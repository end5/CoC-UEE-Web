	...
	export class MainMenu extends BaseContent
	{
		public  MainMenu() {}

		private  _mainMenu:Block;
		...
		private  configureMainMenu(): void {
			//Set up the buttons array
		var  mainMenuButtons: any[] = new Array(
		...
		var  revampLogo:TextField = new TextField();
			...
			revampLogo.height = 70;
			revampLogo.width = 300;
			revampLogo.rotation = 20;
			revampLogo.x = Math.floor(MainView.SCREEN_W / 2) + 165;
			revampLogo.y = Math.floor(MainView.SCREEN_H / 2) - 235;
			revampLogo.selectable = false;
			revampLogo.embedFonts = true;
			revampLogo.defaultTextFormat = new TextFormat(CoCButton.BUTTON_LABEL_FONT_NAME, 20, mainViewManager.isDarkText() ? 0xc0c0c0 : 0, undefined, undefined, undefined, undefined, undefined, "center");
			revampLogo.htmlText = "Unofficially\nExpanded Edition";
		var  miniCredit:TextField = new TextField();
			...
			miniCredit.defaultTextFormat = new TextFormat("Palatino Linotype, serif", 16, mainViewManager.isDarkText() ? 0xc0c0c0 : 0, undefined, undefined, undefined, undefined, undefined, "center", undefined, undefined, undefined, -2);
		...
		var  disclaimerInfo:TextField = new TextField();
			...
			disclaimerInfo.defaultTextFormat = new TextFormat("Palatino Linotype, serif", 16, undefined, undefined, undefined, undefined, undefined, undefined, "left", undefined, undefined, undefined, -2);
		...
		var  versionInfo:TextField = new TextField();
			...
			versionInfo.defaultTextFormat = new TextFormat("Palatino Linotype, serif", 16, mainViewManager.isDarkText() ? 0xc0c0c0 : 0, true, undefined, undefined, undefined, undefined, "right");
		...
		var  websiteInfo:TextField = new TextField();
			...
			websiteInfo.defaultTextFormat = new TextFormat("Palatino Linotype, serif", 20, mainViewManager.isDarkText() ? 0xc0c0c0 : 0, true, undefined, undefined, "www.fenoxo.com", undefined, "center");
			websiteInfo.htmlText = "<a href=\"http://www.fenoxo.com/\">www.fenoxo.com</a>";
			for (var i: number = 0; i < mainMenuButtons.length; i++) {
		...
		private  updateMainMenuTextColours(): void {
		var  elements: any[] = ["revampLogo", "miniCredit", "websiteInfo", "versionInfo"];
