	...
	export class PlayerEvents extends BaseContent implements TimeAwareInterface {
		...
		public static  VAGINA_RECOVER_THRESHOLD_LOOSE: number = 200;
		public static  VAGINA_RECOVER_THRESHOLD_GAPING: number = 100;
		public static  VAGINA_RECOVER_THRESHOLD_GAPING_WIDE: number = 70;
		public static  VAGINA_RECOVER_THRESHOLD_CLOWN_CAR: number = 50;
		...
		private  displayedBeeCock: boolean;
		...
		var  needNext: boolean = false;
			...
			var  recoveryProgress: number = player.vaginas[0].recoveryProgress;
			...
			if (player.hasStatusEffect(StatusEffects.AndysSmoke)) {
				...
				var  tempSpe: number = player.statusEffectv2(StatusEffects.AndysSmoke);
				var  tempInt: number = player.statusEffectv3(StatusEffects.AndysSmoke);
		...
		public  timeChangeLarge(): boolean {
			...
			var  randomWeather: number = rand(100);
