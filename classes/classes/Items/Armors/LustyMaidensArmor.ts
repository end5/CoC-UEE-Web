 ...
 */
	...
	export class LustyMaidensArmor extends Armor {
		...
		public  lustyMaidenPaizuri(player:Player = undefined, monster:Monster = undefined): void {
			if (player == undefined) player = game.player;
			if (monster == undefined) monster = game.monster;
			clearOutput();
