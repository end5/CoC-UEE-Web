...
export class BeeArmor extends Armor {
    public constructor() {
    ...
    public useText(): void {
        this.outputText("You" + this.game.player.clothedOrNaked(" first strip yourself naked and ") + " equip your armor, one piece at a time. \n\nFirst, you clamber into the breastplate. ");
        ...
        this.outputText("Next, you put on your chitinous bracers to protect your arms.\n\n");
