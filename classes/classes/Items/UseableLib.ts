...
import { DebugWand } from "./Other/DebugWand";
...
export class UseableLib extends BaseContent {
    ...
    public D_SCALE = new SimpleUseable("D.Scale", "Dragonscale", "a freshly-shed dragonscale", 45,
    ...
    public LETHITE = new SimpleUseable("Lethite", "Lethicite", "a chunk of lethicite", 1000,
    ...
    public EBNFLWR = new SimpleUseable("E.Flower", "E.Flower", "an Ebonbloom flower", 600,
    ...
    public OBSHARD = new SimpleUseable("ObShard", "Ob.Shard", "a shard of obsidian", 200,
    ...
    // WALL DECOR
    public IMPSKLL = new SimpleUseable("ImpSkll", "ImpSkull", "an imp skull", 25,
    ...
    // MISCELLANEOUS
    public CONDOM = new SimpleUseable("Condom ", "Condom", "a packet of condom", 6,
