...
export class BimboLiqueur extends Consumable {
    ...
    public useItem(): boolean {
        if (this.game.player.findPerk(PerkLib.BroBody) >= 0) {
            ...
            this.outputText(")\n");
            this.outputText("(Perks Gained: Futa Form, Futa Faculties)</b>\n");
            ...
            if (this.game.player.hair.color != "platinum blonde") {
                ...
                if (this.game.player.hair.length < 36) {
                    this.outputText("as you feel the weight of your hair growing heavier and longer.");
                    this.game.player.hair.length = 36;
                }
                else this.outputText("as your hair grows thicker and heavier.");
                this.outputText("  You grab a lock of the silken strands and watch open-mouthed while streaks so blonde they're almost white flow down the " + this.game.player.hair.color + " hair.  It goes faster and faster until your hair has changed into perfectly bimbo-blonde, flowing locks.\n\n");
                this.game.player.hair.color = "platinum blonde";
            }
            ...
            if (!this.game.player.hasVagina()) {
                this.game.player.createVagina();
                this.game.player.setClitLength(0.25);
                this.game.player.vaginas[0].vaginalWetness = Vagina.WETNESS_SLICK;
                ...
                if (this.game.player.isTaur()) {
                    ...
                    if (this.game.player.vaginas[0].vaginalWetness < Vagina.WETNESS_SLICK)
                        this.game.player.vaginas[0].vaginalWetness = Vagina.WETNESS_SLICK;
                }
                else {
            ...
            if (this.game.player.getClitLength() >= 3) this.outputText("jerk ");
            ...
            if (this.game.player.hips.rating < 12 || this.game.player.butt.rating < 12) {
                ...
                if (this.game.player.hips.rating < 12 && this.game.player.butt.rating < 12) {
                    ...
                    this.game.player.butt.rating = 12;
                    this.game.player.hips.rating = 12;
                }
                else if (this.game.player.hips.rating < 12) {
            ...
            if (this.game.player.tone > 0) {
                ...
                if (this.game.player.str100 >= 30) {
                    if (this.game.player.str100 >= 90) this.game.dynStats("str", -10);
                    if (this.game.player.str100 >= 70) this.game.dynStats("str", -10);
                    if (this.game.player.str100 >= 50) this.game.dynStats("str", -10);
            ...
            if (this.game.player.findPerk(PerkLib.BimboBrains) < 0) {
                ...
                if (this.game.player.inte > 21) {
                    let boost: number = this.game.player.inte / 5;
                    this.game.player.inte = 21 + boost;
                }
            }
            this.game.player.orgasm('Vaginal');
