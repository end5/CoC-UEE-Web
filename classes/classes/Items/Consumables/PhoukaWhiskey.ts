 ...
 */
	...
	export class PhoukaWhiskey extends Consumable {
		...
		var  intChange: number = (player.inte < 20 ? player.inte : 20);
			...
			var  drinksSoFar: number = player.statusEffectv2(StatusEffects.PhoukaWhiskeyAffect);
				if (drinksSoFar < 4)
		...
		{
		var  numDrunk: number = player.statusEffectv2(StatusEffects.PhoukaWhiskeyAffect);
		var  libidoSensCombined: number = player.statusEffectv3(StatusEffects.PhoukaWhiskeyAffect);
		var  intSpeedCombined: number = player.statusEffectv4(StatusEffects.PhoukaWhiskeyAffect);
