 ...
 */
	...
	export class AmilyScene extends NPCAwareContent implements TimeAwareInterface
	{
		...
		*/
		...
		public  AmilyScene(pregnancyProgression:PregnancyProgression, output:GuiOutput)
		{
		...
		var  sex = undefined;
			if (!forced && player.lust < 35) return undefined;
		...
		private  amilyDestroyGladesToggle(): void {
			clearOutput();
		...
		var  refillAmount: number = (10 + (flags[kFLAGS.AMILY_CUP_SIZE] * 2)) * flags[kFLAGS.AMILY_LACTATION_RATE];
		...
		public  giveAmilyPureSuccubusDelight(): void {
			clearOutput();
			amilySprite();
			//Doesn't matter if purified or not, she takes it the same way.
			//Amily must have a dick before she can take Succubus' Delight
		...
		//[Reducto]
		private  giveAmilySomeReducto(): void {
			clearOutput();
		...
		private  amilyReducto(part: number): void {
		...
		//[Dye] (NOT USED)
		private  dyeAmilyHairOrFur(): void{
			clearOutput();
