	 ...
	 * @author Kitteh6660
	 */
	export class JoyScene extends NPCAwareContent
	{
		...
		public  joyVagCapacity(): number {
		var  temp: number = 30 + (10 * flags[kFLAGS.JOY_VAGINAL_WETNESS]);
			temp += (2 * flags[kFLAGS.TIMES_PENETRATED_JOY_VAGINALLY]);
			if (temp > 120) temp = 120;
			return temp;
		}
		
		public  joyAnalCapacity(): number {
		var  temp: number = 30;
		...
		public  joyHasCock(): boolean {
			if (flags[kFLAGS.JOY_COCK_SIZE] > 0) return true;
			else return false;
		}
		public  joyHasCockText(text: string): string {
			if (joyHasCock()) return text;
			else return "";
		}
		
		public  joyBallsDescript(): string {
		var  text: string = "";
			if (joyBallSize() >= 3) {
				switch(rand(3)) {
					case 0:
		...
		public  joyPussyDescript(): string {
		var  text: string = "";
		...
		public  joyBreastDescript(): string {
		var  text: string = "";
		...
		public  joyCumQ(): number {
			return jojoScene.jojoCumQ();
		}
		
		public  getTotalLitters(): number {
			return flags[kFLAGS.JOJO_LITTERS] + flags[kFLAGS.JOY_TWINS_BIRTHED];
		}
		
		private  incrementJoysCockFondness(amount: number): void {
		...
		//------------
		//Bimbofy Warning
		public  jojoPromptsAboutThief(): void {
		...
		private  jojoGetsBimbofiedByYou(): void {
			jojoScene.jojoSprite();
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		// FOLLOWER
		//------------
		private  genericMenu(approach: boolean = false): void {
		...
		// TALK
		//------------
		private  joyTalkMenu(from = undefined): void {
			if (from == undefined) {
				clearOutput();
		...
		var  talkButton = function(pos: number, text: string = "", func1 = undefined, arg1: any = -9000, arg2: any = -9000, arg3: any = -9000, toolTipText: string = "", toolTipHeader: string = ""): any {
		...
		private  askJoyAboutYourself(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  askJoyAboutHerself(): void { //For some reason, this talk topic is missing.
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  askJoyAboutOldLife(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  askJoyAboutDemons(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  askJoyAboutBabies(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		// MEDITATION
		//------------
		private  joyMeditationHighCorruptionLetsGo(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  joyMeditationHighCorruptionNoThanks(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  joyMeditationFull(clearText: boolean = true): void {
		...
		private  failedMeditateLetsFuck(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  failedMeditateNoThanks(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  screwTrainingLetsFuck(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  screwTrainingButNoThanks(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		// GIVE ITEMS
		//------------
		private  giveItemsToJoy(): void {
		var  hasValidItems: boolean = false;
		var  buttonPos: number = 0;
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		//Scholar's Tea
		private  giveJoyAScholarsTea(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		//Incubi Draft
		private  giveJoyAnIncubiDraft(purified: boolean = false): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  giveJoyAnIncubiDraftForReal(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  dontGiveJoyAnIncubiDraft(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		//Succubi Milk
		private  giveJoyASuccubiMilk(purified: boolean = false): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  giveJoyASuccubiMilkForReal(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  dontGiveJoyASuccubiMilk(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
			outputText("You tell her you changed your mind and get your vial back. Joy gives you a disappointed \"<i>Dawww...</i>\"");
		...
		//Pink Egg
		private  giveJoyAPinkEgg(large: boolean = false): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  giveJoyAPinkEggForRealYouMonster(large: boolean = false): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  dontGiveJoyAPinkEggThanksGoodness(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		//Blue Egg
		private  giveJoyABlueEgg(large: boolean = false): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		//Lactaid
		private  giveJoyALactaidYummyMilkTime(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		var  refillAmount: number = (flags[kFLAGS.JOY_BREAST_SIZE] + 6) * 5;
		...
		private  reductoJoysBreasts(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		// SEX SCENES
		//------------
		private  initiateSexWithJoy(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
			if (player.lust < 33) {
		...
		private  penetrateJoysPussy(): void {
		var  x: number = player.cockThatFits(joyVagCapacity());
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  fuckJoyInTheAss(): void {
		var  x: number = player.cockThatFits(joyAnalCapacity());
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  haveJoySuckYouOff(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  haveJoyLickYourGinas(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  haveJoyStuffYourPussy(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  haveJoyStuffYourButthole(): void {
		...
		//------------
		//Joy
		public  joyPregnancyUpdate(): boolean {
		...
		private  joyGivesBirthPart2(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		var  babyGender1: number = 0;
		var  babyGender2: number = 0;
		...
		//Night fuck scene
		public  hornyJoyIsPregnant(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  acceptJoyNightFuck(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		public  wakeUpWithJoyPostFuck(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		private  declineJoyNightFuck(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "LukaDoc";
		...
		//Player
		public  playerGivesBirthToJoyBabies(): void {
		var  babyGender1: number = 0;
		var  babyGender2: number = 0;
			switch(rand(10)) { //Decide the gender of the first baby.
				case 0:
		...
		public  playerGivesBirthToJoyBabiesPart2(): void {
		...
		public  joyTakesTheBabiesAway(): void {
			clearOutput();
			spriteSelect(SpriteDb.s_joy);
			credits.modContent = true;
			credits.authorText = "LukaDoc";
