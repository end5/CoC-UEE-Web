...
var  changed: boolean = false;
	...
	if (rand(3) == 0 && player.totalCocks() > 0) {
		outputText("\n\nYour " + player.multiCockDescriptLight() + " feels tighter inside your " + player.armorName + ", even when flaccid.  You shudder and realize you've probably gained more than a few inches in total length, and who knows how your thickness has changed.");
...
public  exgartuanMasturbation(): void {
	...
	//TITURBATION
		...
		outputText("Both hands rise unbidden and begin to caress your " + player.breastDescript(0) + ".  They slide over every sensitive inch of ");
		...
		//(Taunts Male Foes -enemy lust)
			...
			switch(select) {
				...
				case 2:
					...
					break;
				case 3:
					outputText("The waist of your " + player.armorName + " expands as your " + player.cockDescript(0) + " flies skyward fully erect, \"<i>Tremble in fear, peon! My " + num2Text(player.cocks[0].cockLength) + " inches of might shame that feeble nub between your legs.  We've no time for your slack-jawed awe; go home and be a family man.</i>\"");
					break;
				case 4:
...
var  boobs: number = 0;
	...
	//(Not lactating)
		...
		//Nipple stuff
			...
			//(Bigger Nipples!)
			if (rand(2) == 0) {
				outputText("The inner surface of your " + player.armorName + " arouses you as it rubs against your " + player.nippleDescript(0) + "s.  You think about it and realize they've never been like this before.  A quick check reveals each nipple has grown about a half inch longer.  Damn demons.");
