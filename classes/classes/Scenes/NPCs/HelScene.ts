	...
	public  heliaSparIntensity(): number
	{
	var  amount: number = 0;
...
public  helTailPegging(loss: boolean = false): void {
	spriteChooser();
	clearOutput();
	credits.authorText = "Savin";
...
public  helSexualAmbush(): void {
	...
	public  helSexualAmbushEncounter:Encounter = Encounters.build({
