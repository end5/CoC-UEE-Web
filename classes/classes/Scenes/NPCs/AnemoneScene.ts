 ...
 */
	...
	export class AnemoneScene extends BaseContent implements TimeAwareInterface
	{
		...
		public  AnemoneScene(pregnancyProgression:PregnancyProgression, output:GuiOutput)
		{
...
//[Give Weapon]
		...
		var  foundItem: boolean = false;
			for (var x: number = 0; x < inventory.getMaxSlots(); x++) {
...
//[Tutor](only appears if Kid A is armed and present)
		...
		var  dodgeScore: number = player.spe + rand(40); //For ranged weapons
