	...
	export class JojoScene extends NPCAwareContent implements TimeAwareInterface {
		 ...
		 */
		public static  JOJO_FULL_CORRUPTION_STATUS: number = 6;
		
		public  pregnancy:PregnancyStore;

		public  JojoScene(pregnancyProgression:PregnancyProgression, output:GuiOutput)
		{
	...
	private  _jojoForest:Encounter = undefined;
	public  get jojoForest():Encounter {
	const  GAME:CoC = kGAMECLASS;
		if (_jojoForest == undefined) _jojoForest = Encounters.build({
			name  : "jojo",
 ...
 */
public  isJojoCorrupted(): boolean {
...
private  amilyDemonstratesBlowjob(): void {
...
public  jojoFollowerMeditate(): void {
	...
	doNext(camp.returnToCampUseOneHour);
		...
		protected  corruptJojoVaginalSmother(): void {
			jojoSprite();
			clearOutput();
...
public  highCorruptionJojoEncounter(): void {
	flags[kFLAGS.JOJO_STATUS] = 1;
...
//Repeat encounter
public  repeatJojoEncounter(): void {
...
public  corruptJojoEncounter(): void {
	kGAMECLASS.jojoScene.jojoSprite();
	clearOutput();
...
public  talkMenu(from = undefined): void
{
	jojoSprite();
	menu();
...
var  talkButton = function(pos: number, text: string = "", func1 = undefined, arg1: any = -9000, arg2: any = -9000, arg3: any = -9000, toolTipText: string = "", toolTipHeader: string = ""): any {
	...
	talkButton(0, "Village", jojoTalkVillage, undefined, undefined, undefined, "Ask him about the village he was raised in.");
	talkButton(1, "Monks", jojoTalkJoiningTheMonks, undefined, undefined, undefined, "Ask him about how and why he became a monk.");
	talkButton(2, "MonksFall", jojoTalkFallOfTheMonks, undefined, undefined, undefined, "Ask him about the demise of the monks.");
	talkButton(3, "Forest", jojoTalkForestConvo, undefined, undefined, undefined, "Ask him about how he ended up in the forest.");
	if (flags[kFLAGS.TIMES_TALKED_WITH_JOJO] >= 4 && flags[kFLAGS.JOJO_BIMBO_STATE] == 0) talkButton(4, "You", jojoTalkYourOrigin, undefined, undefined, undefined, "Tell him about Ingnam and your history.");
	...
	if (flags[kFLAGS.FACTORY_SHUTDOWN] > 0) talkButton(5, "Factory", jojoTalkFactory, undefined, undefined, undefined, "Tell him about how you've shut down the factory.");
	if (flags[kFLAGS.SAND_WITCHES_COWED] == 1 || flags[kFLAGS.SAND_WITCHES_FRIENDLY] == 1 || flags[kFLAGS.SAND_MOTHER_DEFEATED] == 1) talkButton(6, "SandCave", jojoTalkSandCave, undefined, undefined, undefined, "Tell him about your encounter in the Sand Cave in the desert.");
...
public  getBackYouMenu(): void {
	...
	menu();
	addButton(0, "Yes", keepChanging).hint(undefined);
	addButton(1, "No", stopChanging).hint(undefined);
}

public  keepChanging(): void {
	clearOutput();
	jojoSprite();
...
private  noThanksToMeditate(): void {
	jojoSprite();
	clearOutput();
...
public  offerSexFirstTimeHighAffection(): void {
	jojoSprite();
	clearOutput();
...
private  pureJojoSexMenu(): void {
	//Capacity
var  capacity: number = 40;
...
private  anallyFuckTheMouseButtSlut(): void {
	//Capacity
var  capacity: number = 40;
	if (flags[kFLAGS.JOJO_ANAL_XP] < 10) capacity += (flags[kFLAGS.JOJO_ANAL_XP] * 3);
	else capacity += 30; //Caps at 70.
...
private  getAnallyFuckedByMouseYouSlut(): void {
...
private  getVagFuckedByMouse(): void {
	jojoSprite();
	clearOutput();
...
public  giveBirthToPureJojoBabies(): void {
