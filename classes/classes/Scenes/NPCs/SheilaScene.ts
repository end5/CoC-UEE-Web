...
//Scarred blade
public  badEndScarredBlade(): void {
...
public  rebellingScarredBlade(wieldAttempt: boolean = false): void {
	...
	doNext(playerMenu);
	addButton(1, "Fight", startCombatImmediate, new ScarredBlade, true, undefined, "Fight the saber and try to break it. This is going to be a risky battle and a loss can mean your demise.");
}
public  findScarredBlade(): void {
...
private  leaveScarredBlade(): void {
	clearOutput();
