	...
	export class HelSpawnScene extends NPCAwareContent implements TimeAwareInterface {
...
public  helPregnant(): boolean {
	...
	public  helspawnSparIntensity(): number {
	var  amount: number = Math.max(0, flags[kFLAGS.HELSPAWN_SPAR_VICTORIES] * 2);
		if (amount > 100) amount = 100; //Hard capped at 100. She'll be level 32!
		return amount;
	}

	public  spriteChooser(): void { //USED FOR HELIA'S APPEARANCE, /NOT/ HELSPAWN
...
private  applyHelspawnName(): void {
	spriteChooser();
	credits.authorText = "Savin";
var  forbiddenNames: any[] = ["", "Hellgirl", "Kid", "Phoenix", "Savin", "Helia", "Mini-doofus"];
