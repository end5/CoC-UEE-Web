 ...
 */
	...
	export class EmberScene extends NPCAwareContent implements TimeAwareInterface, VaginalPregnancy
	{
...
// TIMES_EMBER_LUSTY_FUCKED: number = 824;
		...
		public  EmberScene(pregnancyProgression:PregnancyProgression)
		{
		...
		public  emberCorruption(changes: number = 0): number
		{
		...
		public  emberSparIntensity(): number
		{
		var  amount: number = 0;
		...
		public  emberGroinDesc(cock: string, pussy: string, herm: string = " and "): string
		{
		var  strText: string = ""
...
//Approach for sex - initial output when selecting [Sex] menu (Z)
		private  emberSexMenu(output: boolean = true): void
		{
			...
			if (flags[kFLAGS.EMBER_GENDER] >= 2 && player.hasCock() && player.lust >= 33) addButton(6, "Penetrate " + emberMF("Him", "Her"), penetrateEmbrah, undefined, undefined, undefined, "Penetrate Ember vaginally!");
...
//Talk about Yourself (Z)
		...
		private  askEmberForEggshell(): void {
			clearOutput();
...
//Winning gets you affection.
		...
		{
			clearOutput();
		var  oldIntensity: number = emberSparIntensity();
			if (emberAffection() <= 25) {
...
//Get Penetrated - also horse-proof, sorry folks! (Z)
		private  getPenetratedByEmberLastSexSceneWoooo(): void
		{
			...
			outputText("\n\nEmber leans over you, panting, " + emberMF("his", "her") + " hot breath mere inches from your " + player.faceDescript() + ", gazing at you through half-lidded, lust-addled eyes.  \"<i>You feel so good... so hot... so sexy...</i>\" Ember says mid-pant.  You pant right back, reaching up and wrapping your arms around " + emberMF("his", "her") + " neck, staring back at " + emberMF("him", "her") + " with the same expression and telling " + emberMF("him", "her") + " you think " + emberMF("he", "she") + " feels just as good.");
