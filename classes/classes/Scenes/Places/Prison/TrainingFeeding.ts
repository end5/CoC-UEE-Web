	...
	export class TrainingFeeding extends BaseContent
	{
		...
		public  TrainingFeeding() { }
		
		public  prisonCaptorFeedingOrgasmTrainingAccept(branchChoice: string = "choose"): void
		{
			clearOutput();
		var  resistanceCounter: number = 0;
		var  totalResistance: number = 0;
		var  saidNo: number = 0;
		var  lustChange: number = 0;
		var  sceneVariation: number = 0;
		var  begVariation: number = 0;
		...
		{
			clearOutput();
		var  refuse = prisonCaptorFeedingTrainingRefuse;
		var  accept = prisonCaptorFeedingTitleTrainingAccept;
		var  reject = prisonCaptorFeedingTrainingReject;
		var  perform = prisonCaptorFeedingTitleTrainingPerform;
		...
		public  prisonCaptorFeedingBJTraining(): void
		{
			clearOutput();
		var  refuse = prisonCaptorFeedingTrainingRefuse;
		var  accept = prisonCaptorFeedingBJTrainingAccept;
		var  reject = prisonCaptorFeedingTrainingReject;
		var  perform = prisonCaptorFeedingBJTrainingPerform;
			if (flags[kFLAGS.PRISON_TRAINING_LEVEL] == 0)
			{
		...
		public  prisonCaptorFeedingOrgasmTraining(): void
		{
			clearOutput();
		var  refuse = prisonCaptorFeedingTrainingRefuse;
		var  accept = prisonCaptorFeedingOrgasmTrainingAccept;
		var  reject = prisonCaptorFeedingTrainingReject;
		var  perform = prisonCaptorFeedingOrgasmTrainingPerform;
			if (flags[kFLAGS.PRISON_TRAINING_LEVEL] == 0)
			{
				if (prison.prisonIsRestrained())
				{
		...
		public  prisonCaptorFeedingAnalTraining(): void
		{
			clearOutput();
		var  refuse = prisonCaptorFeedingTrainingRefuse;
		var  accept = prisonCaptorFeedingAnalTrainingAccept;
		var  reject = prisonCaptorFeedingTrainingReject;
		var  perform = prisonCaptorFeedingAnalTrainingPerform;
			if (flags[kFLAGS.PRISON_TRAINING_LEVEL] == 0)
			{
		...
		var  refuse = prisonCaptorFeedingTrainingRefuse;
		var  accept = prisonCaptorFeedingQuestTrainingAccept;
		var  reject = prisonCaptorFeedingTrainingReject;
		var  perform = undefined;
		...
		{
		var  newval1: any = undefined;
		var  newval2: any = undefined;
