	...
	export class TrainingPet extends BaseContent
	{
		...
		{
		var  currentTier: number = 0;
		var  currentEvent: number = 0;
		var  petScore: number = 0;
		...
		public  prisonCaptorPetLickCumBowl(branchChoice: string, previousEvent = undefined): void
		{
		var  currentScore: number = 0;
		var  itemEvent = undefined;
		...
		var  currentTier: any = prisonCaptorPetTier();
		var  currentEvent: any = prisonCaptorPetEvent();
		var  petScore: any = prisonCaptorPetScore();
		var  demandFlagged: any = flags[kFLAGS.PRISON_TRAINING_REFUSED];
			return false;
		}
		...
		{
		var  currentTier: any = undefined;
		var  corChange: any = undefined;
			currentTier = prisonCaptorPetTier();
			if (branchChoice == "choose")
			{
				if (currentTier == 2)
		...
		{
		var  currentTier: number = prisonCaptorPetTier()
		var  currentEvent: number = prisonCaptorPetEvent();
		var  previousDreamValue: number = 0;
		var  dreamValue: number = 0;
		var  dreamSelect: number = 0;
		var  corChange: number = 0;
		var  petScore: number = prisonCaptorPetScore();
			previousDreamValue = prisonCaptorPetScratch();
		var  demandFlagged: number = flags[kFLAGS.PRISON_TRAINING_REFUSED];
			if (branchChoice == "choose")
			{
		...
		{
		var  currentTier: any = undefined;
		var  currentEvent: any = undefined;
		var  previousDreamValue: any = undefined;
		var  dreamValue: any = undefined;
		var  dreamSelect: any = undefined;
		var  corChange: any = undefined;
			currentTier = prisonCaptorPetTier();
			currentEvent = prisonCaptorPetEvent();
		var  petScore: any = prisonCaptorPetScore();
		...
		var  corChange: any = undefined;
			...
			currentEvent = prisonCaptorPetEvent();
			petScore = prisonCaptorPetScore();
		var  previousDreamValue: any = prisonCaptorPetScratch();
		var  demandFlagged: number = flags[kFLAGS.PRISON_TRAINING_REFUSED];
			corChange = 0;
		...
		{
		var  behaviorCounter: any = undefined;
		...
		{
		var  behaviorCounter: number = undefined;
		...
		public  prisonCaptorPetTrainingAcceptedIntro(branchChoice: string = "choose"): void
		{
			clearOutput();
		...
		{
		var  lustChange: number = 75;
		var  shortName:ItemType = undefined;
			prisonCaptorPetTierUpdate();
