//Scruffy the Imp Janitor
	...
	export class ScruffyScene extends BaseContent
	{
		...
		{
		var  scruffyMet: any = undefined;
		var  happiness: any = prisonCaptorScruffyHappiness();
		...
		var  refuse = prisonCaptorRandomEventJizzJanitorRefuse;
		var  accept = prisonCaptorRandomEventJizzJanitorAccept;
		var  reject = prisonCaptorRandomEventJizzJanitorReject;
		var  perform = prisonCaptorRandomEventJizzJanitorPerform;
		...
		{
			clearOutput();
		var  freeitemslots: number = inventory.getMaxSlots() - inventory.getOccupiedSlots();
			outputText(images.showImage("prison-scruffy"));
		...
		public  fightScruffy(): void {
			...
			prison.prisonCombatWinEvent = undefined;
