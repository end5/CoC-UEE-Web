	...
	export class KeltScene extends AbstractFarmContent {
		...
		public  KeltScene(output:GuiOutput)
		{
...
//			player.addStatusValue(StatusEffects.Kelt,1,4);
		...
		if (temporary == 3) { //Naked, 20% Chance
			...
			outputText("\"<i>Isn't it obvious?</i>\" he asks, grinning down at you in sardonic amusement. \"<i>You were way off balance.  Of course, I would be too, if I had a couple of extra pounds of fat hanging off my chest.</i>\"\r");
