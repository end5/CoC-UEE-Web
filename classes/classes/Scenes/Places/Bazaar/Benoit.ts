	...
	export class Benoit extends BazaarAbstractContent
	{
		...
		*/
		...
		var  currDay: number = getGame().time.days;
		...
		*/
		...
		var  numEggs: number = player.cumQ() / 200;
		...
		{
		var  benoitSlot1Items: any[] = [];
		var  benoitSlot2Items: any[] = [];
		var  benoitSlot3Items: any[] = [];
		...
		private  talkToBenoit(): void {
			...
			var  choice: number;
				...
				/* BUILD ZE CHOICES!*/
			var  choices: any[] = [0, 1, 2, 3, 4, 5, 6, 7];
		...
		{
		var  keyItemNum: number = player.hasKeyItem("Feathery hair-pin");
		...
		{
		var  eyesGranted: number = flags[kFLAGS.BENOIT_BASIL_EYES_GRANTED] + 1;
			clearOutput();
			credits.authorText = "MissBlackthorne";
