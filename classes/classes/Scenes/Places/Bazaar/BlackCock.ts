	...
	export class BlackCock extends BazaarAbstractContent
	{
		...
		private  satyrGangIntro(): void {
			...
			if (player.lust >= 33) {
				if (!player.isTaur()) {
					addButton(0, "Let Them", letTheSatyrsHaveTheirWayWithYou, false, undefined, undefined, "Let the satyrs have their way with you. This is going to be rough and intense. ");
					if (player.hasVagina()) addButton(5, "No Rimjobs", letTheSatyrsHaveTheirWayWithYou, true, undefined, undefined, "Let the satyrs have their way with you. This is going to be rough and intense. Also signal that you don't want to rim one of the satyr's asses.");
				}
