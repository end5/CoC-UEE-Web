	...
	export class Roxanne extends BazaarAbstractContent implements TimeAwareInterface 
	{
		...
		public  Roxanne(randomNumber:RandomNumberGenerator)
		{
		...
		var  x: number = player.biggestCockIndex();
			...
			outputText(", squeezing you softly while she steadies herself on your " + player.cockDescript(x) + ". She titters, letting a few inches of tongue slip through her lips to envelop your sensitive " + player.cockHead(x) + ", circling the engorged cock-flesh with drunken slobbers. ");
