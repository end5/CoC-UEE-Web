...
export class Ifris extends TelAdreAbstractContent {
    ...
    public approachIfris(): void {
        this.spriteSelect(SpriteDb.s_ifris);
        this.clearOutput();
        ...
        this.outputText("(You could go ahead and work out while she watches, ask her to join you, or leave.)");
        // Work out || Ask Her To Join || Leave?
        this.menu();
        if (this.player.fatigueLeft() >= 30) {
            this.addButton(0, "Work Out", this.workOutForIfris);
            this.addButton(1, "Join Me?", this.askIfrisToJoinYou);
        } else {
            this.addDisabledButton(0, "Work Out", "There's no way you could work out as tired as you are.  Maybe you could come back to flirt with the demonic-looking girl during your next workout.");
            this.addDisabledButton(1, "Join Me?", "There's no way you could work out as tired as you are.  Maybe you could come back to flirt with the demonic-looking girl during your next workout.");
        }
    ...
    private workOutForIfris(): void {
        ...
        this.menu();
        this.addButton(0, "Work Out", this.liftWhileIfrisWatches);
        this.addButton(1, "Show Off", this.showOffForIfris);
    }
    ...
    private askIfrisToJoinYou(): void {
        ...
        this.outputText("You shrug at her response, but there's something about the way she eyes you now...");
        // WORK OUT or SHOW OFF?
        this.menu();
        this.addButton(0, "Work Out", this.liftWhileIfrisWatches);
        this.addButton(1, "Show Off", this.showOffForIfris);
    ...
    private showOffForIfris(): void {
        ...
        if (this.player.str < 40) {
            ...
            this.outputText("Humiliated, you stand and leave, nursing your sore body and ego.");
        ...
        if (this.player.isGenderless() || (this.player.femininity < 40 && !this.player.isPureEnough(75) && this.player.face.type == Face.COW_MINOTAUR)) {
        ...
        if (this.player.hasCock()) {
            // Double dickings!
            if (this.player.cockTotal() > 1 && rand(2) == 0 && this.player.cockThatFits(70) != -1 && this.player.cockThatFits2(70) != -1) {
                this.ifrisDP();
                return;
            }
            // First time
            ...
            // 5a-Repeat oral scene, male/herm-
                ...
                this.outputText("Ifris all but squeals in delight as you tell her you're totally up for smashing that record, a wide grin spreading her thick lips, briefly worrying you when you see those sharp teeth of hers... but then you remind yourself how good she is with them, as you lay back onto the bench, gripping the bars above you. The devil girl doesn't even wait this time, tugging your bottoms down right away to get at your " + this.player.cockDescript(0) + ". She sits upon your " + this.player.legs() + ", her posh butt so nice and soft against you as she waits for you to begin.\n\n");

                this.outputText("The moment you lift the weight for the first time, she bends down, rubbing her smooth cheek against your half-turgid member");
                if (this.player.balls > 0) this.outputText(", her hand cupping your " + this.player.ballsDescriptLight());
        ...
        // 4b4-PC succeeds! Is female!-
            ...
            if (this.flags[kFLAGS.TIMES_FUCKED_IFRIS_LICKED] == 0) {
                ...
                if (this.player.isNaga()) this.outputText("your powerful tail flexing to and fro while your belly clenches");
            ...
            // 5b-Repeat oral scene, female-
                ...
                this.outputText("Ifris all but squeals in delight as you tell her you're totally up for smashing that record, a wide grin spreading her thick lips, briefly worrying you when you see those sharp teeth of hers... but then you remind yourself how good she is with them, as you lay back onto the bench, gripping the bars above you. The devil girl doesn't even wait this time, leaning up to give your cheek a little peck as she pulls your " + this.player.chestDesc() + " free of your top.\n\n");

                this.outputText("She leans in before you've started, peppering your " + this.player.nippleDescript(0) + "s and ");
                ...
                this.outputText("With the first push, that long devil-tongue slides up along your " + this.player.vaginaDescript() + ", not teasing, but firmly lapping between the lips, spreading them slightly as she tastes you. With a pretty little moan, Ifris laves her tongue up your pussy over and over again as you pump your iron, enjoying your flavor, but knowing you'll need more to really get you going. Two fingers spread your " + this.player.vaginaDescript() + " open as her lips seal over your " + this.player.clitDescript() + ", suckling it gingerly, tongue swirling over it. Her fingers pump into you nice and quickly, your pleasureful reward for... well, you don't quite understand why this gets her excited, nor do you care.\n\n");
                ...
                this.outputText("\"<i>Always a pleasure, darling. I can't wait to see you again soon...</i>\" And she's leaving you once more, her butt swaying more than usual, moisture leaking down her long, slender legs...");
            }
    ...
    private ifrisDP(): void {
        ...
        this.outputText("You set the machine's bar back in place, letting your worn-out limbs go slack across Ifris's body, your hands coming to rest on her tight, squeezable butt.  The two slick holes start a whole new wave of contractations, and without the distraction of the weights, you're unable to resist.  ");
        // (Knotting - req's 2 dogdicks!)
        if (this.player.dogCocks() >= 2) {
            this.outputText("Both your canine cocks bloat with seed, the knot's distending and stretching so wide that Ifris couldn't pull off if she wanted.  A moment later, the twin dog-dicks explode pillars of alabaster cream, painting the truly knotted woman's innards white.  ");
            if (this.player.cumQ() >= 1000) this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ");
            this.outputText("Throughout the massive release, you're softly grunting, held immobile by your animalistic body's instincts as your peckers try their damnedest to impregnate your overly fit mate.  You're still cumming, but your knots are starting to deflate at last.  ");
        }
        // (Nodule growing, unholy demonocity)
        else if (this.player.countCocksOfType(CockTypesEnum.DEMON) >= 2) {
            this.outputText("Both your demonic cocks explode inside Ifris, the nodules along each shaft swelling out, thickening to stroke and caress your oily lover's inner walls.  A moment later, the tainted tips explode out, spurting demon-spunk into both silky tunnels.  ");
            if (this.player.cumQ() >= 1000) this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ");
        ...
        else if (this.player.countCocksOfType(CockTypesEnum.HORSE) >= 2) {
            this.outputText("Both your equine cocks explode inside Ifris, their tips swelling outward into thick flares that plug her stuffed channels.  A moment later, the swollen tips unleash pillars of alabaster cream, painting everything above the flares white.  ");
            if (this.player.cumQ() >= 1000) this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ");
            this.outputText("Your hips begin to rock and thrust, and no matter what you try to do, you cannot seem to still your body, your animal instincts owning your waist as you inseminate your seductive, teasing lover's body.  ");
        }
        // (Tentacle pistoning + head-mushrooming)
        else if (this.player.countCocksOfType(CockTypesEnum.TENTACLE) >= 2) {
            this.outputText("Both your plant-like pricks explode inside Ifris, the purplish tips swelling up inside her to disproportionate sizes.  A moment later, the vine-dicks explode out twin pillars of ropey seed, painting her inner walls with spunk.  ");
            if (this.player.cumQ() >= 1000) this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ");
            this.outputText("At the same time, both tentacle-shafts curl and piston, winding around in other in the space between your bodies, curling and thrusting to rub every inch of your sensitive, prehensile shafts against Ifris' pussy-walls.  You shake and shudder, feeling more like a tentacle beast than a " + this.player.mf("man", "woman") + ".  ");
        }
        // (Anemone - stinging funtimes)
        else if (this.player.countCocksOfType(CockTypesEnum.ANEMONE) >= 2) {
            this.outputText("Both your unusual, aquatic cocks explode inside Ifris, their shafts thickening as the prepare for release.  A moment later, they explode out twin pillars of alabaster cum, painting her inner walls with gooey spunk.  ");
            if (this.player.cumQ() >= 1000) this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ");
        ...
        // (Standard)
            ...
            this.outputText("Both your cocks explode inside Ifris, submitting alabaster pillars to her request for your release.  The red-hued sexpot exhales a happy hum and rocks her hips back and forth, her oily, lubricated holes squeezing your dicks for every drop of delectable seed.  ");
            if (this.player.cockTotal() > 2) {
                this.outputText("The ");
                if (this.player.cockTotal() == 1) this.outputText("one unbound prick remaining paints the muscular woman's lower back with goo, but she doesn't seem to mind.");
                else this.outputText("other, unbound pricks paint the muscular woman's lower back in goo, but she doesn't seem to mind.");
                this.outputText("  ");
            }
        }
        ...
        this.outputText("The last few contractions work through you, emptying the last of your load inside Ifris and allowing you to feel utterly, completely at peace.  Sliding up, she lets your slowly-deflating cocks ");
        if (this.player.dogCocks() >= 2) this.outputText("noisily pop free");
        else this.outputText("slide");
        this.outputText(" from her sperm-glazed snatch and anus.  Her body's warmth vanishes as she stands, and with a wink, she reattaches her bikini bottom, the tight garment moulding to her soaked camel-toe and holding in all of your leavings.  She walks away without another word, ");
        if (this.player.cumQ() >= 1000) this.outputText("her body bloated with cum and sloshing audibly with every step");
        else if (this.player.cumQ() >= 500) this.outputText("her belly bloated and gurgling with every step");
        ...
        // Stat changes HERE!
        if (this.player.str100 < 90) this.dynStats("str", .75);
        if (this.player.tou100 < 40) this.dynStats("tou", .5);
        this.player.orgasm('Generic');
        // Body changes here
        // Muscleness boost!
        this.outputText(this.player.modTone(85, 5 + rand(5)));
