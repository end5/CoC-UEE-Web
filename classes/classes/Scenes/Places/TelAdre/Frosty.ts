...
export class Frosty extends TelAdreAbstractContent {
    ...
    public frostyMainMenu(): void {
        ...
        this.addButton(14, "Leave", kGAMECLASS.telAdre.telAdreMenu);
    ...
    public frostySpecialsMenu(free: boolean = false): void {
        ...
        this.addButton(14, "Back", this.approachFrosty);
    }
    ...
    public cupcakeBuy(arg: number = 1): void {
        ...
        this.player.refillHunger(5 * arg);
        this.menu();
