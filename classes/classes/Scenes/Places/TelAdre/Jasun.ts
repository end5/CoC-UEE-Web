...
export class Jasun extends TelAdreAbstractContent {
    ...
    public changingRoom(): void {
        ...
        if (this.flags[kFLAGS.JASUN_MET] == 0) {
        ...
        // [Look Around]
        this.menu();
        if (this.flags[kFLAGS.JASUN_NAME_LEARNED] == 0)
            this.addButton(0, "Look Around", this.meetJasun);
        else this.addButton(0, "Jasun", this.meetJasun);
    ...
    private meetJasun(): void {
        this.clearOutput();
        this.spriteSelect(SpriteDb.s_jasun);
        if (this.flags[kFLAGS.JASUN_MET] == 0) {
            this.flags[kFLAGS.JASUN_MET]++;
            ...
            if (this.player.gender <= 1) {
                ...
                this.outputText("You doubt he'd have the nerve to murder someone here, but you feel like you've wasted your time.");
                this.flags[kFLAGS.JASUN_MET] = 0;
        ...
        // Met Jasun but not boned!
        else if (this.flags[kFLAGS.JASUN_MET] > 0 && this.flags[kFLAGS.JASUN_FUCKED_COUNTER] == 0) {
            if (this.flags[kFLAGS.JASUN_NAME_LEARNED] == 0) {
                ...
                this.flags[kFLAGS.JASUN_NAME_LEARNED]++;
            }
            // If you're a dude.
            ...
            if (this.player.tone < 75 || this.player.armorName != "slutty swimwear") {
                ...
                this.outputText("\"<i>" + this.player.short + ", you know, I still don't think you're quite ready to swim with me. That's fine, and it's entirely up to you, but I think today I should probably swim alone. You can come and visit me anytime, of course, maybe when you're ");
                if (this.player.tone < 75) this.outputText("fit enough");
                else if (this.player.armorName != "slutty swimwear") this.outputText("properly attired");
            ...
            this.outputText("Jasun comes out of his stall and smiles when he sees you, already beginning to strain against the skimpy fabric of his bottom.  He asks, \"<i>Would you like to come swimming with me?</i>\" though his tone indicates that swimming may involve more than a few laps.");
        ...
        // Repeat
            ...
            if (this.player.gender <= 1 || (this.player.gender == 3 && this.player.mf("m", "f") == "m")) {
                this.outputText("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it.  He glances your way and smirks.\n\n");
                this.outputText("\"<i>Eyes to yourself, boy. Try to play any games and I'll tear you apart limb from limb. Now get out of here before I do it anyway.</i>\" The shark-morph snarls threateningly before turning to walk away.\n\n");
                this.outputText("You doubt he'd have the nerve to murder someone here, but it's clear that so long as you lack a vagina Jasun will have no interest in you.  What a waste.");
                this.doNext(this.camp.returnToCampUseOneHour);
                return;
            }
            // IF YOU FAIL TO MEET ANY OF HIS CRITERIA NOW
    ...
    private meetJasun2(): void {
        ...
        if (this.player.str < 50) this.outputText("that you're pretty sure you couldn't have moved on your own at all ");
        ...
        this.flags[kFLAGS.JASUN_NAME_LEARNED] = 1;
        // [Accept] [Turn Away]
        this.menu();
        this.addButton(0, "Accept", this.acceptJasunsAdvances);
        this.addButton(1, "Turn Away", this.turnAwayFromAdj);
    }
    ...
    private jasunSecks(): void {
        ...
        if (this.flags[kFLAGS.JASUN_FUCKED_COUNTER] == 0) {
            ...
            this.outputText("When you come to, you find that your bikini is still on and that everything seems to be in order. Collecting your things, you leave the gym and think fondly of your encounter with Jasun... And what the next encounter might entail.");
        }
        // Repeat
        else {
            // REPEAT SEX
        ...
        this.flags[kFLAGS.JASUN_FUCKED_COUNTER]++;
