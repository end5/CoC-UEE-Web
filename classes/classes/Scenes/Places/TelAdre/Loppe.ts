...
export class Loppe extends TelAdreAbstractContent {
    ...
    */
    ...
    private talkWithLoppe(): void {
        ...
        this.addButton(14, "Back", this.loppeGenericMeetings);
    }
    ...
    private gossipWithLoppe(): void {
        ...
        // Jasun
        if (this.flags[kFLAGS.JASUN_MET] > 0) this.addButton(2, "Jasun", this.gossipWithLoppeAboutJasun);
        // Heckel
        ...
        // Lottie
        if (this.flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER] > 0) this.addButton(5, "Lottie", this.gossipWithLoppeAboutLottie);
        // Cotton
        if (this.flags[kFLAGS.COTTON_MET_FUCKED] > 0) this.addButton(6, "Cotton", this.gossipWithLoppeAboutCotton);
        // Back (spacebar default)
        this.addButton(14, "Back", this.talkWithLoppe);
    }
    ...
    private gossipWithLoppeAboutLottie(): void {
        ...
        if (this.flags[kFLAGS.LOTTIE_TRAINER] == 1) {
        ...
        else if (this.flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER] > 0) {
    ...
    private loppeSexChoice(bakery: boolean = false): void {
        ...
        if (this.player.cockThatFits(this.loppeCapacity()) >= 0) {
            ...
            this.addDisabledButton(0, "Cow-girl", "This scene requires you to have fitting cock.");
        }
        if (this.player.hasCock()) {
            this.addButton(1, "Get BJ", this.loppeWorshipsDicks);
        } else {
            this.addDisabledButton(1, "Get BJ", "This scene requires you to have cock.");
        }
        if (this.player.hasVagina()) {
            this.addButton(2, "TakeVaginal", this.getFuckedInYerTwatYaCunt);
        } else {
            this.addDisabledButton(2, "TakeVaginal", "This scene requires you to have vagina.");
        }
        if (this.player.biggestTitSize() >= 4) {
            this.addButton(3, "Boob-job", this.boobjobLoppe);
        } else {
            this.addDisabledButton(3, "Boob-job", "This scene requires you to have big enouth breasts.");
        }
        if (this.flags[kFLAGS.LOPPE_TIMES_SEXED] > 0) {
            this.addButton(4, "SqueezeJob", this.loppeSqueezedickWhateverThatIs);
        } else {
            this.addDisabledButton(4, "SqueezeJob", "This scene requires you to have some experience with Loppe.");
        }
        ...
        this.addButton(14, "Leave", this.beATeaseAndLeaveLoppeAfterSexInvite);
    }
    ...
    private loppeRidesCocks(): void {
        ...
        this.outputText("\n\n\"<i>I would love to, sugar!</i>\"  Loppe gazes at your " + this.player.multiCockDescriptLight() + ".");
        // [(2 fit cocks)
        ...
        this.outputText(" own, shivering from the sensation of your sensitive [skin] against her proud horseflesh, already drooling even though you can plainly feel that it's only half-erect.");
        ...
        this.outputText("\n\n\"<i>Okay, that's enough foreplay!</i>\" Loppe announces suddenly, eyeing your " + this.player.cockDescript(x) + " with a hunger that you never expected to see on her face.  Loppe quickly straddles you, aligning it with her pussy");
    ...
    private loppeRidesYouSpunksInYourEye(): void {
        ...
        this.outputText(" wrapped around your lover, welcoming what's approaching as her horse-prick throbs and her flared tip inflates.  With a rapturous howl the laquine's cumslit opens like a floodgate, spurting jet after jet of cum onto your [chest], [face] and even the wall behind you; her own pillowy breasts and face are splashed with the force of her orgasm.  Her tight pussy contracts, milking your " + this.player.cockDescript(x) + " for all its worth");
        if (y >= 0) this.outputText(", while her anal ring constricts your " + this.player.cockDescript(y) + " tightly, intent on holding you in place");
        this.outputText(".");
    ...
    private loppeRidesPCCockFinal(): void {
        ...
        this.outputText("\n\nYour " + this.player.cockDescript(x) + " gushes fluids into her hungry womb");
        if (y >= 0 || this.player.hasVagina()) {
            this.outputText(", while ");
            if (y >= 0) this.outputText("your second " + this.player.cockDescript(y) + " just as easily pumps her perverted ass full of baby juice");
        ...
        this.outputText(this.player.multiCockDescriptLight() + " and slides down your body, pressing her soft, cum-slickened breasts against you.  You moan as the smooth curves of her chest press against [eachCock]; the cum-slick ");
        ...
        if (y >= 0) this.outputText("s");
        this.outputText(" of your " + this.player.multiCockDescriptLight() + ".");
    ...
    private getFuckedInYerTwatYaCunt(): void {
        ...
        if (this.player.gender == 3 && !this.player.isTaur()) {
            this.outputText(", though she needs to move aside " + this.player.sMultiCockDesc() + " ");
        ...
        if (this.player.hasCock()) this.outputText(", precum begins to drool from your " + this.player.multiCockDescriptLight());
        this.outputText(".");
    ...
    private getButtFuckedNonHoarseByLoppe(): void {
        ...
        // [(cock)
        if (this.player.hasCock()) this.outputText("One of her hands reaches around to grasp your pre-slickened [cock biggest], stroking you in time with her thrusts.  ");
    ...
    private getAssFuckedByLoppeAsACentaur(): void {
        ...
        if (!this.player.hasScales()) this.outputText(" have goosebumps all over your body");
    ...
    private letsLoppeGoCum(): void {
        ...
        this.dynStats("lus", 30 + this.player.lib / 10, "scale", false);
        this.flags[kFLAGS.LOPPE_TIMES_SEXED]++;
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    // [=Hold=]
    ...
    private boobjobLoppe(): void {
        ...
        if (this.player.hasLongTongue()) this.outputText("retract your tongue into your mouth and ");
        ...
        if ((this.player.str < 50 && !this.player.isTaur()) || (this.player.str < 30 && this.player.isTaur())) {
            ...
            if (this.player.tongue.type > Tongue.HUMAN) this.outputText("looping your inhuman tongue around it and stroking for extra stimulus even while ");
    ...
    private teaseLoppeNSuck(): void {
        ...
        if (this.player.tongue.type > Tongue.HUMAN) this.outputText(", inhumanly long tongue looping out to coil wetly around the length");
