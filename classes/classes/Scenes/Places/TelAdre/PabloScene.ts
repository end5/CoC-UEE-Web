	...
	export class PabloScene extends TelAdreAbstractContent
	{
		...
		private  pabloDickingTimeSubMenus(): void {
			...
			menu();
			addButton(0, "TakeCharge(Vag)", pabloDickingTime, true, false, undefined, "You'll take charge and give him vaginally.", "Take Charge (Vaginal)");
			...
			addButton(2, "PabloLeads(Vag)", pabloDickingTime, false, false, undefined, "You'll let Pablo lead and he'll take your dick vaginally.", "Pablo Leads (Vaginal)");
		...
		private  PabloPussPussSubMenus(): void {
			...
			menu();
			addButton(0, "Take Charge", pabloPussPuss, true, undefined, undefined, "You'll take charge and receive vaginally.", "Take Charge");
			addButton(1, "Pablo Leads", pabloPussPuss, false, undefined, undefined, "You'll let Pablo lead and he'll put his dick to a good use.", "Pablo Leads");
		}
		...
		private  pabloButtsecksSubMenus(): void {
			...
			menu();
			addButton(0, "Take Charge", pabloButtSecks, true, undefined, undefined, "You'll take charge and give him vaginally.", "Take Charge");
			addButton(1, "Pablo Leads", pabloButtSecks, false, undefined, undefined, "You'll let Pablo lead and he'll take your dick vaginally.", "Pablo Leads");
		}
