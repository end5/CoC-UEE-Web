...
export class JewelryShop extends Shop {
	...
	protected override function inside(): void {
		...
		addButton(5, "Jewelry box",curry(confirmBuy, undefined, 500, Inventory.STORAGE_JEWELRY_BOX));
	...
	protected override function noBuyOption(itype:ItemType = undefined, keyItem: string = ""): void {
		clearOutput();
		if(isJewelryBox(keyItem)){
	...
	protected override function debit(itype:ItemType = undefined, priceOverride: number = -1, keyItem: string = ""): void {
		if (isJewelryBox(keyItem)) {
