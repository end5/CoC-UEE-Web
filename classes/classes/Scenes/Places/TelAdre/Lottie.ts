...
export class Lottie extends TelAdreAbstractContent {
    ...
    public lottieAppearance(display: boolean = true) {
        ...
        if (this.flags[kFLAGS.MET_MARAE] <= 0) return undefined;
        if (this.getGame().time.hours >= 15 && this.getGame().time.hours <= 23) {
            if (this.flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER] == 0) {
                ...
                if (display) {
                    // [RANDOM INTROS]
                    // [Encouragement 0 – 30]
                    if (this.flags[kFLAGS.LOTTIE_CONFIDENCE] < 30 && Lottie.rand(6) == 0) {
                        ...
                        if (this.silly()) this.outputText("  What can you say? You love making bacon.");
                    }
                    // [Encouragement 0 – 30]
                    else if (this.flags[kFLAGS.LOTTIE_CONFIDENCE] < 30 && Lottie.rand(5) == 0) {
                        ...
                        if (this.silly()) this.outputText("  What can you say? Her pork buns are the best.");
                    }
                    // [REPEAT INTROS]
                        ...
                        if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 33) this.outputText("voluptuous");
                        else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 66) this.outputText("plump");
                        else this.outputText("curvy");
                        this.outputText(" pig girl jogs on the spot to wake herself up - unintentionally jiggling her " + this.lottieCup() + "-cup breasts and soft ass in the process. She walks over to the nearby cafe and sits down on her ");
                        if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 33) this.outputText("bountiful");
                        else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 66) this.outputText("chubby");
                        ...
                        if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 33) this.outputText("voluminous");
                        else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 66) this.outputText("chubby");
                        else this.outputText("cute");
                        this.outputText(" rump.");
                    }
    ...
    private lottieCup(): string {
        // (d/e/f/g)
        if (this.flags[kFLAGS.LOTTIE_FIGURE] >= 75) return "D";
        else if (this.flags[kFLAGS.LOTTIE_FIGURE] >= 50) return "E";
        else if (this.flags[kFLAGS.LOTTIE_FIGURE] >= 25) return "F";
        else return "G";
    }
    ...
    public encounterLottie(charge: boolean = false): void {
        this.spriteSelect(SpriteDb.s_lottie);
        let comedy1;
        ...
        this.flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER]++;
        // [INITIAL ENCOUNTER]
        if (this.flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER] == 1) {
            this.flags[kFLAGS.LOTTIE_FIGURE] = 50;
            this.flags[kFLAGS.LOTTIE_CONFIDENCE] = 50;
            this.flags[kFLAGS.LOTTIE_LAST_ENCOURAGEMENT_STATE] = 50;
            this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] = 50;
            ...
            // [If Don't Meet Full Requirements]
                ...
                this.outputText("You aren't really doing much else here, so you decide to return home.");
        ...
        // [REPEAT ENCOUNTER]
            ...
            if (this.flags[kFLAGS.LOTTIE_CONFIDENCE] >= 50) this.outputText("relaxing");
            else this.outputText("sitting timidly");
            this.outputText(" at a table, wearing her low-cut top and booty shorts that accentuate her ");
            if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 50) this.outputText("plump");
            else this.outputText("curvy");
            this.outputText(" figure.  ");
            if (this.flags[kFLAGS.LOTTIE_LOVES_HER_BODY] == 0) this.outputText("Lightly sipping");
            else this.outputText("Slurping down");
            this.outputText(" what appears to be ");
            if (this.flags[kFLAGS.LOTTIE_LOVES_HER_BODY] == 0) this.outputText("some juice");
            else this.outputText("a milkshake");
            this.outputText(", her eyes wander over the room when she spots you and waves");
            if (this.flags[kFLAGS.LOTTIE_CONFIDENCE] >= 70) this.outputText(" excitedly");
            ...
            if (this.flags[kFLAGS.LOTTIE_TRAINER] == 0 && (this.player.isNaga() || this.player.isTaur() || this.player.tone < 50)) {
                ...
                this.menu();
                this.addButton(0, "Leave", this.telAdre.gym.gymDesc);
                return;
            }
            // [Normal Encounter, If became met requirements]
            else if (this.flags[kFLAGS.LOTTIE_TRAINER] == 0) {
                ...
                // [Yes][No][God No]
                this.menu();
                this.addButton(0, "Yes", this.gotInShapeAcceptTrainingOffer);
                this.addButton(1, "No", this.gotInShapeButTurnedDownLottie);
                if (this.silly() && (this.player.isCorruptEnough(80) || this.player.hasPerk(PerkLib.Sadist))) {
                    this.addButton(2, "God No", this.gotInShapeComedyDeclineLottie);
                }
                return;
            }
            // [Second Encounter, If fucked Lottie]
            else if (this.flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER] == 2 && this.flags[kFLAGS.LOTTIE_PORKED_COUNT] > 0) {
            ...
            else if (this.flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER] == 2) {
            ...
            // [Fourth Encounter, If didn't take Lust Draft]
            else if (this.flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER] == 4 && this.flags[kFLAGS.LOTTIE_PORKED_COUNT] == 0) {
                ...
                // [Sex][Buddies]
                this.menu();
                this.addButton(0, "Sex", this.fourthMeetingChooseSexWithLottie);
                this.addButton(1, "Buddies", this.stayLottieBuds4Evah);
                return;
            }
            // [Encouragement moved from 31 to 30, first time]
            else if (this.flags[kFLAGS.LOTTIE_ENCOURAGEMENT_THRESHOLD_31_30_DOWN] == 0 && this.flags[kFLAGS.LOTTIE_LAST_ENCOURAGEMENT_STATE] > 30 && this.flags[kFLAGS.LOTTIE_CONFIDENCE] <= 30) {
                ...
                this.flags[kFLAGS.LOTTIE_ENCOURAGEMENT_THRESHOLD_31_30_DOWN] = 1;
                this.flags[kFLAGS.LOTTIE_LAST_ENCOURAGEMENT_STATE] = this.flags[kFLAGS.LOTTIE_CONFIDENCE];
            }
            ...
            else if (this.flags[kFLAGS.LOTTIE_LAST_ENCOURAGEMENT_STATE] <= 30 && this.flags[kFLAGS.LOTTIE_CONFIDENCE] > 30) {
                this.flags[kFLAGS.LOTTIE_LAST_ENCOURAGEMENT_STATE] = this.flags[kFLAGS.LOTTIE_CONFIDENCE];
                // first time
                if (this.flags[kFLAGS.LOTTIE_ENCOURAGEMENT_THRESHOLD_30_31_UP] == 0) {
                    ...
                    this.flags[kFLAGS.LOTTIE_ENCOURAGEMENT_THRESHOLD_30_31_UP] = 1;
                }
            ...
            else if (this.flags[kFLAGS.LOTTIE_LAST_ENCOURAGEMENT_STATE] > 80 && this.flags[kFLAGS.LOTTIE_CONFIDENCE] <= 80) {
                this.flags[kFLAGS.LOTTIE_LAST_ENCOURAGEMENT_STATE] = this.flags[kFLAGS.LOTTIE_CONFIDENCE];
                // , first time]
                if (this.flags[kFLAGS.LOTTIE_ENCOURAGEMENT_THRESHOLD_80_79_DOWN] == 0) {
                    this.flags[kFLAGS.LOTTIE_ENCOURAGEMENT_THRESHOLD_80_79_DOWN] = 1;
            ...
            // [Encouragement moved from 79 to 80, first time]
                ...
                this.flags[kFLAGS.LOTTIE_LAST_ENCOURAGEMENT_STATE] = this.flags[kFLAGS.LOTTIE_CONFIDENCE];
                // , first time]
                if (this.flags[kFLAGS.LOTTIE_ENCOURAGEMENT_THRESHOLD_79_80_UP] == 0) {
                    this.flags[kFLAGS.LOTTIE_ENCOURAGEMENT_THRESHOLD_79_80_UP] = 1;
                ...
                // [Encouragement moved from 79 to 80, regular]
                    ...
                    this.outputText("\"<i>Hey, " + this.player.short + ".Thanks for being... nicer, again. Sometimes I really worry about you, but... well; I'm fine with putting that behind us. I'm glad, y'know?</i>\" She throws you a smile, confident that you won't mistreat her again. You smile back, silently assuring her that you won't, today.");
                }
            }
            // [Normal Encounter, Encouragement 60 - 100]
            else if (this.flags[kFLAGS.LOTTIE_CONFIDENCE] >= 60) {
                // [Figure 0 – 20]
                if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 20 && this.flags[kFLAGS.LOTTIE_LOVES_HER_BODY] == 0) this.outputText("\"<i>Oh, " + this.player.short + "! Let's do our best today, I really wanna lose those pounds! I know I can do my best when I'm with you!</i>\" Lottie beams, her massive tits pushed against the table. She seems to be excited for what you've got in store today.");
                // [Figure 0 - 20, convinced her to accept body]
                else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 20) this.outputText("\"<i>Hey, " + this.player.mf("stud", "cutie") + "! You shouldn't keep a big girl like me waiting; unless you wanna get crushed by these!</i>\" Lottie grins and grabs her luscious breasts firmly, giggling when she notices you're at full attention now. She seems to be excited for what you've got in store today.");
                // Figure 20 - 40, haven't convinced her to accept body]
                else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 40 && this.flags[kFLAGS.LOTTIE_LOVES_HER_BODY] == 0) this.outputText("\"<i>Ah, " + this.player.short + "! We should probably get started soon; I'm gonna push myself to the limit today!</i>\" Lottie's arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems to be excited for what you've got in store today.");
                // [Figure 20 - 40, convinced her to accept body]
                else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 40) this.outputText("\"<i>Hey, " + this.player.mf("stud", "cutie") + "! You shouldn't keep me waiting; the only thing I'm losing right now is my patience!</i>\" Lottie grins and punches your arm playfully, squealing when you try to get her back. She seems to be excited for what you've got in store today.");
                // [Figure 40 - 60]
                else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 60) this.outputText("\"<i>Hey! I was looking for you earlier, y'know? I can't wait to get started.</i>\" She looks happy that you've arrived. Lottie leans over to grab her beverage, giving you an excellent view of her supple mounds. She seems to be excited for what you've got in store today.");
                // [Figure 60 - 80]
                else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 80) this.outputText("\"<i>Yo, " + this.player.mf("big guy", "babe") + "! I've been waiting for you, so you better be pumped! Ready to get started?</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.");
                // [Figure 80 - 100]
                else this.outputText("\"<i>Hey, " + this.player.mf("stud", "cutie") + "! You shouldn't keep me waiting, or I'll put you through the burn twice as hard! You ready?</i>\" Lottie winks at you and punches your arm playfully. She seems to be excited for what you've got in store today.");
            }
            // [Normal Encounter, Encouragement 30 - 60]
            else if (this.flags[kFLAGS.LOTTIE_CONFIDENCE] >= 30) {
                // [Figure 0 - 20]
                if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 20) this.outputText("\"<i>Oh, " + this.player.short + ", hey. I think we should try and get into it today. I don't think I tried hard enough last time, y'know?</i>\" Lottie leans over to grab her beverage, her massive tits pushed against the table. She seems to be intent on trying her best today.");
                // [Figure 20 - 40]
                else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 40) this.outputText("\"<i>A-ah, " + this.player.short + "! We should probably get started soon; I... I want to push myself to the limit today!</i>\" Lottie's arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems curious as to what you both plan to do today.");
                // [Figure 40 - 60]
                else if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 60) this.outputText("\"<i>H-hey! I was looking for you earlier, y'know? I can't wait to get started.</i>\" She looks at ease now that you've arrived. Lottie leans over to grab her beverage, giving you an excellent view of her supple mounds. She seems curious as to what you both plan to do today.");
                // [Figure 60 - 80]
                else this.outputText("\"<i>Hello " + this.player.short + "! I've... I've been waiting for you, so you better be ready, hey! Don't hold back!</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.");
            }
            // [Normal Encounter, Encouragement 0 - 30]
            else {
                // [Normal Encounter, Figure 0 – 70]
                if (this.flags[kFLAGS.LOTTIE_FIGURE] <= 70) this.outputText("\"<i>Oh, " + this.player.short + "... I know I haven't been trying the way you want me to. I – I punished myself extra hard last night! Please, let me try again today!</i>\" Lottie leans over and looks at you desperately, her creamy tits pushed against the table. You can see they're redder than before. Has she been trying to slap her fat away? You turn away, not giving her the pleasure of looking at your face. You agree to help her – but don't expect to be looked at by the only person who can stand you if this goes on. Lottie squeals and manages to blurt out a 'th-thank you!' in response.");
        ...
        // [Appearance][Talk][Exercise][Give Item][Sex][Hug]
        this.menu();
        this.addButton(0, "Appearance", this.lotteryAppearance);
        this.addButton(1, "Talk", this.talkToPigSlut);
        this.addButton(2, "Exercise", this.lottieExercise);
        this.addButton(3, "Give Item", this.giveLottieAnItem);
        if (this.player.lust >= 33) {
            this.addButton(4, "Sex", this.lottieFuck);
        } else {
            this.addDisabledButton(4, "Sex");
        }
        this.addButton(5, "Hug", this.hugTheShitOutOfYourHam);
        this.addButton(14, "Leave", this.telAdre.gym.gymDesc);
        this.flags[kFLAGS.LOTTIE_LAST_ENCOURAGEMENT_STATE] = this.lottieMorale();
        if (this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] == 0) this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] = this.lottieTone();
    }
    ...
    private fourthMeetingChooseSexWithLottie(): void {
        ...
        this.menu();
        this.addButton(0, "Oral", this.getSuckedOffByAHamSandwich);
        this.addButton(1, "Anal", this.analLottieMilkshake);
    }
    ...
    private declineBeingLottiesGymHamsandwich(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.clearOutput();
        this.outputText("\"<i>O-oh, um... okay. I understand! You're probably busy what with all that lifting you're getting up to, haha!</i>\" The pig girl chuckles nervously, shifting her towel to cover more of her soft cleavage.  \"<i>I'll uh – I'll go get outta your hair then. I've got some stuff to do at home.</i>\"  You watch as she jogs off through the door and out into Tel'Adre, towel and all.  You decide you better return home too, and head back towards the camp.");
        // [PC no longer encounters Lottie.]
        this.flags[kFLAGS.LOTTIE_DISABLED] = 1;
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private acceptBeingLottiesHamSandwich(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.clearOutput();
        this.flags[kFLAGS.LOTTIE_TRAINER] = 1;
        ...
        this.outputText("You take this opportunity to get a good look at Lottie. She stands at around 4'8</i>\", considerably shorter than average, ");
        if (this.player.tallness > 60) this.outputText("and shorter than you");
        else if (this.player.tallness > 53) this.outputText("but you can't judge, being roughly the same height");
        ...
        // [Water][Shake]
        this.menu();
        this.addButton(0, "Water", this.drinkWaterWithYourHamhock);
        this.addButton(1, "Shake", this.drinkLustWithYourHamhock);
    }
    ...
    private gotInShapeButTurnedDownLottie(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.outputText("\"<i>O-oh, um... okay. I understand! You're probably busy what with all that lifting you're getting up to, haha!</i>\" The pig girl chuckles nervously, shifting her towel to cover more of her soft cleavage. \"<i>I'll uh – I'll go get outta your hair then. I've got some stuff to do at home.</i>\" You watch as she jogs off through the door and out into Tel'Adre, towel and all. You decide you'd better return home too, and head back towards the camp.");
        // [PC no longer encounters Lottie.]
        this.flags[kFLAGS.LOTTIE_DISABLED] = 1;
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    public gotInShapeComedyDeclineLottie(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.clearOutput();
        this.outputText("Haha, of course you fucking aren't, why would you be? Lottie stares at you, tears welling in her eyes. Oh, whoops – you must've said that out loud. Proceeding to not give two shits about the bawling pig-slut in front of you, you take a good squeeze of her cushiony tits before whipping your " + this.player.cockDescript(this.player.biggestCockIndex()) + " out and slapping her in the face with it.  \"<i>W-w-why... why are you... *sniff* p-please...!</i>\" The pig girl chokes in between sobs. It almost gives you a hard on - almost. You take one final step backwards, before announcing quite loudly to the other cafe-goers that you're going for a home run. Lottie squeaks before you take your " + this.player.cockDescript(this.player.biggestCockIndex()) + " and swing at her face, hitting dead on and managing to leave a bit of pre-cum on her newly-christened cheek. You stand triumphantly at your latest work of art, though Lottie seems to have other ideas, running out the door in complete misery, pre-cum and all. You decide you'd better return home too, and head back towards the camp – but not before spending the next hour or so chasing after Lottie and taking grabs at her plush ass.");
        // [PC no longer encounters Lottie.]
        this.flags[kFLAGS.LOTTIE_DISABLED] = 1;
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private gotInShapeAcceptTrainingOffer(): void {
        ...
        this.outputText("You take this opportunity to get a good look at Lottie. She stands at around 4'8</i>\", considerably short on average, ");
        if (this.player.tallness > 60) this.outputText("and shorter than you");
        else if (this.player.tallness > 53) this.outputText("but you can't judge, being roughly the same height");
        else this.outputText("taller than you");
    ...
    private drinkWaterWithYourHamhock(): void {
        ...
        if (this.flags[kFLAGS.TIMES_HAD_YOGA] == 0) this.outputText("You've never had any experience with the yoga classes first hand, but you tell ");
    ...
    private drinkLustWithYourHamhock(): void {
        ...
        this.outputText("You take her by the hand and lead her into one of the empty saunas. \"<i>" + this.player.short + "...</i>\" You grab her by the hips and lean her against the wall, throwing off her towel and revealing her velvety skin underneath. Reaching down, you grab a handful of her luxurious ass, squeezing and slapping it lightly. Lottie moans into your shoulder and reaches towards your groin, removing your " + this.player.armorName + ". She begins stroking " + this.player.oMultiCockDesc() + " lightly, picking up the pace as you continue to work on her pert rump. You can't help but lust over her full figure, using one of your hands to firmly grope her pillowy jugs and reaching your other towards her glistening pussy. You move your hand over her cushiony rack, before burying your head into her bosom and eagerly sucking on one of her nipples, fondling the other between your thumb and forefinger. Your other hand is already fast at work, fingering her hot cunt. You can feel her legs about to buckle beneath their own weight. Lottie moans in between short, hot breaths, \"<i>Y-you're... really amazing, " + this.player.mf("guy", "lady") + ".</i>\"  You give her chubby ass a hard slap in agreement.  Lottie squeals in glee, jerking your " + this.player.cockDescript(0) + " as it pokes into her soft stomach. The sensation of your tip rubbing against her velvety skin drives you wild.\n\n");
    ...
    public analLottieMilkshake(): void {
        ...
        let x: number = this.player.cockThatFits(40);
        if (x < 0) x = 0;
        this.outputText("You brush her grip off of " + this.player.oMultiCockDesc() + ", only to turn her around and fit your girth between her large cheeks");
        if (this.player.totalCocks() == 2) this.outputText(", managing to squeeze in your other cock along with it");
        else if (this.player.totalCocks() > 2) this.outputText(", the rest of your dicks poking and prodding against her soft flesh");
        this.outputText(".  \"<i>You sure do like my butt, huh?</i>\"  She giggles softly, satisfied that at least some of her fat is being put to use.  You groan as she starts to move her ample hips, massaging your " + this.player.cockDescript(x) + " within her jiggling buttocks.  Your tip brushes against her asshole, smearing pre-cum all over the hot entrance.  Lottie starts to push back towards your cock, clearly overcome with lust.  You wait a few seconds as she aimlessly grinds against you before you spread her cheeks and plunge your " + this.player.cockDescript(x) + " into her tight backdoor. Lottie squeals against the wall in delight as you fill her stomach and begin pounding away at her relentlessly, her large tits bouncing rhythmically. She continues to drive herself into you, her tight, fiery insides squeezing your length whilst you watch her heavy butt ripple with every thrust.\n\n");
        ...
        this.outputText("\"<i>A-aa-ah, I-I... AHH!</i>\" Lottie oinks noisily, her eyes rolling to the back of her head and her large thighs slapping against your own, pulling your " + this.player.cockDescript(x) + " further in. She shudders in orgasm");
        if (this.player.balls > 0) this.outputText(", her soaked pussy rubbing against your balls");
        this.outputText(".\n\n");
        ...
        if (this.player.cockTotal() > 1) {
            ...
            this.outputText(" and push it against her puckered hole. \"<i>H-hey, wait a mome- OHH!</i>\" You ease yourself back into her, with ");
            if (this.player.cockTotal() == 2) this.outputText("your two ");
            else this.outputText("two of your ");
            this.outputText(" throbbing cocks buried deep in her rectum. The pressure against your hot rods is immense, though you continue to slowly push and pull her sweaty ass against you, enjoying the feeling of her meaty fuckpillows as they massage your cock");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(".\n\n");
        }
        if (this.player.balls > 0) this.outputText("Your " + this.player.sackDescript() + " begins to swell");
        ...
        this.outputText(" with your hot, thick spunk. She squeals again as you bring her to orgasm, ramming herself into you to collect as much of your cum as possible. You continue to pound her bouncy buttocks as you release the rest of your seed inside of her");
        // [If large cum production]
        if (this.player.cumQ() >= 500) this.outputText(", a heavy amount leaking from her ass");
        ...
        this.lottieTone(1);
        if (this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ANAL] == 0) this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ANAL] = 1;
        this.outputText(this.player.modTone(100, 1));
    ...
    public getSuckedOffByAHamSandwich(): void {
        ...
        this.outputText("You grab Lottie's shoulders and firmly move her down towards your crotch. She kneels down, face to face with your " + this.player.cockDescript(x) + ".  Feeling her hot breath against your " + this.player.skinFurScales() + ", you tell her to suck it.\n\n");

        // [If player cock is at or below 4']
        if (this.player.cocks[x].cockLength <= 4) {
            this.outputText("She stares at your " + this.player.cockDescript(x) + " and then up at you. \"<i>I... oh, well I guess this is okay.</i>\" She lazily slurps your member into her mouth, and moans at the taste of your " + this.player.cockDescript(x) + ". Her agile tongue moves over your entire length, licking gently over your sensitive head and along your shaft. Your " + this.player.cockDescript(x) + " sits comfortably inside her warm hole, covered in her saliva");
            if (this.player.cockTotal() > 1) {
        ...
        // [If the player has a cock between 5' – 12']
            ...
            this.outputText("She stares intently at your " + this.player.cockDescript(x) + " with hunger in her eyes. A small amount of drool escapes her luscious lips as she moves forward, kissing your ");
            if (this.player.cockTotal() > 1) this.outputText(" biggest head lightly");
            else this.outputText(" head lightly");
            this.outputText(".  Her saliva leaks onto your " + this.player.cockDescript(x) + ", though she is quick to lick it up while she works her tongue around the rest of your shaft");
            if (this.player.cockTotal() > 1) this.outputText(", jerking off your " + this.player.cockDescript(this.player.biggestCockIndex2()) + " with both hands");
        ...
        // [If the player has a cock equal to or over 13']
            ...
            this.outputText("She gasps as you lift your " + this.player.cockDescript(x) + " and slap her face. \"<i>It's... wow, " + this.player.short + "!</i>\" You grin before poking her pudgy cheek with the tip of your ");
            if (this.player.cockTotal() > 1) this.outputText("biggest erection");
            else this.outputText("erection");
            this.outputText(".  A small amount of drool escapes her luscious lips as she moves forward, kissing your head lightly. Her saliva leaks onto your " + this.player.cockDescript(x) + ", though she is quick to lick it up while she works her tongue around the rest of your lengthy shaft");
            if (this.player.cockTotal() > 1) this.outputText(" - using her hands to massage your leftover " + this.player.cockDescript(this.player.biggestCockIndex2()));
            this.outputText(". She places small licks on the tip of your head, and without warning stuffs as much of your thick girth as she can into her mouth, coughing around your " + this.player.cockDescript(x) + ".\n\n");
        }

        this.outputText("She begins fellating your cock at an incredible rate, throatfucking herself on your " + this.player.cockDescript(x));
        if (this.player.balls > 0) this.outputText(", your sack slapping against her chin ");
        else if (this.player.biggestTitSize() > 2) this.outputText(" while you play with your " + this.player.biggestBreastSizeDescript());
        this.outputText(". You remark on what a hungry little piggy she must be, and the chubby girl moans in response, the vibrations massaging your member. Relishing the feeling of your " + this.player.cockDescript(x) + " in between her hungry lips, you start to thrust into her warm mouth hole, grabbing onto her head as you pound her face against your groin.");
        if (this.player.cockTotal() > 1) {
            if (this.player.cockTotal() == 2) this.outputText("  Your extra cock flails wildly, slapping against her cheeks.");
            else if (this.player.cockTotal() > 2) this.outputText("  Your extra cocks flail wildly, slapping against her cheeks.");
        }
        this.outputText("  Lottie's slick tongue desperately wraps itself around your length as you drive in and out of her fuckhole relentlessly, drool beginning to leak from her mouth. She");
        // [if Multi]
        if (this.player.cockTotal() > 1) this.outputText(" stops rubbing your " + this.player.cockDescript(x) + " to ");
        // (Otherwise)
        else this.outputText(" reaches down towards her dripping pussy; plunging two fingers into her wetness while using the other hand to ");
        // If Balls]
        if (this.player.balls > 0) this.outputText("knead your " + this.player.ballsDescriptLight());
        else this.outputText("reach around and squeeze your " + this.player.buttDescript());
        ...
        this.outputText("You slowly take your " + this.player.cockDescript(x) + " out of her hot mouth, a small *pop* breaking the silence as it escapes her plump, puckered lips. Grabbing one of her hefty tits in your hands, you rub your cockhead against her erect nipple, eliciting a small moan from the sweaty slut. You slap your " + this.player.cockDescript(x) + " against her sweaty chest a few times before burying it in between her cleavage, ");
        // [If the player has a cock equal to or over 13']
        if (this.player.cocks[x].cockLength > 12) this.outputText("your sensitive tip brushing against her eager mouth");
        // Otherwise]
        ...
        // [If the player has a cock equal to or over 13']
        if (this.player.cocks[x].cockLength > 12) this.outputText("Licking at your cockhead, Lottie squishes her breasts against the rest of your member, making sure to lap up the stray beads of pre-cum squirting from your tip. Relishing the taste of your " + this.player.cockDescript(x) + " in her mouth she begins to suck at your head, flicking her tongue around your urethra and pressing her full lips against it, creating a vacuum of pleasure around your manhood.\n\n");
        ...
        if (this.player.cockTotal() > 1) {
            ...
            this.outputText(" extra cock as you push it between her pouty lips, her face brushing against it while she tries to titfuck your main member. Looking up at you, Lottie descends on you and begins fellating your " + this.player.cockDescript(this.player.biggestCockIndex2()) + ", not forgetting to knead her fat tits into your " + this.player.cockDescript(x) + ".\n\n");
        }
        ...
        this.outputText(".  You throb against her hot flesh, feeling your spunk bubbling up inside you.  Throwing your head back, you give one final thrust before pulling back and exploding all over your squishy slut, ");
        if (this.player.cumQ() < 500) this.outputText("thick ropes of cum splattering all over her face and pooling in between her tits");
        else this.outputText("massive globules of cum splattering all over her face and painting her tits");
        ...
        this.outputText("cum you've painted on her flesh and gulping it all down. \"<i>Thanks for the load, " + this.player.mf("big guy", "babe") + ",</i>\" she remarks, sucking gently on her fingers. \"<i>I'll... I'll see you again, hey!</i>\" You pat her on the head and begin to make your way out of the gym, making sure to grab a ");
        if (this.silly()) this.outputText("bacon ");
        this.outputText("shake on the way out.");
        // LOTTIE FIGURE -1, MUSCLE TONE +1, DRAINS PC'S LUST.
        this.lottieTone(-1);
        if (this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ORAL] == 0) this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ORAL] = 1;
        this.outputText(this.player.modTone(100, 1));
        this.player.orgasm('Dick');
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private lotteryAppearance(): void {
        ...
        if (this.lottieTone() <= 20) {
            this.outputText("She stands at around 4'8</i>\", considerably short on average, ");
            if (this.player.tallness > 60) this.outputText("and shorter than you");
            else if (this.player.tallness > 53) this.outputText("but you can't judge, being roughly the same height");
            else this.outputText("taller than you");
        ...
        // [If Figure between 40 - 60]
            ...
            this.outputText("She stands at around 4'8</i>\", short on average, ");
            if (this.player.tallness > 60) this.outputText("and shorter than you");
            else if (this.player.tallness > 53) this.outputText("but you can't judge, being roughly the same height");
            else this.outputText("taller than you");
            this.outputText(". Physique-wise, Lottie is definitely a bit chubbier than most girls, though you couldn't call her fat - of the few pig people you have seen around Tel'Adre, she's definitely the 'thinnest'. The majority of her weight is focused in her cushiony breasts, ample thighs and large ass, though her stomach is rounded nicely to support the weight of her upper body. Her heart-shaped face is complimented by her button nose and soft lips, framed by her pink-gray hair, which ends in small curls. A small, coiled tail rests above her rump.");
    ...
    public lottieTone(dif: number = 0): number {
        if (dif == 0) return this.flags[kFLAGS.LOTTIE_FIGURE];
        if (this.debug) this.outputText("\n<b>(DEBUG: Lottie Tone changed by " + dif + "!)</b>\n");
        this.flags[kFLAGS.LOTTIE_FIGURE] += dif;
        if (this.flags[kFLAGS.LOTTIE_FIGURE] > 100) this.flags[kFLAGS.LOTTIE_FIGURE] = 100;
        else if (this.flags[kFLAGS.LOTTIE_FIGURE] < 0) this.flags[kFLAGS.LOTTIE_FIGURE] = 0;
        // Clear blowjob/anal change talk flags in case tone is getting out of whack.
        if (this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ORAL] == 1) this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ORAL] = 0;
        if (this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ANAL] == 1) this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ANAL] = 0;
        return this.flags[kFLAGS.LOTTIE_FIGURE];
    }
    public lottieMorale(dif: number = 0): number {
        if (dif == 0) return this.flags[kFLAGS.LOTTIE_CONFIDENCE];
        if (this.debug) this.outputText("\n<b>(DEBUG: Lottie Morale changed by " + dif + "!)</b>\n");
        this.flags[kFLAGS.LOTTIE_CONFIDENCE] += dif;
        if (this.flags[kFLAGS.LOTTIE_CONFIDENCE] > 100) this.flags[kFLAGS.LOTTIE_CONFIDENCE] = 100;
        else if (this.flags[kFLAGS.LOTTIE_CONFIDENCE] < 0) this.flags[kFLAGS.LOTTIE_CONFIDENCE] = 0;
        return this.flags[kFLAGS.LOTTIE_CONFIDENCE];
    }
    ...
    private talkToPigSlut(): void {
        ...
        // FIRST TIMER SHIT
        // [If 1st Time Oral]
        if (this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ORAL] == 1) {
            this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ORAL] = 2;
            ...
            // [Encourage][Abuse]
            this.menu();
            this.addButton(0, "Encourage", this.firstOralReactionChooseEncourage);
            this.addButton(1, "Abuse", this.firstOralReactionChooseAbuse);
        }
        // [If 1st Time Anal]
        else if (this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ANAL] == 1) {
            this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ANAL] = 2;
            ...
            // [Encourage][Abuse]
            this.menu();
            this.addButton(0, "Encourage", this.firstAnalReactionChooseEncourage);
            this.addButton(1, "Abuse", this.firstAnalReactionChooseAbuse);
        }
        // FATNESS
        // [If Gained Weight since Last Encounter, Encouragement 0 - 30]
        else if (this.lottieMorale() <= 30 && this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] - 5 > this.lottieTone()) {
            ...
            // [Encourage][Abuse]
            this.menu();
            this.addButton(0, "Encourage", this.lottieLowMoraleWeightGainEncourage);
            this.addButton(1, "Abuse", this.lottieLowMorealeWeightGainAbuse);
        }
        // [If Gained Weight since Last Encounter, Encouragement 30 - 70]
        else if (this.lottieMorale() <= 70 && this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] - 5 > this.lottieTone()) {
            ...
            // [Encourage][Abuse]
            this.menu();
            this.addButton(0, "Encourage", this.lottieMediumMoraleWeightGainEncourage);
            this.addButton(1, "Abuse", this.lottieMediumMorealeWeightGainAbuse);
        }
        // [If Gained Weight since Last Encounter, Encouragement 70 – 100, convinced 'Bigger is Better']
        else if (this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] - 5 > this.lottieTone() && this.flags[kFLAGS.LOTTIE_LOVES_HER_BODY] == 1) {
            ...
            // [Encourage][Abuse]
            this.menu();
            this.addButton(0, "Encourage", this.lottieHighMoraleWeightGainFATTYLOVESIT);
            this.addButton(1, "Abuse", this.lottieHighMoraleWeightGainFATTYLOVESABUSE);
        }
        // [If Gained Weight since Last Encounter, Encouragement 70 - 100]
        else if (this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] - 5 > this.lottieTone()) {
            ...
            // [Encourage][Abuse]
            this.menu();
            this.addButton(0, "Encourage", this.lottieHighMoraleWeightGainEncourage);
            this.addButton(1, "Abuse", this.lottieHighMoraleWeightGainAbuse);
        }
        // DEFATNESS
        // [If Lost Weight since Last Encounter, Encouragement 0 - 30]
        else if (this.lottieMorale() <= 30 && this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] < this.lottieTone() - 5) {
            ...
            // [Encourage][Abuse]
            this.menu();
            this.addButton(0, "Encourage", this.lottieLowMoraleWeightLossEncourage);
            this.addButton(1, "Abuse", this.lottieLowMoraleWeightLossAbuse);
        }
        // [If Lost Weight since Last Encounter, Encouragement 30 - 70]
        else if (this.lottieMorale() <= 70 && this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] < this.lottieTone() - 5) {
            ...
            // [Encourage][Abuse]
            this.menu();
            this.addButton(0, "Encourage", this.lottieMediumMoraleWeightLossEncourage);
            this.addButton(1, "Abuse", this.lottieMediumMoraleWeightLossAbuse);
        }
        // [If Lost Weight since Last Encounter, Encouragement 70 – 100, convinced 'Bigger is Better']
        else if (this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] < this.lottieTone() - 5 && this.flags[kFLAGS.LOTTIE_LOVES_HER_BODY] == 1) {
            ...
            this.menu();
            this.addButton(0, "Encourage", this.lottieHighMoraleWeightLossFATTYLOVESIT);
            this.addButton(1, "Abuse", this.lottieHighMoraleWeightLossFATTYLOVESABUSE);
        }
        // [If Lost Weight since Last Encounter, Encouragement 70 - 100]
        else if (this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] < this.lottieTone() - 5) {
            this.outputText("Her ears perk up at your eagerness to talk; she seems to be pretty excited about something. You ask her what's on her mind.  \"<i>That obvious, huh?</i>\" Lottie looks up at you and grins. \"<i>Y'see babe, since the last time we met, I've actually – I've lost weight!</i>\" She stands up, pumping her fist in the air and wiggling her plump ass. \"<i>I mean, I know it's not a big difference, but it's still a result! This is amazing!</i>\" She's clearly pleased with herself. You place a hand on her shoulder, and she beams at you. Do you encourage her, or break the bad news?\n\n");
            this.menu();
            this.addButton(0, "Encourage", this.lottieHighMoraleWeightLossEncourage);
            this.addButton(1, "Abuse", this.lottieHighMoraleWeightLossAbuse);
        }
        // [If Encouragement = 0, Figure = 0, first time]
        else if (this.lottieMorale() == 0 && this.lottieTone() == 0 && this.flags[kFLAGS.LOTTIE_FATASS_LOW_ESTEEM] == 0) {
            this.flags[kFLAGS.LOTTIE_FATASS_LOW_ESTEEM] = 1;
            ...
            this.menu();
            this.addButton(0, "To Fuck", this.lottieFatLoserCulminationFuckChoice);
            this.addButton(1, "To Humiliate", this.lottieFatLoserCulminationHumiliationChoice);
            if (this.silly()) {
                this.addButton(2, "To Leave", this.lottieFatLoserCulminationLeaveComedyChoice);
            } // silly mode - no disabled button
        }
        // [If Encouragement =100, Figure =0, first time]
        else if (this.lottieMorale() == 100 && this.lottieTone() == 0 && this.flags[kFLAGS.LOTTIE_LOVING_FAT_BITCH_EVENT] == 0) {
            this.flags[kFLAGS.LOTTIE_LOVING_FAT_BITCH_EVENT] = 1;
            ...
            this.menu();
            this.addButton(0, "Love Self", this.lottieHighMoraleFatLoveSelfOneTimeEvent);
            this.addButton(1, "StickWithIt", this.lottieHighMoraleFatYoullGetThereOneTimeEvent);
            if (this.silly()) {
                this.addButton(2, "EwLottieNo", this.ewLottieNo);
            } // silly mode - no disabled button
        }
        // [If Encouragement = 0, Figure = 100, first time]
        else if (this.lottieMorale() == 0 && this.lottieTone() == 100 && this.flags[kFLAGS.LOTTIE_CHARLOTTES_WEB_EVENT] == 0) {
            this.flags[kFLAGS.LOTTIE_CHARLOTTES_WEB_EVENT] = 1;
        ...
        // [If Neither, Encouragement 30 - 70]
            ...
            this.dynStats("lus", 2);
            this.outputText("Without much to go on, you can't really comment on her progress.");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        this.flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] = this.lottieTone();
    }
    ...
    private lottieLowMoraleWeightGainEncourage(): void {
        ...
        this.outputText("<b>...</b>After a good workout, you decide to return back to camp, exhausted.");
        // ENCOURAGEMENT +2
        this.lottieMorale(3);
        this.player.changeFatigue(10);
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private lottieHighMoraleWeightGainAbuse(): void {
        ...
        this.outputText("Deciding you're done here, you return back to camp – strangely satisfied.");
        this.lottieMorale(-10);
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private lottieFatLoserCulminationFuckChoice(): void {
        ...
        this.flags[kFLAGS.LOTTIE_DOGGYSTYLE_UNLOCKED] = 1;
        this.flags[kFLAGS.LOTTIE_PORKED_COUNT]++;
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private lottieHighMoraleFatLoveSelfOneTimeEvent(): void {
        ...
        this.outputText("As you feel yourself about to explode, you keep a tight grip on her hips before thrusting forward, filling her insides with your hot spunk. Lottie trembles in orgasm, the feeling of your cum inside of her sending her over the edge.");
        if (this.player.cockTotal() > 1) {
        ...
        this.outputText("  You both lay on the mat, panting in ecstasy while your " + this.player.cockDescript(x) + " continues to ejaculate inside her.\n\n");
        ...
        this.flags[kFLAGS.LOTTIE_COWGIRL_UNLOCKED] = 1;
        this.flags[kFLAGS.LOTTIE_PORKED_COUNT]++;
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private lottieHighMoraleFatYoullGetThereOneTimeEvent(): void {
        ...
        this.outputText("Sweaty and panting, Lottie lies on the floor, exhausted and full of your spunk. You slap her jiggling ass before walking out of the pool area, making sure to grab a ");
        if (this.silly()) this.outputText("bacon ");
        this.outputText("shake on the way out.");
        ...
        this.flags[kFLAGS.LOTTIE_QUICKIE_UNLOCKED] = 1;
        this.flags[kFLAGS.LOTTIE_PORKED_COUNT]++;
        this.player.orgasm('Dick');
        this.dynStats("sen", -3, "cor", -1);
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private lottieElleThreesomeFirstTime(): void {
        ...
        this.flags[kFLAGS.LOTTIE_THREESOME_UNLOCKED] = 1;
        this.flags[kFLAGS.LOTTIE_PORKED_COUNT]++;
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private fuckElleInsteadOfThatFatSlutFirstTime(): void {
        ...
        if (this.player.cockTotal() == 1) {
            this.outputText("begins to caress your " + this.player.cockDescript(x) + " with two of her hands, while the other sets to work on ");
        ...
        this.flags[kFLAGS.LOTTIE_ELLE_NTR_UNLOCKED] = 1;
        this.flags[kFLAGS.LOTTIE_PORKED_COUNT]++;
        this.player.orgasm('Dick');
    ...
    private leaveLottieInsteadOfYogaSex(): void {
        ...
        this.outputText("As you head home, you have the strangest feeling you've missed out on incredibly sexy sex.");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private lottieExercise(): void {
        ...
        this.menu();
        this.addButton(0, "Weights", this.lottieWeights);
        this.addButton(1, "Jogging", this.goJoggingWithLottie);
        this.addButton(2, "Yoga", this.lottieYoga);
        this.addButton(3, "Pool", this.lottiePool);
    }
    ...
    private lottieWeights(): void {
        ...
        if (this.lottieTone() <= 70) {
            ...
            // [Boast][Train]
            this.menu();
            this.addButton(0, "Boast", this.boastAtLottie);
            this.addButton(1, "Train", this.trainWithLottie);
            if (this.lottieMorale() <= 30 && this.flags[kFLAGS.TIMES_FUCKED_IFRIS_BLOWJOB] > 0 && this.player.str >= 75 && this.player.tone >= 60 && this.player.cumQ() >= 1000) {
                this.addButton(2, "NTR Lift", this.ifrisAndLottieGetsNTRedLiftingWeights);
            } else {
                this.addDisabledButton(2, "NTR Lift");
            }
        }
        // [If Figure 70 - 100]
        else {
            ...
            // [Boast][Train]
            this.menu();
            this.addButton(0, "Boast", this.boastAtFitLottie);
            this.addButton(1, "Train", this.trainWithFitLottie);
        }
    }
    ...
    private boastAtLottie(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.clearOutput();
        this.outputText("You laugh as you pick up one of the larger ones and pump mercilessly, looking at her expectantly as if she had been failing out of laziness. She tries harder to pull the heavy object over her head, but eventually she begins to shake and drops it, landing in the sand with a ");
        ...
        this.outputText("After a few more attempts at the weights, she eventually buckles under the pressure and gives up, walking home by herself. You snort and continue a few more well-earned reps before dropping down and recharging for the night.");
        this.player.changeFatigue(10);
    ...
    private trainWithLottie(): void {
        ...
        this.outputText("After a few more attempts at the weights, you both decide you've had enough, going your separate ways and waving as you leave the gym.");
        this.dynStats("str", .1);
        this.lottieMorale(2);
        this.lottieTone(2);
        this.player.changeFatigue(10);
    ...
    private goJoggingWithLottie(): void {
        ...
        if (this.lottieTone() <= 70) {
            ...
            // [Sprint][Jog]
            this.menu();
            this.addButton(0, "Sprint", this.sprintAndLeaveLottieBehind);
            this.addButton(1, "Jog", this.jogWithLottie);
        }
        // [If Figure 70 - 100]
        else {
            ...
            // [Sprint][Run]
            this.menu();
            this.addButton(0, "Sprint", this.sprintAndLeaveFitLottieBehind);
            this.addButton(1, "Jog", this.jogWithFitLottie);
        }
    }
    // [Sprint]
    private sprintAndLeaveLottieBehind(): void {
        ...
        this.outputText("A few rounds later, you've exhausted yourself so you decide to return home. You notice that Lottie's nowhere in sight, but it's her loss - not yours.");
    ...
    private sprintAndLeaveFitLottieBehind(): void {
        ...
        this.outputText("A few rounds later and you've exhausted yourself, so you decide to return home. You notice that Lottie's nowhere in sight, but it's her loss - not yours.");
        this.dynStats("tou", .2, "spe", .25);
        this.lottieMorale(-3);
        this.player.changeFatigue(10);
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private lottieYoga(): void {
        ...
        // [Alone] [Together]
        this.menu();
        this.addButton(0, "Alone", this.lottieYogaAlone);
        this.addButton(1, "Together", this.togetherLottieYoga);
    }
    ...
    private lottieYogaAlone(): void {
        ...
        this.outputText("You continue to take on the vaguely sexual positions of the athletic yoga teacher, the class ending before you know it. Your head strangely dizzy from the smell of sweat and pheromones, you walk home by yourself, completely forgetting about Lottie.");
        this.outputText(this.player.modThickness(30, 1));
        this.outputText(this.player.modTone(60, 1));
        this.lottieMorale(-2);
    ...
    private togetherLottieYoga(): void {
        ...
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(", while you secretly relish in the fact that you're at the back of the class. \"<i>Was... was that because of me?</i>\" Lottie whispers, tactlessly pointing directly at your " + this.player.multiCockDescriptLight() + ". You nod in response, Lottie giggling at your aroused reaction to her body. She playfully slaps your stiff length, and returns to her stretches. You groan and move towards an easier, less-exposed position.\n\n");

        this.outputText("The class ends a while later, Lottie continuing to tease you as you walk out of the gym. You note in your head that you'll get her back later, but for now you're exhausted.");
        this.lottieMorale(4);
        this.lottieTone(1);
        this.player.changeFatigue(5);
    ...
    private jumpInPoolBeforeLottieSeesYourWingWang(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.clearOutput();
        this.outputText("You can't risk it, so you decide to take a plunge into the water – it's freezing at first, but you quickly warm up. Lottie takes your avoidance to heart and looks visibly discouraged, though you wonder what her reaction would've been if your cockrocket");
        if (this.player.cockTotal() > 1) this.outputText("s");
        ...
        this.outputText(this.player.modTone(100, 2));
    ...
    private waitAndShowLottieYourPoolBoner(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.clearOutput();
        this.outputText("You figure it can't do much harm to let " + this.player.sMultiCockDesc() + " fly, so you decide to leave it be, even leaning back so as to accentuate the hardening length. It doesn't take long for Lottie to notice, letting out a little gasp as she observes your ");
        ...
        this.outputText("A while later and you've both finished off several laps of the pool, exhausted from your progress. Lottie flashes you a large smile before you part ways, leaving you still somewhat aroused from the experience.");
        this.outputText(this.player.modTone(100, 2));
        this.dynStats("lus", 80);
        this.lottieTone(2);
        this.lottieMorale(2);
    ...
    public giveLottieAnItem(): void {
        ...
        this.clearOutput();
        this.menu();
        this.addDisabledButton(0, "Cafe");
        if (this.player.hasItem(this.consumables.LABOVA_)) {
            this.addButton(1, "LaBova", this.feedLottieLaBova);
        } else {
            this.addDisabledButton(1, "LaBova");
        }
        if (this.player.hasItem(this.consumables.GROPLUS) && this.flags[kFLAGS.FACTORY_SHUTDOWN] > 0) {
            this.addButton(2, "Gro Plus", this.giveLottieGroPlus);
        } else {
            this.addDisabledButton(2, "Gro Plus");
        }
        if (this.player.hasItem(this.consumables.REDUCTO)) {
            this.addButton(3, "Reducto", this.giveLottieReducto);
        } else {
            this.addDisabledButton(3, "Reducto");
        }
        this.addButton(14, "Back", this.encounterLottie);

        if (this.flags[kFLAGS.LOTTIE_TIMES_GIVEN_ITEMS] == 0) {
            ...
            // [LaBova][Gro+][Reducto]
            this.flags[kFLAGS.LOTTIE_TIMES_GIVEN_ITEMS]++;
        }
        // [Give Item – Repeat Encounter]
            ...
            this.addButton(0, "Cafe", this.feedLottieAWholeCafe);
            if (this.silly()) {
                this.addButton(4, "HamSandwich", this.hamSammitchTimeBIATCH);
    ...
    public feedLottieLaBova(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.clearOutput();
        if (this.flags[kFLAGS.LOTTIE_LABOVA_COUNTDOWN] == 0) {
        ...
        this.lottieTone(-10);
        this.flags[kFLAGS.LOTTIE_LABOVA_COUNTDOWN] = 40;
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    // [If Gro+]
    ...
    public giveLottieReducto(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.clearOutput();
        if (this.flags[kFLAGS.LOTTIE_REDUCTO_USED] == 0) {
            this.flags[kFLAGS.LOTTIE_REDUCTO_USED]++;
            ...
            this.outputText("Lottie sits still, unsure about the convenience of the results, but glad that you've helped.");
        }
    ...
    public hamSammitchTimeBIATCH(): void {
        this.spriteSelect(SpriteDb.s_lottie);
        this.clearOutput();
        if (this.flags[kFLAGS.LOTTIE_HAM_SAMMICH] == 0) {
            this.flags[kFLAGS.LOTTIE_HAM_SAMMICH]++;
            this.outputText("You walk over to the cafe, Lottie watching as you order a sandwich from their menu. In a matter of seconds the collie-like clerk pulls one up from the glass display and hands it over to you");
            if (this.silly()) this.outputText(", mumbling something about lifetime members receiving free pig-related food items");
    ...
    public lottieFuck(): void {
        ...
        if (this.lottieMorale() <= 40) {
            this.outputText("You take Lottie's hand in your own, though the girl seems to flinch at your touch. \"<i>D-did I do something?</i>\" she asks, slowly recoiling into her seat. You choose not to answer, though the both of you know what's coming next. Silently, you increase your grip on Lottie, leading her out of her seat and into the pool area, checking for any bystanders before taking her inside one of the empty saunas. Lottie grows more and more anxious as you undress yourself in front of her, taking out " + this.player.oMultiCockDesc() + " and stroking gently. She seems to shrink when you turn to her and ask her to do the same. \"<i>P-please, " + this.player.short + "... I... I like what we're doing, but,</i>\" she turns away from your wanting gaze before muttering, \"<i>I want to do this with someone special.</i>\" You scowl – it looks like you're going to have to take things into your own hands again. Walking towards the pig-slut, you grab the hem of her top and pull down, ripping it off to reveal her lovepillows which are covered hastily by her arms. \"<i>N-no! I... please, please don't do this...</i>\" Grabbing your " + this.player.cockDescript(x) + ", you step close enough for her to feel your hot breath against her skin. You rub the tip of your " + this.player.cockDescript(x) + " against her soft flesh, pre-cum leaking against her stomach as you thrust slowly. Your natural musk fills Lottie's button nose, and her increasingly shorter breaths give you the signal that she's ready to give up against your raging lust. \"<i>But " + this.player.short + ", I... I love...</i>\" A loud slap is heard as you press and play with her bottom, grinding your length in between her creamy thighs. \"<i>I... love...</i>\" Slap!  You wail on her ass and thrust hard between her legs. \"<i>F-fuck! I love you so much!</i>\" the pink whore cries, pulling off her shorts and turning around, grabbing your " + this.player.cockDescript(x) + " and rubbing it against the entrance to her wetness. You grin at your success, but you're not going to satiate her needs yet. You continue to fuck her thighs, slapping her luscious butt every so often and earning a squeal in response. You lean over and grab one of her heaving breasts, groping it roughly to the sound of your pelvis slapping against her fat legs. The feeling of your " + this.player.cockDescript(x) + " being squeezed against Lottie's thighs almost sends you to climax, before you get a better idea.\n\n");

            this.outputText("You turn Lottie around to face you, telling her you've decided you're going to take her for a vigorous work out. She only pants with anticipation.");
            // [Anal][Oral] – [Doggystyle][Walkies][Threesome][Netorare]
            this.menu();
            this.addButton(0, "Anal", this.analLottieMilkshake);
            this.addButton(1, "Oral", this.getSuckedOffByAHamSandwich);
            if (this.player.countCocksOfType(CockTypesEnum.TENTACLE) > 0 && this.flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ORAL] == 2) {
                this.addButton(2, "Tentacle", this.tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK);
            } else {
                this.addDisabledButton(2, "Tentacle");
            }
            if (this.flags[kFLAGS.LOTTIE_DOGGYSTYLE_UNLOCKED] > 0) {
                this.addButton(5, "Doggystyle", this.lottieRepeatDoggieStyle);
            } else {
                this.addDisabledButton(5, "Doggystyle");
            }
            if (this.flags[kFLAGS.LOTTIE_WALKIE_UNLOCKED] > 0) {
                this.addButton(6, "Walkies", this.lottieRepeatWalkies);
            } else {
                this.addDisabledButton(6, "Walkies");
            }
            if (this.flags[kFLAGS.LOTTIE_THREESOME_UNLOCKED] > 0) {
                this.addButton(7, "Threesome", this.lottieRepeatThreesome);
            } else {
                this.addDisabledButton(7, "Threesome");
            }
            if (this.flags[kFLAGS.LOTTIE_ELLE_NTR_UNLOCKED] > 0) {
                this.addButton(8, "Netorare", this.lottieRepeatSUPERNEATORARES);
            } else {
                this.addDisabledButton(8, "Netorare");
            }
            if (this.silly() && this.player.hasCock()) {
                this.addButton(9, "30Minute", this.lottiesThirtyMinutePigGasm);
            } // silly mode scene - no disabled button
        }
        // [If Encouragement 30 – 60]
        else if (this.lottieMorale() <= 60) {
            this.outputText("You ask Lottie if she's keen for a little 'extracurricular workout', earning a giggle and a tilt of the head from the pig-girl. \"<i>What do you mean, " + this.player.mf("big guy", "babe") + "?</i>\" she asks. You sigh and stand up, revealing your hardening member");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(". \"<i>I... oh.</i>\" Taking Lottie's hand, you quickly lead her out of the cafe and into the pool area, looking for an empty sauna to sneak into. Considering that the gym's pool is only used by a few semi-aquatic humanoids and the odd ");
            if (this.silly()) this.outputText("street ");
            this.outputText("shark, your search isn't that difficult. Hopping into the toasty room, you quickly undress, Lottie still standing by the doorway. \"<i>H-hey, y'know, I didn't actually agree on this or a-anything...</i>\" she stutters, nervously fiddling with her top. Without missing a beat, you walk towards her and plant a kiss on her full lips, tasting her sweetness as you probe her mouth with your eager tongue. The girl melts underneath your touch, passionately returning your erotic display while you take the chance to slip Lottie out of her top, reaching into her shorts to feel between her creamy hips. She moans as you slowly push two fingers inside her moist wetness, simultaneously pulling out your " + this.player.cockDescript(x) + " and pushing her back against the wall. Lottie begins to jerk you off slowly, massaging the length of your " + this.player.cockDescript(x) + " with one hand while the other takes care at gently caressing your tip. You start to thrust into her hands on reflex while you claim her mouth, the feel of her sugary tongue wrapped around yours sending you both into fits of needy lust. You use your hands to reach around and squeeze her chubby derriere, lightly slapping it whilst a stray hand heads towards her source of hot desire. You slick your hand against her wetness, Lottie moaning in your mouth while you work towards bringing her to an early climax. However, the sudden roughness of your hands against her mound only causes a quick jerk to your " + this.player.cockDescript(x) + ", her soft hands tightening against your shaft. You groan in response, removing yourself from the lips of her mouth and instead placing your own against her erect nipple, sucking forcefully. The pig-slut grabs your head and pushes you towards her heaving chest, relinquishing her grip on your member to hug you closer.\n\n");

            this.outputText("Not wanting to be left unsatisfied, you tell her you've decided you're going to take her for a vigorous work out. She can only pant with anticipation.");
            // [Anal][Oral]
            this.menu();
            this.addButton(0, "Anal", this.analLottieMilkshake);
            this.addButton(1, "Oral", this.getSuckedOffByAHamSandwich);
            ...
            if (this.silly() && this.player.hasCock()) {
                this.addButton(3, "30Minute", this.lottiesThirtyMinutePigGasm);
            } // silly mode scene - no disabled button
        }
        // [If Encouragement 60 – 100]
            ...
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" against her plump asscheeks. \"<i>W-woah! I... well, okay...</i>\" she moans, reaching back to stroke your " + this.player.cockDescript(x) + " through your clothing while you grab a handful of her rosy ass, slapping and squishing it against your palm. You continue to hump relentlessly against Lottie's tight shorts, occasionally reaching around to feel her hot mound, causing the odd squeal or moan to emanate from her pouting lips. Eventually deciding clothes are the only thing between Lottie's lewd figure and your own " + this.player.cockDescript(x) + ", you simultaneously remove your outfit while ripping off her sweaty top, causing her breasts to spill out into your eager, groping hand. Despite your sudden stripping, Lottie immediately gets back into position, placing your cock in between her pillow-like asscheeks and moaning while you flick and tease her swollen nipples, rocking back and forth against you.\n\n");

            this.outputText("Lottie whimpers in between short, hot breaths, \"<i>You're driving me crazy here, babe...</i>\" You give her chubby ass a hard slap in agreement. Lottie squeals in glee, jerking your " + this.player.cockDescript(x) + " as it pokes up through her ass. The sensation of your tip rubbing against her velvety skin drives you wild.\n\n");

            this.outputText("You turn Lottie around to face you, telling her you've decided you're going to take her for a vigorous work out. \"<i>I'll work you out, babe,</i>\" she moans in response.");
            ...
            if (this.flags[kFLAGS.LOTTIE_QUICKIE_UNLOCKED] > 0) {
                this.addButton(3, "Quickie", this.lottieRepeatQuickie);
            } else {
                this.addDisabledButton(3, "Quickie");
            }
            if (this.flags[kFLAGS.LOTTIE_COWGIRL_UNLOCKED] > 0) {
                this.addButton(4, "Cowgirl", this.lottieRepeatCowGirl);
            } else {
                this.addDisabledButton(4, "Cowgirl");
            }
            if (this.flags[kFLAGS.LOTTIE_REVERSE_COWGIRL_UNLOCKED] > 0) {
                this.addButton(5, "R.Cowgirl", this.lottieRepeatBackwardsAssCowgirl);
            } else {
                this.addDisabledButton(5, "R.Cowgirl");
            }
            if (this.flags[kFLAGS.LOTTIE_FEMDOM_UNLOCKED] > 0) {
                this.addButton(6, "Femdom", this.lottieRepeatFEMDOMFEMFDOM);
            } else {
                this.addDisabledButton(6, "Femdom");
            }
            if (this.silly() && this.player.hasCock()) {
                this.addButton(7, "30Minute", this.lottiesThirtyMinutePigGasm);
            } // silly mode scene - no disabled button
        }
    ...
    public lottieRepeatDoggieStyle(): void {
        ...
        let x: number = this.player.cockThatFits(40);
        if (x < 0) x = 0;
        this.outputText("A few minutes later and you've taken your whore to the washrooms. Mirrors line the sides of the walls to allow members to observe how far they've gone and how far they still need to go. It's entirely empty for the night, though you make sure to lock the door just in case. You turn around to see Lottie cowering in the corner. She knows what you want – and you swear on Mareth's giant tree titties you'll get it. With her naked body on full display, Lottie quietly moves down to the ground, positioning herself on all fours with her butt facing towards you. She looks behind herself to see your erect " + this.player.cockDescript(x) + " on full display, quickly squealing and looking away. You grin as you stroke yourself into fullness, walking over and placing yourself behind Lottie's full derriere. \"<i>" + this.player.short + "?</i>\" she gently sobs, \"<i>P-please don't do this.</i>\" With that, you grab her ample thighs and thrust forward, driving your " + this.player.cockDescript(x) + " straight into her tense wetness.\n\n");
    ...
    public lottieRepeatWalkies(): void {
        ...
        if (!this.silly()) this.outputText("Heyyy, is she like *hic* your shex slave er shumthin?");
        else this.outputText("Heyyy, do I shmell bacon?  I fucking love bacon!  BACON BACON BACON!");
        ...
        if (this.silly()) this.outputText("bacon ");
        this.outputText("shake.");
        if (this.silly()) this.outputText("  You sure do love spit roasting a pig, but nothing can beat a bacon shake.");
    ...
    public lottieRepeatCowGirl(): void {
        ...
        this.outputText("A while later, you've both said your goodbyes for the night. Before you leave, you make sure to head out to the cafe to buy yourself a ");
        if (this.silly()) this.outputText("bacon ");
        this.outputText("shake.");
    ...
    public lottieRepeatQuickie(): void {
        ...
        this.outputText("In moments flat you remove your clothes to jump the piggy, whipping out your " + this.player.cockDescript(x) + " and pushing it against Lottie's wet slit, the pig-girl lying on her back while her legs rest upon your shoulders. With a hearty thrust you drive yourself into her, eliciting a loud moan while you pork her insides with your meat. Her thick thighs slap against you as you bend over to take a lustful grab at her melons, sucking at her nipple and pinching the other, her sweet taste enveloping your mouth. Lottie buries you in her cleavage, yelping as you piledrive her tight pussy into submission – but you've got more in store. Flipping her over, Lottie lies face down with her soft butt jutting up in the air, your persistent fucking driving her wild. You continue gripping onto her tits as you pound her flesh, every thrust accompanied by her pleasured grunts. Back and forth you mount her until the familiar sensation in your loins signal your release. You increase your pace, pounding her pussy until you pull your head back and ejaculate inside her inner walls, slamming in harder every few seconds with each burst.");
        if (this.player.cockTotal() > 1) {
            this.outputText("  Your other cock");
            if (this.player.cockTotal() == 2) this.outputText(" twitches ");
            else this.outputText("s twitch ");
    ...
    public lottieRepeatSUPERNEATORARES(): void {
        ...
        if (this.player.cockTotal() == 1) {
            this.outputText("begins to caress your " + this.player.cockDescript(x) + " with two of her hands, while the other sets to work on massaging your ");
            if (this.player.balls > 0) this.outputText("balls");
            else if (this.player.hasVagina()) this.outputText("pussy");
            else this.outputText("ass");
        }
        else this.outputText("uses all four of her hands to handle " + this.player.sMultiCockDesc() + ", jerking each one with ease");
        ...
        this.outputText("  Elle follows suit, groaning in pleasure as she reaches her own peak, her hole tightening around your length and trapping the rest of your spunk inside. The spinnerets upon her shoulder pulse in orgasm, spurting sticky globs of what appears to be thread up into the air and back down onto the pig, spunk pooling around her cleavage. You both relax, letting the spider-girl down off of you to collapse on the floor. You bend down, looking at Lottie before shoving your " + this.player.cockDescript(x) + " inside of her and letting one final spurt of your seed fill her up. \"<i>Satisfactory.</i>\" You mumble, redressing and heading out the door, making sure to grab a ");
        if (this.silly()) this.outputText("bacon ");
        this.outputText("shake on the way out.");
        if (this.silly()) this.outputText("  You only need one of those to satisfy you.");
        this.player.orgasm('Dick');
    ...
    public lottieRepeatBackwardsAssCowgirl(): void {
        ...
        let x: number = this.player.cockThatFits(40);
        if (x < 0) x = 0;
        this.outputText("You both walk into the yoga area, met with the smell of sweat and flowers pervading the room. Lottie gently asks for you to lie down on your back, to which you comply quite easily. You're comfortable, folding your arms behind your head to give you leverage as you watch your lover walk slowly to you. Lottie turns around, her thick thighs straddling you as she sits down on your groin with her back facing your direction, giving you  a perfect view of her curvy body and plump ass. Your " + this.player.cockDescript(x) + " nestles gently between her rosy cheeks, pulsing with lustful intent as the girl grabs her hips and begins to pleasure you through her ass. The silence of the room breaks at your fevered pants and grunts as Lottie's skillful assjob sends you through fits of ecstasy, every curve of her bottom jiggling against the heat of your member. Her pace picks up while she bounces upon you, squeezing and squashing her perfect ass until one final lift in the air is met with her plunging your length up into her hot interior. The feeling of your molten cock inside her immediately sends Lottie into fits of orgasmic bliss, the intense heat filling the pig-girl with pleasure. Her attempts to continue are thwarted by your " + this.player.cockDescript(x) + " scraping against her inner walls, her thick thighs clenched together while she slowly moves up and down upon you. Deciding to take things into your own hands, you thrust upwards, almost pushing the girl off with your strength and causing Lottie to squeal as you begin pounding her irresistible hole. Her lush buttcheeks jiggle with every movement you make, the rising and falling of her body moving in accordance to your own will. You pump in and out, keeping a steady rhythm inside the hot and bothered woman.\n\n");
    ...
    public lottieRepeatFEMDOMFEMFDOM(): void {
        ...
        // [If Cum Production High]
            ...
            this.outputText("Unfortunately for her, you have far too much built up to stop now. With another thrust, your " + this.player.cockDescript(x) + " pulses in delight, exploding in orgasm as ropes of spunk splatter upon Lottie's face and tits. The girl gasps, the sheer amount of your seed painting her white. \"<i>N-no, stop! Oh god!</i>\" she yelps, before her mouth is filled with your hot essence. She forces herself to swallow, coughing as you grin at the defeated slut. \"<i>O-okay, y-you win, " + this.player.short + ".</i>\" she looks up at you and smiles, before untying your binds and setting you free. \"<i>But you have to admit, this was pretty fun, right?</i>\" You give her a thumbs up before walking out the door, leaving her to clean your thick mess. On the way out, a milkshake vendor waves over to you – it's the guy from the cafe. You buy a ");
            if (this.silly()) this.outputText("bacon ");
            this.outputText("shake before deciding to head home.");
            if (this.silly()) this.outputText("  You fucking love bacon shakes.");
        }
    ...
    public hugTheShitOutOfYourHam(): void {
        ...
        // [If Encouragement 0 – 30]
        if (this.lottieMorale() <= 30 && !this.player.isPureEnough(75)) {
            ...
            this.outputText("The kind that wishes for the day that her life will change, Lottie thinks back.");
            this.lottieMorale(-4);
        }
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    public tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK(): void {
        ...
        this.outputText("The porcine girl takes the initiative as soon as you enter the room, stripping down and planting her cushiony ass upon the pile of mats in front of you.  \"<i>What're we gonna do in here, babe?</i>\" she asks, turning over onto her soft belly and rolling around, covering herself in an assortment of old, thin mattresses.  \"<i>Heh, I'm a pig in a blanket,</i>\" she squeaks, unaware of you slowly pacing towards her, your hand firmly stroking your " + this.player.multiCockDescriptLight() + ".  There's a time for games, you think, and a time for unleashing your myriad of undulating vine-beasts upon your curious pink slut.\n\n");
        this.outputText("Removing your " + this.player.armorName + ", you let your " + this.player.multiCockDescriptLight() + " hang loose, a single vine stretching outwards and slapping Lottie upon the ass to remind you of why you're here.  She squeals, trapped underneath the heap of mattresses and doing little to help the situation she's found herself in.  \"<i>H-hey, uh, I've kinda found myself in a little pickle, " + this.player.mf("big guy", "hon") + " - could you give me a hand?</i>\" Lottie chuckles, squirming around in an attempt to loosen herself from the pile, but inevitably failing.  You walk closer towards her, shifting away a few mattresses here and there to free her limbs.  She smiles apologetically as you lift up the last mattress, crawling back out of the pile only to squeak when you bring down the smallest - albeit, heaviest - mat onto her back, preventing her from moving any further and causing her face to be buried against the mattress below her, the girl's plump ass stretched directly up into the air.  The awkward position restricts the movement of anything outside of her forearms and neck, and the majority of the weight upon her back pushes her chest into her knees, disallowing her from stretching outwards.  Lottie turns her head to the side, giving her time to breathe and assess the situation.  She notices you're stark naked, her eyes drawn down to the " + this.player.multiCockDescriptLight() + " laid before her.");
        if (this.lottieMorale() <= 30) this.outputText("  She gives you a gloomy stare, before turning her head back down and plunging it into the mattress, already accepting her defeat");
        else this.outputText("  She raises an eyebrow, though doesn't probe any further");
        this.outputText(".\n\n");

        this.outputText("You grasp the base of your " + this.player.cockDescript(x) + " as it stretches forward, gently caressing Lottie's face before exploring the rest of her body, idly stroking the smooth curves of her hips or brushing against her hardening nipples.  The pig-girl moans quietly from the light petting while the feeling of her soft skin excites your hardening length, reminding you of your true intentions.  You walk behind her, obscuring yourself from Lottie's peripheral vision and crouching down to inspect the view of her perfectly rounded ass pointed conveniently into the air.  " + this.player.SMultiCockDesc() + " twitches in agitation, eager to plow the chubby slut trapped in front of you - and you aren't about to disappoint.\n\n");

        // [if a single, lonely tentapenis]
        this.outputText("You firmly squeeze your ");
        if (this.player.countCocksOfType(CockTypesEnum.TENTACLE) > 1) this.outputText("first ");
        ...
        if (y >= 0) {
            this.outputText("Seeing that you have extra junk left to be used, and she has some vacant holes, you quickly remedy this problematic situation; guiding your " + this.player.cockDescript(y) + " toward her moist butthole, you press the tip of your tree-like beast against her plush buttocks, literally stabbing her flesh with your penile flora.  The butt-slut doesn't seem to care: if anything, she squirms all the more, visibly aroused.  Her ass seems to stretch on its own as it braces itself for the imminent butt-devastation.  You welcome Lottie's efforts to comply to your anal needs and with a single thrust, you push ");
            if (this.player.cockArea(y) <= 80) this.outputText("the entirety of your " + this.player.cockDescript(y));
            else this.outputText("as many inches of your " + this.player.cockDescript(y));
            ...
            if (z >= 0) {
                this.outputText("Her constant moaning and screaming reminds you that one of her holes at least isn't being put to use.  Her eyes widen in awe as she sees your " + this.player.cockDescript(z) + " inexorably moving to her waiting mouth, her lips forming a wide O as if to greet your tentacle pecker.  Without a word, you plunge your beast in her mouth, burying your prick until she's about to choke.  Fortunately she's used to blowjobs, and you have no trouble fitting a decent amount of inches down her throat.  You can see her neck bulge from the obscene intrusion, and the tip of your " + this.player.cockDescript(z) + " swells until her windpipe looks ready to explode.  She can't say anything, but the way her eyes are staring at you tell you more than anything about how she feels.");
                if (this.lottieMorale() < 40) this.outputText("  This pig slut really loves to be used like that!");
                else this.outputText("  Your pig lover really loves what you're doing to her!");
                ...
                if (zz >= 0) {
                    this.outputText("Surely her twat must have some room left for more cock?  Before you even think of it, your free tentacle prick is already squirming its way to the piggy's love-tunnel, trying to fit as its companion ruthlessly rams her fuckhole.  You feel her whole body clench as you press the tip of your " + this.player.cockDescript(zz) + " between her netherlips, stretching them beyond their normal capacity as you keep pushing forward.  If her mouth wasn't so full of dick, you'd be sure she would scream like a harpy in heat.  Once the tip manages to get through her tight vaginal entrance, the rest easily follows, and you effortlessly slide your dickflesh down her now-gaping cunt.  You synchronize your pricks penetrating her cuntwardly, literally ravaging her pussy as you pork her insides with your genitals.\n\n");
                    // [if another extra cock]//to be added to standard text
                    if (zzz >= 0) {
                        this.outputText("Since her dripping twat has been able to take some extra dick, why not try her backside?  Your " + this.player.cockDescript(zzz) + " wriggles joyfully as it wraps around Lottie's plump rump, ready to test her anal capacity.  Fortunately, its rubbery texture allows it to be compressed as it grinds against your " + this.player.cockDescript(y) + ", sliding toward the pig-girl's wet anus.  Your plant-like dong bounces back against her entrance numerous times, but you know she is being stretched wider at every attempt.  You don't know how many times you poke her pucker with the erect tip of your " + this.player.cockDescript(zzz) + ", and you can't imagine how the teasing stimulation feels for the poor prisoner of your tentacle embrace.  At last, with a brutal thrust, your flexible dong somehow manages to clear a path for additional butt-penetration.  Your twin erect pricks are incredibly squeezed against her tight anal walls and her body is about to be torn in half from all the rods impaling her from many directions at once.  That doesn't prevent you from thrusting back and forth very carefully through her colon, never completely pulling out.\n\n");
                        // [if another extra cock]//to be added to standard text
                        if (zzzz >= 0) {
                            this.outputText("No matter how hard you try, you can't fit any more cock in her toy-like body. Your " + this.player.cockDescript(zzzz) + " is quivering in frustration, until you notice her fleshy orbs bouncing up and down repeatedly on her chest as you ruthlessly pound her from every hole.  This might be the right occasion to get a good titfuck: your " + this.player.cockDescript(zzzz) + " slowly slithers along her sweaty body and slides between her sizable fuckpillows; although the sensation isn't as hot and amazingly rough as the sharp tingles of pleasure received from the dongs pounding her ass, your rod is being subtly tickled and teased by her supple flesh.  Already aroused from the thorough multi-penetration, you start dripping pre-cum all over her torso, smearing her whole body with your sap.  This makes her breasts all the more slick and slippery, and needless to say, the sensation isn't lost on your " + this.player.cockDescript(zzzz) + "; it seems to grow even bigger and becomes pinkish, the sudden color change betraying its arousal. You keep fucking her boobs until they are literally glistening from all the juices you've spilled on them.\n\n");

                            // [if another extra cock]//to be added to standard text
                            if (zzzzz >= 0) {
                                this.outputText("As you idly pump Lottie's body with all your junk, you mentally count all the extra ways her body could be used, since you have some tentacle dong left.  Mouth, cunt, ass, tits... wait!  Her hands are still free!  By the way they are twitching convulsively, you can clearly tell they are aching for some dick to handle.  You graciously comply to her cocky needs and shove your " + this.player.cockDescript(zzzzz) + " against her palm, coating it with your pre-cum.  She instinctively clings to your rod of flesh as if her life depended on it and starts jerking you off, ferociously rubbing your dickflesh and using a mix of her sweat and your pre-cum as lube.");
                                // [if another extra cock]
                                if (zzzzzz >= 0) this.outputText("  Seeing the effect your junk had on her, you move your " + this.player.cockDescript(zzzzzz) + " to her remaining hand and she grips it likewise.");
                                this.outputText("  She keeps stroking you in a compulsive way, her hands clearly acting under the effect of her tremendous lust.");
                                this.outputText("\n\n");
                                // [if another extra cock]//to be added to standard text
                                if (zzzzzzz >= 0) {
        ...
        // generic
        else this.outputText("You stand exhausted, trembling slightly from the after-effects of your climax while your tree-like junk slows its movements.  Retracting your " + this.player.cockDescript(x) + ", you slowly change back into your " + this.player.armorName + " while Lottie comes to.  She hazily opens her eyes, the smell of hot semen in the air while she lifts herself upwards, remembering the sequence of events leading to where she is now. \"<i>H-huh? " + this.player.short + "...</i>\" the girl mumbles, struggling to move out only to find she's still underneath the small weighted mattress.  \"<i>H-hey! I'm still stuck!</i>\"\n\n");
        // [if enc. 100]
        if (this.lottieMorale() >= 99) {
            ...
            if (this.silly()) this.outputText("  Before you leave, you make sure to grab a bacon shake from the clerk, high-fiving her as you backflip back to camp.");
            this.outputText("\n\n");
        }
        // [if enc. 0]
        else {
            ...
            if (this.silly()) this.outputText("  Unfortunately for the spider-clerk, you've raided her cart of bacon shakes on the way out.  You try to backflip back to camp before accidentally dropping the majority of your shakes onto the floor, ultimately deciding to walk back normally - the last beverage you could save gripped firmly in your hands.");
        }
        this.player.orgasm('Dick');
        this.dynStats("sen", -2);
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    public ifrisAndLottieGetsNTRedLiftingWeights(): void {
        ...
        if (this.player.balls > 0) this.outputText("  Your pace doesn't slow, even when your swollen balls smack loudly against her chin.");
        this.outputText("  You let out a deranged chuckle at the sight of Ifris being thrown about");
        ...
        this.outputText("Only swaying for a handful of seconds before collapsing into the two women, you black out.");
        this.player.orgasm('Dick');
    ...
    private lottieAndIfrisNTREpilogue(): void {
        ...
        if (this.silly()) this.outputText("  You'll make damn sure to buy Urta a bacon shake tomorrow.");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    public lottiesThirtyMinutePigGasm(): void {
        ...
        this.outputText("DAMN!  Did this pig bitch really just have a half-hour orgasm?  You're a little jealous.");
        this.player.orgasm('Dick');
        this.doNext(this.camp.returnToCampUseOneHour);
    }
}
