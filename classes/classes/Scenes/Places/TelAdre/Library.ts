...
export class Library extends TelAdreAbstractContent {
    ...
    public visitZeMagesTower(): void {
        ...
        this.menu();
        if (this.flags[kFLAGS.TIMES_BEEN_TO_LIBRARY] == 0 || this.getGame().time.hours <= 17) {
            this.addButton(1, "You Okay?", this.youOkayBuddy);
            if (this.flags[kFLAGS.DOMINIKA_DRAMA] > 0) this.addButton(2, "Mali", this.talkToMali);
        }
    ...
    private firstTowerVisit(): void {
        ...
        if (this.getGame().time.hours <= 17) { // Don't want to meet Quinn if he's not supposed to be there
    ...
    private studyInTA(): void {
        ...
        // [Study, 18:00-20:00]
            ...
            if (rand(3) == 0) {
                ...
                // Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 30 && !this.player.hasStatusEffect(StatusEffects.KnowsHeal)) {
                ...
                // Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 40 && !this.player.hasStatusEffect(StatusEffects.KnowsMight)) {
                ...
                // Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 25 && !this.player.hasStatusEffect(StatusEffects.KnowsCharge)) {
                ...
                // Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 30 && !this.player.hasStatusEffect(StatusEffects.KnowsBlind)) {
                ...
                // Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 40 && !this.player.hasStatusEffect(StatusEffects.KnowsWhitefire)) {
