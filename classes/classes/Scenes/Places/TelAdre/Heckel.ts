...
export class Heckel extends TelAdreAbstractContent {
    ...
    */
    ...
    public greetHeckel(): void {
        this.clearOutput();
        this.spriteSelect(SpriteDb.s_heckel);
        ...
        else if (this.telAdre.brooke.brookeAffection() >= 70 && this.flags[kFLAGS.BROOKE_MEDIUM_SCENE] > 0 && this.flags[kFLAGS.MET_HECKEL] > 0 && this.getGame().time.hours >= 13 && this.getGame().time.hours <= 15 && (this.player.hasVagina() || this.player.cockThatFits(this.telAdre.brooke.brookeCapacity()) >= 0)) {
        ...
        this.menu();
        this.addButton(0, "Training", this.heckelTraining);
    ...
    private heckelTraining(): void {
        ...
        if (this.player.tone < 60) {
            ...
            this.outputText("You open your mouth to reply, but the hyena has already started another lap.  Deciding it isn't worth it, you turn away indignantly.");
        ...
        if (this.flags[kFLAGS.TIMES_FUCKED_HECKEL_BLOWJOB] + this.flags[kFLAGS.TIMES_FUCKED_HECKEL_ANAL] == 0) {
            this.spriteSelect(SpriteDb.s_heckel_nude);
            ...
            // ORAL or LEAVE
            this.menu();
            this.addButton(0, "Oral", this.heckelOrallyFixated);
            if (this.player.str > 50 && this.player.hasCock()) {
                ...
                this.addButton(1, "Be Top Dog", this.dominateHeckel);
            } else {
                this.addDisabledButton(1, "Be Top Dog", "This scene requires you to have considerable strength and cock.");
            }
        ...
        // FOLLOWUP SECKZ
            ...
            this.menu();
            this.addButton(0, "Oral", this.heckelOrallyFixated);
            this.addButton(1, "Anal", this.heckelLovesDaAnal);
            if (this.player.str > 50 && this.player.hasCock()) {
                ...
                this.addButton(2, "Be Top Dog", this.dominateHeckel);
            } else {
                this.addDisabledButton(2, "Be Top Dog", "This scene requires you to have considerable strength and cock.");
            }
            this.addButton(14, "Leave", this.camp.returnToCampUseOneHour);
        }
    }
    ...
    private heckelOrallyFixated(): void {
        ...
        // Repeat
            ...
            // [<PC IS MALE OR HERM>
            if (this.player.hasCock()) this.outputText("You use one hand to fondle her balls, letting them roll over your fingers and pinching the skin lightly. Your other hand finds its way to your crotch, where you begin stroking your " + this.player.cockDescript(0) + " in time with her weak thrusts. Within moments you've brought yourself to a stiffening arousal, the cold air making your exposed " + this.player.cockDescript(0) + " twitch slightly.\n\n");
            // [<PC IS FEMALE>
            else if (this.player.hasVagina()) this.outputText("You use one hand to fondle her balls, letting them roll over your fingers and pinching the skin lightly. Your other hand finds its way to your crotch, where you roll your " + this.player.clitDescript() + " between your first two fingers. You let two fingers sink into your " + this.player.vaginaDescript(0) + ", curling them upwards and moaning around the giant dog dick in your mouth.  Your fingers bring you to the edge of orgasm, but you lack the stimulation to send yourself over just yet.\n\n");
            ...
            // <PC IS MALE OR HERM>
            else this.outputText("A growl rises in Heckel's throat, and you recognize the sign of her impending orgasm. It's all you can do to keep your balance as her thrusts into your throat come more frequently. Although you are barely able to breath between thrusts, your free hand feverishly strokes your " + this.player.cockDescript(0) + ", your hand becoming slippery with pre as your own orgasm builds. Heckel's paws grab your head and pull you deeply on to her dick as you feel it spasm, and you begin to moan as you feel her load travelling through her cock and finally spilling directly into your stomach. The warmth of her seed spreads throughout your body until it meets the warmth of your groin, and your cock erupts in your hand as it sets your over the edge.\n\n");
    ...
    private heckelLovesDaAnal(loss: boolean = false): void {
        ...
        if (this.player.analCapacity() <= 20 && !loss) {
            this.outputText("Heckel lets out a barking laugh when you suggest using your " + this.player.assDescript() + ", ruffling your hair playfully. \"<i>Know your limits, " + this.player.short + ", I'd tear you apart down there. I'm sure there are plenty of others in this realm who can help you out with that.</i>\"\n\n");
            this.doNext(this.camp.returnToCampUseOneHour);
            return;
        }
        ...
        this.outputText("You half expect her to just shove herself in right there, but she thankfully holds off. Instead, you feel her rough paws grab and knead either side of your " + this.player.buttDescript() + " as she lets out a low growl.");
        // [<IF TONE OVER 80>
        if (this.player.tone >= 80) this.outputText("  \"<i>Damn " + this.player.short + ", you've got one hell of an ass. I bet it's gonna feel even better than it looks.</i>\"");
        // [<IF TONE BETWEEN 60-79>
        else if (this.player.tone >= 60) this.outputText("  \"<i>Mmm, not bad " + this.player.short + ", not perfect, but not bad.</i>\"");
        this.outputText("\n\n");

        this.outputText("One hand releases your " + this.player.buttDescript() + " and you can hear the sound of her stroking herself. You start to turn your head around to watch, but she firmly presses you back down against the bench. \"<i>Now now partner, I told you to stay there. When you're the alpha dog around here, then you can make the rules.</i>\" Deciding this treatment isn't so bad anyway, you relax and let her hand continue to knead your " + this.player.buttDescript() + ".\n\n");

        this.outputText("The sound of her stroking stops, and you bite your lower lip. You feel the bench shift beneath you as she changes position, and a moment later she pulls both of your asscheeks apart to expose your " + this.player.assholeDescript() + ". You tense for the inevitable penetration, but instead of a hard cockhead poking at your backdoor you feel something warm and wet. Heckel is licking you!\n\n");

        this.outputText("Her large tongue feels like sandpaper as it licks up and down your anus, your spread cheeks exposing you to the world. You can feel her wet nose on your sensitive skin, and the contrast with her warm tongue makes you shiver. Her tongue pokes and prods at your " + this.player.assholeDescript() + " before slipping painlessly in, swirling expertly around before pulling out and licking some more.\n\n");

        // [<IF PC HAS PENIS AND VAGOO>
        if (this.player.hasCock() && this.player.hasVagina()) this.outputText(this.player.SMultiCockDesc() + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. Your " + this.player.vaginaDescript(0) + " is also being ignored, and having so much pleasure with so little stimulation is driving you crazy. You hump weakly up and down, trying to draw some pleasure out of the bench beneath you while simultaneously pushing her rolling and massaging tongue closer to your aching slit, but she ignores you and only licks deeper. She buries her face in your ass entirely, her cold nose and teeth rubbing up against your sensitive skin as her tongue pushes as far inside of you as she can get it.\n\n");

        // [<IF PC HAS PENIS>
        else if (this.player.hasCock()) this.outputText(this.player.SMultiCockDesc() + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. You hump weakly at the bench in a desperate attempt to get some stimulation, and you can feel the vibrations of Heckel's laugh as she buries her snout in your ass. She doesn't stop you, but the polished wood barely gives any pleasure anyway.\n\n");
    ...
    private heckelLovesAnal2(): void {
        this.clearOutput();
        this.outputText("Her legs bump against yours as she pulls herself up, the contact sending shivers through your sensitive body. \"<i>Even better than I thought,</i>\" she mumbles as you hear the sound of her stroking herself. Before the wetness around your ass can dry up, you feel something hard and slightly pointed poking the entrance of your " + this.player.assholeDescript() + ".\n\n");
        ...
        this.outputText("Just as the sting begins to fade, she draws herself out to the tip in one motion. You bite your lip in anticipation, but you still moan like a whore when she slams all 15 inches back into you. She draws back before pounding your " + this.player.assholeDescript() + " again, making your " + this.player.buttDescript() + " shake with the impact.\n\n");

        // [<IF PC HAS PENIS AND VAGOO>
        if (this.player.hasCock() && this.player.hasVagina()) this.outputText("Although " + this.player.sMultiCockDesc() + " is trapped beneath you, Heckel's balls slap into your cunt with every one of her quickening thrusts.  Although neither your " + this.player.multiCockDescriptLight() + " or " + this.player.vaginaDescript(0) + " are getting much stimulation, your prostate is being milked better than it ever has. One thrust in particular makes you cry out, and Heckel laughs above you as she slams her furry thighs into yours again. \"<i>You moan like a whore, " + this.player.short + ", a perfect bitch for me to ride.</i>\"\n\n");

        // [<IF PC HAS PENIS AND BALLS>
        else if (this.player.hasCock() && this.player.balls > 0) this.outputText(this.player.SMultiCockDesc() + " pulses beneath you with every thrust, her duo of fist-sized balls slapping into your " + this.player.ballsDescriptLight() + ". You gasp in surprise as one of her thrusts rubs against your prostate, and she barks out a single laugh above you. \"<i>You moan like a whore, " + this.player.short + ", a perfect bitch for me to ride.</i>\"\n\n");
        ...
        // [<IF PC IS FEMALE>
        if (this.player.gender == 2) this.outputText("  \"<i>I'm going to fuck your ass like you wish I'd fuck your cunt,</i>\"");
        // [<IF PC IS MALE OR HERM >
        else this.outputText("  \"<i>I'm going to ride your ass like you wish you could ride me,</i>\"");
        ...
        // [<HERM PC>
        if (this.player.gender == 3) this.outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your vagina hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + this.player.vaginaDescript(0) + " spasms and gushes over your soaked " + this.player.legs() + ", your asshole spasming around her cock just as much. Your " + this.player.multiCockDescriptLight() + " soon follows, shooting your own seed up between your " + this.player.chestDesc() + " and coating your stomach. Even as your orgasm begins to taper off, you can do little more than lie panting in a pool of your own spunk. Your legs quiver beneath hers as the warmth spreads further up your gut, leading you into a warm and hazy afterglow.\n\n");
        // [<MALE PC>
        else if (this.player.hasCock()) this.outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your " + this.player.ballsDescriptLight() + " and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your " + this.player.ballsDescriptLight() + " get tight as your trapped " + Appearance.cockNoun(CockTypesEnum.HUMAN) + " twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n");
        // [<FEMALE PC>
        else if (this.player.hasVagina()) this.outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your " + this.player.vaginaDescript() + " hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + this.player.vaginaDescript(0) + " spasms and gushes over your soaked thighs, your asshole spasming around her cock just as much. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n");
        ...
        this.outputText("She laughs as she stands and heads for the shower, letting you clean yourself up and head back to camp.");
    ...
    private dominateHeckelConclusion(): void {
        ...
        this.outputText("\n\nOnly once you have fully sated yourself upon the still-climaxing herm's vagina do you pull out.  Her gash gapes in the shape of your maleness as you exit, dribbling sperm and continuing to convulse anew, milking the phantom member she wishes were still inside her.  You plop your " + this.player.cockDescript(x) + " into her mouth, and she licks it without thought or question, cleaning the mixed love-juices from you until you shine with her glossy spit.");
        ...
        if (this.silly()) {
            ...
            if (this.flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER] > 0) this.outputText(", then give Lottie a high five");
