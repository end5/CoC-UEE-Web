		...
		//Dungeon inoperable
			...
			//Corrupt!
				...
				if (flags[kFLAGS.MET_MARAE_CORRUPTED] <= 0) {
					...
					addButton(3, "Prank", maraeStealLethicite, true, undefined, undefined, "Play a practical joke on the corrupted goddess and pretend to steal her Lethicite. Why would you do this?", "Practical Joke");
...
//Prompts
	private  promptFightMarae(cancelFunction): void {
		clearOutput();
...
//Only procs when you have both perks. Rare.
	public  level3MaraeEncounter(): void {
		...
		menu();
		addButton(0, "Fight Her", promptFightMarae, level3MaraeEncounter, undefined, undefined, "Fight Marae the corrupted goddess!");
