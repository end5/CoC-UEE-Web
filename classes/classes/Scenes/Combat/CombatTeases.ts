	...
	export class CombatTeases extends BaseContent
	{
		public  CombatTeases() {}
		
		public  teaseAttack(targetSelected: boolean = false, monsterTarget:Monster = undefined): void {
		...
		public  tease(justText: boolean = false, monsterTarget:Monster = undefined): void {
			if (monsterTarget == undefined) monsterTarget = getGame().combat.getOnlyMonsterLeft();
		...
		var  auto: boolean = true;
			...
			switch(select) {
				...
				case 45:
				var  partChooser: any[] = []; //Array for choosing.
