//Succubus, one of the classic encounters from Unnamed Text Game, now modified to be up to modern standards, with new fight.
	...
	export class SuccubusScene extends BaseContent
	{
		
		public  SuccubusScene() {}
		...
		public  fightAgainstSuccubus(): void {
			startCombatImmediate(new Succubus());
		}
		
		public  winAgainstSuccubus(): void {
			clearOutput();
		...
		public  winAgainstSuccubusRape(): void {
			clearOutput();
		...
		public  loseToSuccubus(fromBattle: boolean = true): void {
			clearOutput();
