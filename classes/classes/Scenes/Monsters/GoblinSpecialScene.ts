 ...
 */
	...
	export class GoblinSpecialScene extends BaseContent
	{
		public  GoblinSpecialScene() {}
		 ...
		 */
		public  goblinSpecialEncounter(forceType: number = -1): void {
			clearOutput();
		...
		private  goblinClassName(): string {
			return monster.short.slice(7, monster.short.length);
		}
		
		private  goblinClassActions(assassin: string, shaman: string, warrior: string): string { //Allows for variants.
		...
		private  displayGoblinSprite(gobtype: string = ""): void {
		...
		//[LOSS SEXAHNZ]
		public  gobboSpecialBeatYaUp(): void {
			clearOutput();
			if (doSFWloss()) return;
		var  x: number;
		...
		//[WIN RAEPZ]
		public  gobboSpecialRapeIntro(hpVictory: boolean): void
		{
			clearOutput();
			displayGoblinSprite();
