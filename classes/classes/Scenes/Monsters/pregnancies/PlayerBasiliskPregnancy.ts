	 ...
	 */
	export class PlayerBasiliskPregnancy implements VaginalPregnancy
	{
		 ...
		 */
		public  PlayerBasiliskPregnancy(pregnancyProgression:PregnancyProgression, output:GuiOutput) 
		{
