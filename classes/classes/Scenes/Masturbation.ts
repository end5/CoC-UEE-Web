//	import classes.Scenes.NPCs.*;
	...
	export class Masturbation extends BaseContent {
		...
		var  nippleFuck: boolean = false;
			...
			var  craving: number = getGame().bimboProgress.analCraving(); 
		...
		*/
		...
		var  tentacle: number;
			...
			for (var x: number = tentacle + 1; x < player.cocks.length; x++) { //Find the biggest tentacle cock you've got
		...
		var  gildedCock: number;
			...
			for (var x: number = gildedCock + 1; x < player.cocks.length; x++) { //Find the biggest gilded cock you've got
