...
export class UrtaQuest extends NPCAwareContent {
    ...
    public startUrtaQuest(): void {
        ...
        this.player.hips.rating = 12;
        this.player.butt.rating = 12;
        this.player.ass.analLooseness = 2;
        this.player.createStatusEffect(StatusEffects.BonusVCapacity, 58, 0, 0, 0);
        this.player.createVagina();
        this.player.vaginas[0].vaginalWetness = Vagina.WETNESS_DROOLING;
        this.player.vaginas[0].vaginalLooseness = Vagina.LOOSENESS_NORMAL;
        this.player.setClitLength(1);
        this.player.str = 75;
        this.player.tou = 80;
        this.player.spe = 90;
        this.player.inte = 55;
        ...
        this.player.level += this.player.ascensionFactor(30);
        this.player.str *= 1 + this.player.ascensionFactor(0.25);
        this.player.tou *= 1 + this.player.ascensionFactor(0.25);
        this.player.spe *= 1 + this.player.ascensionFactor(0.25);
        this.player.inte *= 1 + this.player.ascensionFactor(0.25);
        ...
        // GEAR!
        switch (this.player.newGamePlusMod()) {
            case 0:
                this.player.setWeapon(this.weapons.HALBRD0);
                break;
            case 1:
                this.player.setWeapon(this.weapons.HALBRD1);
                break;
            case 2:
            case 3:
            case 4:
                this.player.setWeapon(this.weapons.HALBRD2);
                break;
            default:
                this.player.setWeapon(this.weapons.HALBRD0);
        }
    ...
    private visitPCPreUrtaQuest(truth: boolean): void {
        ...
        if (this.player.hasStatusEffect(StatusEffects.JojoNightWatch) && this.player.hasStatusEffect(StatusEffects.PureCampJojo))
        ...
        if (this.flags[kFLAGS.FACTORY_SHUTDOWN] > 0) this.outputText(", no matter why " + this.player2.mf("he", "she") + " was sent here");
        ...
        const buttonFuckVagText: string = "Fuck" + this.player2.mf("His", "Her") + "Vag";
        this.menu();
        this.addButton(0, "Cuddle", this.snuggleWithUrta, truth);
        // Put Urta dick in girl PC's vag(C)*
        if (this.player2.hasVagina())
            this.addButton(1, buttonFuckVagText, this.putUrtasWangInPCsCunt, truth);
    ...
    private urtaPutsHerDickInPCsWithDicks(truth: boolean): void {
        ...
        if (this.player2.tallness < 60) this.outputText(" and let your tits hang over " + this.player2.mf("his", "her") + " " + this.player2.faceDescript());
        ...
        if (this.player2.hasVagina()) this.outputText("  You don't notice the female fluids that drip from " + this.player2.mf("his", "her") + " sodden slit - they soak into your big balls, already forgotten.");
    ...
    private putAPCDickInUrtaCoochies(truth: boolean): void {
        ...
        if (this.player2.hasVagina()) this.outputText(", " + this.player2.mf("his", "her") + " cunt dripping wetly onto the ground from the stimulus");
        ...
        if (this.player2.isTaur() || this.player2.isDrider()) {
            ...
            if (this.player2.hasVagina()) this.outputText(", " + this.player2.mf("his", "her") + " female jizz spattering unnoticed onto the ground behind the pair of you");
            this.outputText(".");
        ...
        // Else:
            ...
            if (this.player2.hasVagina()) this.outputText(", " + this.player2.mf("his", "her") + " female jizz spattering unnoticed onto the ground beneath the pair of you");
            this.outputText(".");
    ...
    private putUrtasWangInPCsCunt(truth: boolean): void {
        this.clearOutput();
        this.outputText("You push " + this.player2.short + " down on " + this.player2.mf("his", "her") + " back, a task made all the more difficult by your growing arousal.  Thankfully, " + this.player2.mf("he", "she") + "'s not wearing " + this.player2.mf("his", "her") + " usual " + this.player2.armorName + ".  Instead, " + this.player2.mf("his", "her") + " form is bared to your probing fingertips, pliant and exposed.  You cannot help but dip a finger into " + this.player2.mf("his", "her") + " moist delta, parting the oozing veil to enjoy the view of " + this.player2.mf("his", "her") + " ");
        ...
        this.outputText("\n\nYou twist around and grab at the straps holding your gear together with hands shaking so hard they fumble off of them more often than not.  " + this.player2.short + " laughs again at your mistake, gently cupping your smooth nutsack in " + this.player2.mf("his", "her") + " hand.  Your mammoth balls are so large that they hang partway off " + this.player2.mf("his", "her") + " palm on either side, but " + this.player2.mf("he", "she") + " doesn't seem to mind.  In fact, " + this.player2.mf("he", "she") + " begins to roll them back and forth luxuriously.  Your tip flares slightly as it releases a slippery deposit onto ");
        if (this.player2.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150) this.outputText("the curve of " + this.player2.mf("his", "her") + " pregnant belly");
        else if (this.player2.tone >= 65) this.outputText("" + this.player2.mf("his", "her") + " toned abdomen");
        else if (this.player2.tone < 30) this.outputText("" + this.player2.mf("his", "her") + " soft, forgiving middle");
        else this.outputText("" + this.player2.mf("his", "her") + " belly");
        ...
        this.outputText("\n\n" + this.player2.short + " gently rests " + this.player2.mf("his", "her") + " finger across your nose and lips, commanding, \"<i>Hold on a second.</i>\"  You look at " + this.player2.mf("him", "her") + " and pant, your tongue dangling freely, dripping with frothy saliva as you try to contain yourself.  Your erection, painfully hard, twitches when " + this.player2.mf("he", "she") + " finally stops teasing it, already missing the pleasant touches.  Thankfully, " + this.player2.mf("he", "she") + " begins to remove your armor for you, smoothly undoing one strap at a time.   You sigh in exquisite relief when your chest bounces free, released from the binding leather bondage.  " + this.player2.short + " tosses the armor aside before rounding back to your skirt.  A quick twist of the clasps, and it joins the rest of the ensemble, leaving you naked and exposed.");

        this.outputText("\n\n\"<i>Was that what you wanted?</i>\" " + this.player2.mf("he", "she") + " asks.  You shut " + this.player2.mf("him", "her") + " up by kissing " + this.player2.mf("him", "her") + ", mashing your tits into " + this.player2.mf("his", "her") + " chest so hard that they bulge out obscenely, pressed down painfully.  Your tongue twines with " + this.player2.short + "'s, twisting into a double helix of lusty licks and slippery, oral caresses.  Pleasantly, your monstrous equine dong is dripping pre all over " + this.player2.mf("his", "her") + " middle, right up onto the bottom of " + this.player2.mf("his", "her") + " chest.  " + this.player2.mf("He", "She") + " has to force you back up off " + this.player2.mf("him", "her") + " with both hands, just to be able to talk.  Breathily, " + this.player2.mf("he", "she") + " whispers, \"<i>I hope you didn't come all this way just to make out all night.</i>\"");

        this.outputText("\n\nYou answer with a feral, lusty snarl ");
        // {fork centaurs/nagas/goo here}
        // {centaur}
        if (this.player2.isTaur()) {
            this.outputText("and climb off the 'taur-" + this.player2.mf("man", "woman") + ".  " + this.player2.mf("He", "She") + " smirks up at you, until you bid " + this.player2.mf("him", "her") + " to rise, telling " + this.player2.mf("him", "her") + " that you plan to mount " + this.player2.mf("him", "her") + " like the fertile filly " + this.player2.mf("he", "her") + " is. Reluctantly, " + this.player2.short + " clatters up onto " + this.player2.mf("his", "her") + " hooves.");
            if (this.player2.tail.type > Tail.NONE) this.outputText("  You stroke " + this.player2.mf("his", "her") + " tail as you shift it aside");
            else this.outputText("  You stroke " + this.player2.mf("his", "her") + " swollen sex as you admire it");
            this.outputText(", making sure you've got the perfect view of " + this.player2.mf("his", "her") + " lube-slimed horse-cunt.  Unbidden, your cock thickens, disgorging a potent trail of animal-pre down its underside in anticipation.");
            if (this.player2.wetness() >= 4) this.outputText("  Fuck, " + this.player2.mf("he", "she") + "'s wetter than Edryn!  Just look at those heavy trails of slick moisture as they run down " + this.player2.mf("his", "her") + " rump and hindlegs.");
            else if (this.player2.wetness() >= 2) this.outputText("  Fuck, " + this.player2.mf("he", "she") + "'s as wet as Edryn!  Beads of moisture are forming on " + this.player2.mf("his", "her") + " clit, ready to drop to the ground.");
            else this.outputText("  Fuck, " + this.player2.mf("he", "she") + "'s almost as wet as Edryn!  Just getting a sniff of " + this.player2.mf("his", "her") + " horny horse-snatch has your head swimming!");
            this.outputText("  You give it a lick and shudder, taking in a few deep lungfuls of " + this.player2.mf("his", "her") + " scent.");
            if (this.player2.tallness >= 84) this.outputText("  Before you know what you're doing, you've pulled " + this.player2.mf("his", "her") + " back to a rock and climbed atop it, bringing your cock level with that heavenly hole.");
        ...
        // {goo}
            ...
            this.outputText("and roll the gooey woman so " + this.player2.mf("he", "she") + "'s face down.  " + this.player2.mf("He", "She") + " holds " + this.player2.mf("him", "her") + "self up off the dry dirt with " + this.player2.mf("his", "her") + " palms, sweet, slimy bottom upraised above " + this.player2.mf("his", "her") + " goopy undercarriage.  Amazingly, there's a slight parting in the mass of slime, right between where " + this.player2.mf("his", "her") + " legs would be, if " + this.player2.mf("he", "she") + " had them.  A narrow, barely visible divide can be spotted inside, capped with the telltale bulge of " + this.player2.mf("his", "her") + " ");
            if (this.player2.getClitLength() < .5) this.outputText("tiny ");
            else if (this.player2.getClitLength() >= 2.5) this.outputText("massive ");
            this.outputText("button.  You nuzzle up to that slick slime-cunt, sniffing at " + this.player2.mf("his", "her") + " super-wet snatch, taking the pheromones as deeply inside yourself as possible.  " + this.player2.mf("His", "Her") + " femininity is so strong that it makes your head spin and your dick ache.  Glancing down as you lick the moisture from your muzzle, you see the rigid, over-engorged veins standing out in harsh relief on your equine tool.  Your legs seem to move on their own, lining you up with the moisture-laden slit just inches away.");
        }
        // {nagas}
        else if (this.player2.isNaga()) {
            this.outputText("and roll the snake-woman over so " + this.player2.mf("he", "she") + "'s prostrate on the ground, barely holding " + this.player2.mf("him", "her") + " front half up with " + this.player2.mf("his", "her") + " arms.  " + this.player2.mf("His", "Her") + " loins are flat on the ground, undulating slightly as " + this.player2.mf("he", "she") + " grinds " + this.player2.mf("his", "her") + " moist clit against it for sensation.  Your lover's anatomy poses a problem for your choice of positions, but then, inspiration strikes.  You come up under the hind part of " + this.player2.mf("his", "her") + " snake-tail, and hoisting it up, you support half over your shoulder.  As expected, " + this.player2.mf("he", "she") + " has all the flexibility of the serpent " + this.player2.mf("he", "she") + " so resembles, and " + this.player2.mf("his", "her") + " tail bends down just far enough for " + this.player2.mf("his", "her") + " cunt to hang a mere inch above your rigid tool, right where " + this.player2.mf("his", "her") + " body changes from snake to person.");
            if (this.player2.wetness() >= 3) this.outputText("  " + this.player2.mf("His", "Her") + " moisture drizzles from that wanton slit, basting you with " + this.player2.mf("his", "her") + " fragrant femininity, and you have a hard time not taking " + this.player2.mf("him", "her") + " here and now.");
            this.outputText("  The tail you're holding up coils in, sliding around your arm and middle, wrapping you up in snakey snugness.  With impeccable control, " + this.player2.mf("he", "she") + " squeezes a little bit, bringing " + this.player2.mf("his", "her") + " cunt close enough to breathe foggy moisture on your equine tool.");
        }
        // {biped}
        else {
            this.outputText("and roll " + this.player2.mf("him", "her") + " over on " + this.player2.mf("his", "her") + " hands and knees, lifting that sweet butt up in the air where you can admire it.  You kneel behind " + this.player2.mf("his", "her") + " and, pressing your nose into " + this.player2.mf("his", "her") + " fragrant quim, you extend your tongue, letting the smooth oral muscle taste " + this.player2.mf("his", "her") + " juices and tease at " + this.player2.mf("his", "her") + " engorging clit.  " + this.player2.short + " moans and presses back into you, crying out like a true bitch in heat, one in need of a thorough rutting.  The thought hits your cock like a lightning bolt, and it fills out to painful proportions, every vein and bulge standing out in stark relief, thumping obscenely to the tune of your insatiable lust.  You moan into " + this.player2.mf("his", "her") + " lovely-tasting snatch, gulping down ");
            if (this.player2.wetness() < 3) this.outputText("every drop of nectar that " + this.player2.mf("he", "she") + " gives up");
            else if (this.player2.wetness() < 4) this.outputText("the copious drops of nectar " + this.player2.mf("he", "she") + " gives up");
            else if (this.player2.wetness() < 5) this.outputText("the drizzling moisture that oozes from " + this.player2.mf("his", "her") + " twat");
            else this.outputText("the rivers of girl-lube that run unimpeded from " + this.player2.mf("his", "her") + " sopping twat");
            this.outputText(".  You sniff in great lungfuls of " + this.player2.mf("his", "her") + ", your head swimming with need, and before you know it, you've risen behind " + this.player2.mf("him", "her") + ", your oozing flare just inches from that delectable opening.");
        }

        this.outputText("\n\nGrabbing hold of " + this.player2.short + " by " + this.player2.mf("his", "her") + " waist, you level your phallus up against " + this.player2.mf("his", "her") + " lips and press forward, hard.  " + this.player2.mf("His", "Her") + " velvet curtains part slowly under your relentless pressure, a hanging veil of lubricants sheathing your head as it batters its way inside " + this.player2.mf("him", "her") + " in pliant depths.  " + this.player2.mf("He", "She") + " fits you like a glove, a soft, squishy, velvet-lined glove that squeezes back against you oh-so-perfectly.  You groan in delight, but " + this.player2.mf("he", "she") + "'s only taken a few inches - there's at least fifteen more, throbbing bigger in excitement.  " + this.player2.short + " grunts out loud, pushing back against you, stretching " + this.player2.mf("him", "her") + "self around you to take a little bit more.  " + this.player2.mf("His", "Her") + " lips cling to your girth, welcoming ever greater lengths of your iron shaft into the swelteringly pleasant embrace of " + this.player2.mf("his", "her") + " needy hole.  When your medial ring catches " + this.player2.mf("his", "her") + " clit, " + this.player2.mf("he", "she") + " moans, shaking " + this.player2.mf("his", "her") + " asscheeks at you.");

        this.outputText("\n\nYou smack " + this.player2.short + " on the ass, and " + this.player2.mf("he", "she") + " wiggles again, this time slower, and more sensually.  " + this.player2.mf("His", "Her") + " cunt feels sinfully tight around you");
        if (this.player2.vaginalCapacity() >= 200) this.outputText(", though you know " + this.player2.mf("he", "she") + " can handle cocks with Edryn's ease");
        this.outputText(".  It's a wonderful sensation, and you push the rest of the way in with one, hard thrust.  Your sheath is pushed back against you, releasing an extra inch of horse-cock into your partners willing, lube-dripping pussy.  The oversensitive horseflesh bombards you with a wave of fresh feelings so strong that your legs nearly fold under you.  You dig your hands into " + this.player2.short + "'s haunches for support and hang on for dear life, instinctively plowing " + this.player2.mf("his", "her") + " [vagina] like your life depended on it.");

        this.outputText("\n\nMoaning, " + this.player2.mf("he", "she") + " looks over " + this.player2.mf("his", "her") + " shoulder and whispers, \"<i>Do it!  I can-can't take much more!</i>\"");

        this.outputText("\n\nYou oblige your lover's request (as if you had any other option) and hammer your oozing dick deep into " + this.player2.short + "'s puffy vagina so hard that your tip butts up against " + this.player2.mf("his", "her") + " cervix, bowing it in towards " + this.player2.mf("his", "her") + " unprotected womb.  " + this.player2.mf("He", "She") + " squeezes down like a vice, wringing your cock with juicy, slippery walls.  You moan with " + this.player2.mf("him", "her") + ", balls tensing, lifting slightly in your sack as they ready your juicy load.  Climactic bliss erupts from within and your flare nearly doubles in size, locking itself in the honeyed heaven it so loves to nestle itself into.  Bubbling heat builds inside until you feel as if your body is about to light aflame, and then, in a dizzying rush, you release the first sticky deposit into your lover's womb.  " + this.player2.mf("He", "She") + " moans, wiggling happily as some slips into " + this.player2.mf("his", "her") + " womb, while the rest begins to flood every nook and cranny of " + this.player2.mf("his", "her") + " violated tunnel.");

        this.outputText("\n\nAgain and again, you fire sticky white loads deep into " + this.player2.short + "'s body, anchored tightly by the flaring horse-cock you used to hate, but have come to accept with " + this.player2.short + "'s help.  " + this.player2.mf("He", "She") + " taught you that you could be loved, and as you thoroughly seed " + this.player2.mf("his", "her") + " womb a teardrop of moisture beads at the corner of your eye.  " + this.player2.mf("He", "She") + " loves you, cock and all, and there's nothing you'd rather be doing than spending the night with " + this.player2.mf("him", "her") + ".  " + this.player2.mf("His", "Her") + " belly rounds slightly");
        if (this.player2.pregnancyIncubation > 0 && this.player2.pregnancyIncubation < 150) this.outputText(" (more than it already is)");
        this.outputText(" from your prodigious deposit.  The illusion of knocking " + this.player2.mf("him", "her") + " up takes hold of you, and your orgasm redoubles, fresh waves of horse-cum pouring out of you unceasingly.  " + this.player2.short + " moans, rubbing " + this.player2.mf("him", "her") + " taut");
        ...
        if (this.player2.hasCock()) {
            ...
            if (this.player2.cumQ() < 50) this.outputText("Ropes of seed shoot from " + this.player2.mf("his", "her") + " prick.  After a few shots of cum, " + this.player2.mf("his", "her") + " cock stops leaking at once.");
            else if (this.player2.cumQ() < 250) this.outputText("Thick ropes of seed shoot from " + this.player2.mf("his", "her") + " prick.  " + this.player2.mf("He", "She") + " definitely made a bit of mess. ");
            else if (this.player2.cumQ() < 1000) this.outputText("Thick ropes of seed shoot from " + this.player2.mf("his", "her") + " prick.  This continues for a while and eventually, " + this.player2.mf("he", "she") + " stops after " + this.player2.mf("he", "she") + " made a large puddle of cum.");
            else if (this.player2.cumQ() < 2500) this.outputText("Torrents of cum blast from " + this.player2.mf("his", "her") + " prick.  This continues for a while and eventually, " + this.player2.mf("he", "she") + " stops after " + this.player2.mf("he", "she") + " made a large puddle of cum.");
            else this.outputText("Torrents of cum blast from " + this.player2.mf("his", "her") + " prick.  This continues for a few minutes and eventually, " + this.player2.mf("he", "she") + " stops after " + this.player2.mf("he", "she") + " made a huge puddle of cum.");
        }
        this.outputText("\n\nYou lay down on " + this.player2.mf("his", "her") + " back, exhausted, and " + this.player2.mf("he", "she") + " rolls onto " + this.player2.mf("his", "her") + " side, taking you with " + this.player2.mf("his", "her") + ".  Snuggled together, genitals still locked and dripping, the two of your doze off together, whispering sweet nothings into the still, night air.");
        // Slimefeed!   Virgin removal + stretching silently
        this.player2.slimeFeed();
    ...
    public urtaSpecials(): void {
        // Gone	menuLoc = 3;
        if (this.getGame().inCombat && this.player.hasStatusEffect(StatusEffects.Sealed) && this.player.statusEffectv2(StatusEffects.Sealed) == 5) {
            this.clearOutput();
        ...
        this.menu();
        this.addButton(0, "Combo", this.urtaComboAttack).hint("Make a three-hit combo.  Each attack has an extra 33% chance to miss, unless the target is blind. \n\nFatigue cost: 25");
        this.addButton(1, "Vault", this.urtaVaultAttack).hint("Make a vaulting attack for an extra 25% damage.  Automatically crits stunned foes. \n\nFatigue cost: 20");
        this.addButton(2, "Sidewinder", this.urtaSidewinder).hint("An attack that hits for reduced damage but has a high chance of stunning. \n\nFatigue cost: 10");
        this.addButton(3, "Dirt Kick", this.urtaDirtKick).hint("Attempt to blind your foe with a spray of kicked dirt. \n\nFatigue cost: 5");
        this.addButton(4, "Metabolize", this.urtaMetabolize).hint("Convert 10% of your maximum HP into fatigue.");
        this.addButton(5, "SecondWind", this.urtaSecondWind).hint("Regain 50% of your HP, 50 fatigue, and reduce lust by 50 once per fight.", "Second Wind");
        this.addButton(14, "Back", this.combat.combatMenu, false);
    }
    ...
    private urtaSecondWind(): void {
        this.clearOutput();
        if (this.monster.hasStatusEffect(StatusEffects.UrtaSecondWinded)) {
        ...
        this.monster.createStatusEffect(StatusEffects.UrtaSecondWinded, 0, 0, 0, 0);
    ...
    private urtaComboAttack(): void {
        if (!this.player.hasStatusEffect(StatusEffects.Attacks)) {
            this.clearOutput();
            if (this.player.fatigue + 25 > this.player.maxFatigue()) {
        ...
        if (!this.player.hasStatusEffect(StatusEffects.Attacks))
            this.player.createStatusEffect(StatusEffects.Attacks, 3, 0, 0, 0);
        else {
            this.player.addStatusValue(StatusEffects.Attacks, 1, -1);
            if (this.player.statusEffectv1(StatusEffects.Attacks) <= 1) {
                this.player.removeStatusEffect(StatusEffects.Attacks);
            }
        }
        // Blind
        if (this.player.hasStatusEffect(StatusEffects.Blind)) {
            this.outputText("You attempt to attack, but as blinded as you are right now, you doubt you'll have much luck!  ");
        }
        let damage: number;
        // Determine if dodged!
        if (!this.monster.hasStatusEffect(StatusEffects.Blind) && (UrtaQuest.rand(3) == 0 || (this.player.hasStatusEffect(StatusEffects.Blind) && UrtaQuest.rand(2) == 0) || (this.monster.spe - this.player.spe > 0 && int(Math.random() * (((this.monster.spe - this.player.spe) / 4) + 80)) > 80))) {
            if (this.monster.spe - this.player.spe < 8) this.outputText(this.monster.capitalA + this.monster.short + " narrowly avoids your attack!");
            if (this.monster.spe - this.player.spe >= 8 && this.monster.spe - this.player.spe < 20) this.outputText(this.monster.capitalA + this.monster.short + " dodges your attack with superior quickness!");
            if (this.monster.spe - this.player.spe >= 20) this.outputText(this.monster.capitalA + this.monster.short + " deftly avoids your slow attack.");
            this.outputText("\n");
            if (this.player.hasStatusEffect(StatusEffects.Attacks)) {
        ...
        if (damage > 0) {
            ...
            damage = this.combat.doDamage(damage);
        }
        if (damage <= 0) {
            damage = 0;
            this.outputText("Your attacks are deflected or blocked by " + this.monster.a + this.monster.short + ".");
        }
        else {
            this.outputText("You hit " + this.monster.a + this.monster.short + "! (" + damage + ")");
        ...
        if (this.monster.HP >= 1 && this.monster.lust <= 99) {
            ...
            if (this.monster.HP <= 0) this.doNext(this.combat.endHpVictory);
            else this.doNext(this.combat.endLustVictory);
        }
    }
    ...
    private urtaDirtKick(): void {
        this.clearOutput();
        if (this.player.fatigue + 5 > this.player.maxFatigue()) {
        ...
        // Blind
        if (this.player.hasStatusEffect(StatusEffects.Blind)) {
            this.outputText("You attempt to dirt kick, but as blinded as you are right now, you doubt you'll have much luck!  ");
        }
        ...
        else if (this.monster.hasStatusEffect(StatusEffects.Blind)) {
            this.outputText(this.monster.mf("He", "She") + "'s already blinded.  What a waste.\n\n");
        }
        else {
            this.outputText(this.monster.mf("He", "She") + "'s blinded!\n\n");
            this.monster.createStatusEffect(StatusEffects.Blind, 2 + UrtaQuest.rand(3), 0, 0, 0);
        }
        this.monster.doAI();
    }
    ...
    private urtaSidewinder(): void {
        this.clearOutput();
        if (this.player.fatigue + 10 > this.player.maxFatigue()) {
            this.outputText("You are too fatigued to use that attack!");
            // Gone		menuLoc = 3;
            // 		doNext(getGame().combatMenu);
            this.menu();
        ...
        // Blind
        if (this.player.hasStatusEffect(StatusEffects.Blind)) {
            this.outputText("You attempt to hit with a vicious blow to the side, but as blinded as you are right now, you doubt you'll have much luck!  ");
        }
        else this.outputText("You make a wide swing to the side, hoping to stun your foe!  ");
        let damage: number;
        // Determine if dodged!
        if ((this.player.hasStatusEffect(StatusEffects.Blind) && UrtaQuest.rand(2) == 0) || (this.monster.spe - this.player.spe > 0 && int(Math.random() * (((this.monster.spe - this.player.spe) / 4) + 80)) > 80)) {
            if (this.monster.spe - this.player.spe < 8) this.outputText(this.monster.capitalA + this.monster.short + " narrowly avoids your attack!");
            if (this.monster.spe - this.player.spe >= 8 && this.monster.spe - this.player.spe < 20) this.outputText(this.monster.capitalA + this.monster.short + " dodges your attack with superior quickness!");
            if (this.monster.spe - this.player.spe >= 20) this.outputText(this.monster.capitalA + this.monster.short + " deftly avoids your slow attack.");
            this.outputText("\n\n");
        ...
        if (!this.monster.hasStatusEffect(StatusEffects.Stunned) && this.monster.findPerk(PerkLib.Resolute) < 0 && damage > 0) {
            if (this.monster.tou / 10 + UrtaQuest.rand(20) + 1 < 20) {
                this.outputText("\n<b>" + this.monster.capitalA + this.monster.short + " is stunned!</b>");
                this.monster.createStatusEffect(StatusEffects.Stunned, 1, 0, 0, 0);
            }
        }
        ...
        // Kick back to main if no damage occured!
        if (this.monster.HP >= 1 && this.monster.lust <= 99) {
            if (this.player.hasStatusEffect(StatusEffects.FirstAttack)) {
                this.combat.attack();
                return;
            }
            this.outputText("\n");
    ...
    private urtaVaultAttack(): void {
        ...
        this.player.changeFatigue(20);
        if (this.player.hasStatusEffect(StatusEffects.Sealed) && this.player.statusEffectv2(StatusEffects.Sealed) == 0) {
        ...
        // Blind
        if (this.player.hasStatusEffect(StatusEffects.Blind)) {
            this.outputText("You attempt to make a high, vaulting attack, but as blinded as you are right now, you doubt you'll have much luck!  ");
        }
        ...
        // Determine if critical hit!
        let crit: boolean = false;
        if (this.monster.hasStatusEffect(StatusEffects.Stunned) || UrtaQuest.rand(100) <= 4 || (this.player.findPerk(PerkLib.Tactician) >= 0 && this.player.inte >= 50 && (this.player.inte - 50) / 5 > UrtaQuest.rand(100))) {
            crit = true;
            damage *= 2;
        }
        // Start figuring enemy damage resistance
    ...
    private gnollAlphaBitchIntro(): void {
        ...
        this.monster.HP = this.monster.maxHP(); // TODO extract to AlphaGnoll class
    ...
    private urtaSleepsArmored(): void {
        ...
        this.player.HPChange(.5 * this.player.maxHP(), false);
        this.player.changeFatigue(-50);
        this.player.orgasm('Dick');
        this.menu();
    ...
    private urtaSleepsNaked(): void {
        ...
        this.player.HPChange(this.player.maxHP(), false);
    ...
    public urtaSubmitsToMinotaurBadEnd(): void {
        ...
        if (this.monster.hasStatusEffect(StatusEffects.MinotaurEntangled)) this.outputText("   Seeing the fire in your eyes change from a determined glare to a lusty look, the minotaur pulls you over, carefully unwinding the chain from around you, so as not to damage you.");
    ...
    public winRapeAMinoLordAsUrta(): void {
        ...
        if (this.monster.lust >= this.monster.maxLust()) this.outputText("lusty");
    ...
    public milkyUrtaTic(): void {
        ...
        this.outputText("\n\n");
        this.player.addStatusValue(StatusEffects.MilkyUrta, 1, -1);
        if (this.player.statusEffectv1(StatusEffects.MilkyUrta) <= 0) this.player.removeStatusEffect(StatusEffects.MilkyUrta);
        this.dynStats("lus", 10);
    }
    ...
    public urtaBeatsUpCowcubi(): void {
        ...
        this.dynStats("lus", 40, "scale", false);
        // [Leave] [Fuck]
        this.menu();
    ...
    private knockUpUrtaWithGodChild(): void {
        ...
        this.outputText(".  The nub of her clit is a diamond-hard button that drags across your sensitive [skin], aggressively smashed into your genitals.  Still, somehow, she seems to be holding back, probing you with some last vestige of sanity for your consent.");

        this.outputText("\n\nSighing, you figure you may as well lie back and enjoy it, and you push your tongue back against hers, letting her set the fevered, frenzied pace but along for the ride regardless.  She picks up on the change in your attitude and shifts, a soft-fingered grip snaring [oneCock] and lifting it up, pressing it into the slick wetness between her thighs.  You gasp, muffled by her overwhelmingly intense french-kiss, the fox-girl's puffy black lips smothering your own in warm, wet affection.  Likewise, the onyx opening of her vagina yields against your " + this.player.cockDescript(x) + ", clinging tightly around your girth as they swallow the first few inches of you.  Already, you can feel her inner walls massaging your tender erection towards orgasm.  They squeeze and tug on your " + this.player.cockHead(x) + " powerfully while small squirts of fox-lube drizzle down to your [sheath].  The fox drives herself the rest of the way down onto you.  Her hips hit yours with a loud smack, splattering her moisture down your [legs].");

        this.outputText("\n\nFinally, Urta breaks the kiss, panting for air as she begins to buck and rock atop you.  Your " + this.player.cockDescript(x) + " shivers against the squeezing pressures the frenzied fox is forcing upon you, and already you can feel yourself trickling and leaking into her sodden vice.  Both of your bodies have become absolutely drenched in sticky, musky horse-pre");
    ...
    private postFuckUrtaUp(): void {
        ...
        if (this.flags[kFLAGS.FACTORY_SHUTDOWN] > 0) this.outputText(" - besides, given you know that you're nothing but a sacrifice the demons are too lazy to collect, it's not like they'll really send an invasion through");
    ...
    private getKnockedUpWithGodChild(): void {
        ...
        if (this.player.tail.type > Tail.NONE) this.outputText(", though getting your tail angled right to allow her entrance is a bit of a challenge");
