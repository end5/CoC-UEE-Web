...
export class Gargoyle extends BaseContent {
    ...
    public gargoylesTheShowNowOnWBNetwork(): void {
        ...
        if (this.flags[kFLAGS.TIMES_EXPLORED_DESERT] > 0) this.outputText(", making even the desert seem healthy and full of life");
        ...
        if (this.player.statusEffectv1(StatusEffects.TelAdre) >= 1) this.outputText("or the ruins of one of Tel'Adre's more distant neighbors, ");
    ...
    private gargoyleMeeting2(): void {
        this.clearOutput();
        this.spriteSelect(SpriteDb.s_gargoyle);
        ...
        this.outputText(this.images.showImage("gargoyle-cathedral"));
    ...
    private nameZeGargoyle(): void {
        if (this.mainView.nameBox.text === "" || this.mainView.nameBox.text === "0" || this.mainView.nameBox.text === "1") {
            ...
            this.menu();
            this.mainView.promptCharacterName();
    ...
    public returnToCathedral(woken: boolean = false): void {
        ...
        if (this.getGame().time.hours <= 9 || this.getGame().time.hours >= 18 || woken) {
            if (!woken) {
                this.outputText(this.images.showImage("gargoyle-cathedral"));
                this.outputText("\n\nIn the dim ");
                if (this.getGame().time.hours <= 9) this.outputText("early morning");
            ...
            if (this.player.lust >= 33) {
                ...
                this.addDisabledButton(0, "Sex", "You are not aroused enough.");
            }
            this.addButton(1, "Rituals", this.ritualGargoyle);
            if (this.flags[kFLAGS.GAR_HISTORY] < 3 || this.flags[kFLAGS.GAR_CATHEDRAL] < 3 || this.flags[kFLAGS.GAR_NAME_TALKS] < 3) {
                this.addButton(2, "Talk", this.talkToGargoyle);
            } else {
                this.addDisabledButton(2, "Talk", "She has nothing more to tell you.");
            }
            ...
            if (this.gargoyleConfidence() >= 70 && this.flags[kFLAGS.RITUAL_INTRO] > 0) {
                ...
                this.addDisabledButton(4, "Kinky Rituals", "Maybe if you'll know her better...");
            }
        }
        // [b]Cathedral Interior: 10:00 –> 17:00[/b]
            ...
            if (this.player.lust >= 33) {
                ...
                else this.addDisabledButton(1, "Use Her", "This scene requires you to have genitals.");
            } else {
                this.addDisabledButton(1, "Use Her", "You are not aroused enough.");
            }
            this.addButton(3, "Appearance", this.gargoyleAppearance);
        }
    ...
    private gargoyleSexMenu(): void {
        ...
        if (this.player.hasCock()) {
            ...
            this.addDisabledButton(0, "Vaginal", "This scene requires you to have cock.");
            this.addDisabledButton(1, "Anal", "This scene requires you to have cock.");
            this.addDisabledButton(2, "Titfuck", "This scene requires you to have cock.");
        }
        this.addButton(3, "Strap-On", this.strapOnGargoyle);
        if (this.player.hasVagina()) {
            this.addButton(4, "Tail Fuck", this.tailFuckGargoyleScene);
        } else {
            this.addDisabledButton(4, "Tail Fuck", "This scene requires you to have vagina.");
        }
        this.addButton(14, "Leave", this.returnToCathedral);
    }
    ...
    private gargoyleCoochiiGetsPlowed(): void {
        ...
        this.outputText("\n\nThe two of you lay there for a while after, until your " + this.player.cockDescript(x) + " has deflated and you've both stopped panting from exertion and pleasure.  Giving her another kiss, you pull out of her cold depths – now significantly warmer thanks to your passion – and stuff your dick back into your armor.");
        ...
        this.outputText("\n\n\"<i>Thank you, Master,</i>\" she says, running a hand through your " + this.player.hairDescript() + ".  \"<i>That was wonderful.</i>\"");
    ...
    private ritualGargoyle(): void {
        ...
        if (this.player.hasStatusEffect(StatusEffects.Infested) || this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.addButton(2, "Banish", this.banishmentGargoyleRitual);
        else {
            this.addDisabledButton(2, "Banish", "A ritual that banishes evil creatures and spirits...");
        }
    ...
    private bodyRitual(): void {
        this.clearOutput();
        this.outputText("You tell " + this.flags[kFLAGS.GAR_NAME] + " that you could stand to reverse some of the corruption that has affected your body.  With a solemn nod, she takes you to a side alcove near the altar and instructs you to spread your arms and legs.  Hesitantly, you do so, and from the floor and ceiling " + this.flags[kFLAGS.GAR_NAME] + " produces leather straps with rough looped straps.  Before you can react, she binds your arms and legs, spreading you eagle against the cold stone wall.");
    ...
    private banishmentGargoyleRitual(): void {
        ...
        if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText("a hitchhiker");
        ...
        if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText("this bastard");
        ...
        // with Exgartuan:
        if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText("  Booming from within you, you hear the demon's voice: \"<i>Hey!  What the shit is this!?  What're you doing? Fucking stop, you ingrate!</i>\"");
        // with Worms:
        ...
        if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText("creature within you has");
        ...
        if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText("possessed");
        ...
        if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.player.removeStatusEffect(StatusEffects.Exgartuan);
        else this.player.removeStatusEffect(StatusEffects.Infested);
    ...
    private gargoyleKinkyRituals(): void {
        ...
        if (this.player.hasStatusEffect(StatusEffects.Infested) || this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.addButton(2, "Banish", this.banishPervRitual);
        else {
            this.addDisabledButton(2, "Banish", "A ritual that banishes evil creatures and spirits...");
        }
        this.addButton(4, "Leave", this.returnToCathedral);
    ...
    private kinkyBodyRitual(): void {
        ...
        // if Male/Herm:
        if (this.player.hasCock()) this.outputText(this.player.cockDescript(0));
    ...
    private banishPervRitual(): void {
        ...
        if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText("it");
        ...
        // If PC has Worms:
        if (!this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText("  You can feel her cock ram against your prostate, and shudder as the writhing mass of worms begin to panic as her cock pushes against them, obviously causing the creatures great pain.");
        ...
        // (If PC has Exgartuan:
        if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText("  You can hear the demonic voice of Exgartuan inside your mind, yelling and cursing as he is rapidly drained from your body and sealed into the holy rod within you.");
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText("Exgartuan is");
        ...
        if (this.player.hasStatusEffect(StatusEffects.Exgartuan)) this.outputText(" within you has");
    ...
    private talkToGargoyle(output: boolean = true): void {
        ...
        this.menu();
        if (this.flags[kFLAGS.GAR_HISTORY] < 3) {
            this.addButton(0, "History", this.historyGo);
        } else {
            this.addDisabledButton(0, "History");
        }
        if (this.flags[kFLAGS.GAR_CATHEDRAL] < 3) {
            this.addButton(1, "Cathedral", this.cathedralTalks);
        } else {
            this.addDisabledButton(1, "Cathedral");
        }
        if (this.flags[kFLAGS.GAR_NAME_TALKS] < 3) {
            this.addButton(2, "Her", this.talkAboutGarName);
        } else {
            this.addDisabledButton(2, "Her");
        }
        this.addButton(14, "Back", this.returnToCathedral);
    }
    ...
    private gargoyleHistoryC(): void {
        ...
        else if (this.player.hasStatusEffect(StatusEffects.CampMarble)) {
