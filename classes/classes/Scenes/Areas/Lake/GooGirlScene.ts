...
export class GooGirlScene extends AbstractLakeContent implements Encounter {
		public  GooGirlScene(pregnancyProgression:PregnancyProgression, output:GuiOutput)
		{
	...
	private  _encounter:Encounter = Encounters.complex(Encounters.fn.ifLevelMin(2), {
