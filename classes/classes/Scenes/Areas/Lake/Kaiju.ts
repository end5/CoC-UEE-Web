...
export class Kaiju extends AbstractLakeContent implements Encounter {
...
//[If no]
private  noMeetingKaijus(never: boolean=false): void {
	clearOutput();
...
private  fuckThisGiantYouDumbCuntt(): void {
	clearOutput();
