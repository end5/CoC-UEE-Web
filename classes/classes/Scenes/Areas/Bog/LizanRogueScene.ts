	...
	export class LizanRogueScene extends BaseContent
	{
		...
		var  lizan:LizanRogue = new LizanRogue();
			if (!player.isPureEnough(30)) {
				...
				menu();
				addButton(0, "Fight", fightLizan, false, undefined, undefined, "Fight the lizan!");
				...
				menu();
				addButton(0, "Spar", fightLizan, true, undefined, undefined, "Do a spar session with the lizan!");
				if (player.lust >= 33) {
				...
				addButton(2, "Decline", leaveLizan, true, undefined, undefined, "Excuse yourself and leave.");
			}
		...
		public  consensualWatersports(): void { //Yay watersports!
			...
			dynStats("lus", 10);
			menu();
			addButton(0, "Continue", haveSexWithLizan, true, undefined, undefined, "Continue having sex.");
