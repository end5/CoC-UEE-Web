...
export class ChameleonGirlScene extends BaseContent {
    ...
    public encounterChameleon(): void {
        ...
        this.spriteSelect(SpriteDb.s_chameleon);
    ...
    public loseToChameleonGirl(): void {
        ...
        if (this.player.gender == 3 && rand(2) == 0) this.loseToChameleonWithCockAnBallsAnCunt();
        else if (this.player.gender == 1 || (this.player.gender == 3 && rand(2) == 0)) this.dudesLoseToChamChams();
    ...
    private loseToChameleonWithCockAnBallsAnCunt(): void {
        ...
        this.spriteSelect(SpriteDb.s_chameleon);
        this.outputText(this.images.showImage("chameleon-herm-lose-footjob-taildick"));
        ...
        this.outputText("\n\nAs you set the last bit of your " + this.player.armorName + " aside in the water, you're suddenly struck in your chest and pushed to the ground.  The chameleon girl's wide foot keeps you pinned down, and she looks at you almost apologetically.  She shakes the worry from her face, and tries to appear stern once again.  \"<i>I'll... I'll show you who's the boss around here!</i>\"  Her tail darts towards you and uncoils at its end.  The tip starts probing around your " + this.player.vaginaDescript(0) + ", brushing across your " + this.player.clitDescript() + " as it feels around for your entrance.");
    ...
    private dudesLoseToChamChams(): void {
        const x: number = rand(this.player.totalCocks());
        this.spriteSelect(SpriteDb.s_chameleon);
        this.outputText(this.images.showImage("chameleon-male-lose-facesit-vagsex"));
        this.outputText("\n\nRecognizing that you're no danger, her skin shifts back into its natural " + this.monster.skin.tone + " coloration as she walks towards you.  She swings her hips seductively as she splashes slowly through the water and licks her lips with a loud smack of her tongue, then reaches out and forcefully pulls your " + this.player.armorName + " above your waist before you can even try to resist her advances, and pushes you back against a tree.  With a few quick pulls of fabric she's stripped her own clothes, and she tosses her thong over a low-hanging branch.  The other band of silk she uses to quickly bind your wrists.  Were you in any shape to fight back you could pull free, but you're too ");
        if (this.player.lust >= this.player.maxLust()) this.outputText("overwhelmed by lust");
    ...
    private loseToChamChamWithPCCunt(): void {
        this.spriteSelect(SpriteDb.s_chameleon);
        this.outputText(this.images.showImage("chameleon-female-lose-facesit-tailfuck"));
    ...
    public defeatChameleonGirl(): void {
        ...
        // -Win by HP
            ...
            this.outputText("Too weak to continue fighting, the chameleon girl drops to her knees, exhausted.  Her skin returns to its usual " + this.monster.skin.tone + ", unable to maintain the camouflage.");
        ...
        this.addDisabledButton(2, "Herm Style", "This scene requires you to be a herm and to have sufficient arousal.");
        this.addDisabledButton(3, "SuccMilk", "This scene requires you to have a bottle of Succubus Milk, cock and sufficient arousal.");
        this.addDisabledButton(4, "LustnSensD.", "This scene requires you to have a bottle of Fuck Draft, genitals and sufficient arousal. Lust Draft mixed with Sensitivity Draft would work too.");

        if (this.player.lust >= 33 && !this.player.isGenderless()) {
            if (this.player.hasCock()) {
                this.addButton(0, "Use Dick", this.manFucksChameleonWithBiggishWang);
            }
            if (this.player.hasVagina()) {
                this.addButton(1, "Use Pussy", this.femaleHasWinSexWithChamCham);
            }
            if (this.player.isHerm()) {
                this.addButton(2, "Herm Style", this.fuckDatChameleonAsACoolGuyGirlHerm);
            }
            if ((this.player.hasItem(this.consumables.SUCMILK) || this.player.hasItem(this.consumables.P_S_MLK)) && this.player.hasCock()) {
                this.addButton(3, "SuccMilk", this.giveTheChameleonASuccubiMilk);
            }
            if (this.player.hasItem(this.consumables.SENSDRF) && (this.player.hasItem(this.consumables.L_DRAFT) || this.player.hasItem(this.consumables.F_DRAFT))) {
                this.addButton(4, "LustnSensD.", this.doseDatChameleonWithLustAndSensitivityDrafts);
            }
        }
    ...
    private manFucksChameleonWithBiggishWang(): void {
        ...
        this.spriteSelect(SpriteDb.s_chameleon);
        const x: number = this.player.biggestCockIndex();
        this.outputText(this.images.showImage("chameleon-male-win-get-blowjob"));
        ...
        if (this.player.balls > 0) this.outputText("your " + this.player.ballsDescriptLight() + " clench and ");
        this.outputText("the semen erupts from the end of your " + this.player.cockDescript(x) + " spilling out hot spunk over her folded tongue.  She gasps audibly and arches her back as the thick ropes of your jizz coat her tongue, shoving her long fingers as far as she possibly can into her dripping pussy, and flashes so brightly pink she nearly glows.");
    ...
    private femaleHasWinSexWithChamCham(): void {
        this.clearOutput();
        this.spriteSelect(SpriteDb.s_chameleon);
        this.outputText(this.images.showImage("chameleon-female-win-fingering"));
        this.outputText("You shed your " + this.player.armorName + " and approach the fallen chameleon girl");
        if (this.monster.lust >= this.monster.maxLust()) this.outputText(", her moans of pleasure growing more desperate as you approach");
        ...
        if (this.monster.lust >= this.monster.maxLust()) this.outputText("  She coos lustily at the sensation.");
    ...
    private giveTheChameleonASuccubiMilk(): void {
        this.clearOutput();
        this.spriteSelect(SpriteDb.s_chameleon);
        this.outputText(this.images.showImage("chameleon-male-win-succumilk-titfuck"));
        ...
        this.outputText(" your cock aimed for her pillowy tits.  She pushes and squirms beneath you, but cannot get enough leverage to move you.  You take her breasts in your hands and shimmy up her torso towards them, squeezing them around your " + this.player.cockDescript(x) + ".");
    ...
    private doseDatChameleonWithLustAndSensitivityDrafts(): void {
        ...
        if (!this.player.hasCock() || this.player.cockArea(this.player.smallestCockIndex()) > this.monster.vaginalCapacity()) {
            this.outputText(this.images.showImage("chameleon-male-win-fingering"));
