//Minerva Purification (Light in the Darkness)
	...
	export class MinervaPurification extends BaseContent
	{
		...
		public  purificationByMarae(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Kinathis";
		...
		public  purificationByJojoPart1(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Kinathis";
		...
		public  purificationByJojoPart2(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Kinathis";
		...
		public  purificationByRathazul(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Kinathis";
		...
		//Post-purification
		public  growTreePostPurification(): void {
			clearOutput();
			credits.modContent = true;
		...
		var  chooserArray: any[] = [];
			...
			//Select a scene!
		var  chooser: number = chooserArray[rand(chooserArray.length)];
			clearOutput();
		...
		private  minervaSinging(): void {
			...
			if (flags[kFLAGS.MINERVA_TOWER_TREE] > 0) {
				...
				var  sceneChooser: number = rand(3) 
		...
		private  minervaPregnancyMeet(): void {
			outputText("\n\n");
		...
		private  minervaBabiesMeet(): void {
		var  temp: number = rand(2);
			switch(temp) {
		...
		private  minervaCorruptionMeet(): void {
		...
		private  pureMinervaAppearance(): void {
			clearOutput();
		...
		//  TALKIE TALKIE
		//------------------
		private  minervaTalkSelect(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Kinathis";
			
		var  talkChooser: number = rand(5);
		...
		private  talkToMinervaAboutSpring(): void {
		...
		private  talkToMinervaAboutSharkgirl(): void {
		...
		private  talkToMinervaAboutMotherhood(): void {
		...
		private  talkToMinervaAboutTree(): void {
		...
		private  sleepWithMinervaII(): void {
			clearOutput();
			kGAMECLASS.highMountains.minervaScene.minervaSprite();
		...
		private  sleepWithMinervaPostBirthing(): void {
			clearOutput();
		...
		private  sleepWithMinervaProcess(): void {
			clearOutput();
			kGAMECLASS.timeQ = 10;
			goNext(timeQ, true);
			sleepWithMinervaII();
		}
		private  sleepWithMinervaHeal(): void {
			kGAMECLASS.timeQ = 10;
		...
		//  SEX SCENES!
		//------------------
		private  pureMinervaSexMenu(): void {
			menu();
			clearOutput();
		...
		private  fuckMinervasAsshole(): void {
			clearOutput();
			kGAMECLASS.highMountains.minervaScene.minervaSprite();
		var  x: number = player.cockThatFits(kGAMECLASS.highMountains.minervaScene.minervaACapacity());
		...
		var  x: number = player.cockThatFits(kGAMECLASS.highMountains.minervaScene.minervaVCapacity());
			if (x < 0) x = player.smallestCockIndex();
			clearOutput();
			kGAMECLASS.highMountains.minervaScene.minervaSprite();
			flags[kFLAGS.TIMES_MINERVA_SEXED]++;
		...
		private  getButtFuckedYouSlut(): void {
		var  x: number = player.cockThatFits(kGAMECLASS.highMountains.minervaScene.minervaACapacity());
			if (x < 0) x = player.smallestCockIndex();
			clearOutput();
			kGAMECLASS.highMountains.minervaScene.minervaSprite();
		...
		public  pregnancyStage1(repeat: boolean = false): void {
			clearOutput();
		...
		public  pregnancyStage2(repeat: boolean = false): void {
			clearOutput();
			if (!repeat) {
		...
		public  pregnancyStage3(repeat: boolean = false): void {
			clearOutput();
			if (!repeat) {
		...
		private  postPregnancyStage3Sex(): void {
			clearOutput();
		...
		private  postPregnancyStage3Sleep(): void {
			processSleepTime();
		...
		private  pregnancyStage4(repeat: boolean = false): void {
			clearOutput()
		...
		public  pregnancyPlayerStage1(repeat: boolean = false): void {
			clearOutput();
		...
		public  pregnancyPlayerStage2(repeat: boolean = false): void {
			clearOutput();
			outputText("Sliding your hands down over the gentle baby bump swelling your waistline, you cast your gaze to the one that blessed you with such a motherly gift. The proud siren catching your gaze blushes before grinning to you, her own eyes looking you up and down, undressing you as she looks at you with more than a little hunger. She can't help but watch you as you stroke your swollen tummy, tenderly rubbing the baby sirens that you have growing inside your womb. Shifting from side to side, Minerva seems to be trying hard NOT to just pounce you and cuddle your pregnant body. Biting her lip and grinning wider than ever, Minerva can't hold back a moment longer. Letting out a great bird like chirp she cries out, flapping her great wings, the excited herm barrels into you, plowing you over as she wraps her arms around you and squeezes the daylights out of you. \"<i>Oh darling! I can hardly believe it! Pregnant, you're pregnant and its mine...</i>\" she says, ending in a quiet voice. The golden herm sliding her hands over your body, feeling your tummy gently, stroking and caressing you. The siren that impregnated you seemingly, entranced by your pregnant body, her face bright, happier then you have ever seen her. ");
