 ...
 */
	...
	export class CockatriceScene extends BaseContent {
		public  CockatriceScene(pregnancyProgression:PregnancyProgression, output:GuiOutput) {
		...
		private  cockatriceRideHimVag(): void {
			//spriteSelect(75);
			clearOutput();
			credits.modContent = true;
			credits.authorText = "MissBlackthorne";
		...
		private  cockatriceRideHimAnal(): void {
			//spriteSelect(75);
			clearOutput();
			credits.modContent = true;
			credits.authorText = "MissBlackthorne";
		...
		private  cockatriceButtfuck(): void {
			//spriteSelect(75);
			clearOutput();
			credits.modContent = true;
			credits.authorText = "MissBlackthorne";
		...
		private  cockatriceOralCock(): void {
			//spriteSelect(75);
			clearOutput();
			credits.modContent = true;
			credits.authorText = "MissBlackthorne";
		...
		//Cockatrice gives the PC a blowjob
		private  cockatriceOralVag(): void {
			//spriteSelect(75);
			clearOutput();
			credits.modContent = true;
			credits.authorText = "MissBlackthorne";
		...
		private  cockatriceTaurButtFuck(): void {
			//spriteSelect(75);
			clearOutput();
			credits.authorText = "MissBlackthorne";
		...
		private  cockatriceDriderButtFuck(): void {
		const  CHOICE_PUSSY: number = 1;
		const  CHOICE_COCK: number  = 2;
		var  choice: number;
		...
		private  rideCockatriceForeplay(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "MissBlackthorne";
		const  FOREPLAY_NEUTRAL: number = 0;
		const  FOREPLAY_BLOWJOB: number = 1;
		const  FOREPLAY_VAGINAL: number = 2;
		...
		public  cockatriceLossAnal(): void {
			clearOutput();
			credits.authorText = "MissBlackthorne";
		...
		//Player lost -> Vag sex
		public  cockatriceLossVaginal(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "MissBlackthorne";
			outputText("You fall to the ground [if (hp <= 1)utterly exhausted|too aroused to continue]. "
		...
		public  cockatriceLossOral(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "MissBlackthorne";
			outputText("You fall to the ground [if (hp <= 1)utterly exhausted|too aroused to continue]. "
