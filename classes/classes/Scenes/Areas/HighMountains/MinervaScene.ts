	...
	export class MinervaScene extends BaseContent implements TimeAwareInterface {

		public  pregnancy:PregnancyStore;
		
		public  MinervaScene(pregnancyProgression:PregnancyProgression, output:GuiOutput) {
...
//-Tainted Minerva anal capacity: 100
	public  minervaVCapacity(): number {
		return 90;
	}
	public  minervaACapacity(): number {
		return 100;
	}
	public  minervaSprite(): void {
	...
	public  minervaRomanced(): boolean {
		return (flags[kFLAGS.MINERVA_LOVE] == 1);
	}

	public  minervaSparIntensity(): number {
	var  amount: number = Math.max(0, flags[kFLAGS.MINERVA_SPAR_VICTORIES]);
		if (amount > 100) amount = 100; //Hard capped at 100. She'll be level 31!
		return amount;
	}
	
	public  minervaPurification:MinervaPurification = new MinervaPurification;
	public  minervaCorruption:MinervaCorruption = new MinervaCorruption;
...
//http://i46.tinypic.com/20z1f1x.jpg
		...
		public  tryToImpregnateMinerva(): void {
...
public  repeatEncounterMinerva(): void {
	clearOutput();
	credits.authorText = "Kinathis";
	minervaSprite();
...
public  fightMinerva(): void {
	startCombat(new Minerva(),true);
	minervaSprite();
	playerMenu();
}

public  genericMenu(display: boolean = false): void {
	menu();
	credits.authorText = "Kinathis";
...
//3-6 Bath Time - romance only
public  bathTimeTalkWithMinerva(): void {
	clearOutput();
	minervaSprite();
...
public  eatSomethingYouCunt(): void {
	clearOutput();
	minervaSprite();
