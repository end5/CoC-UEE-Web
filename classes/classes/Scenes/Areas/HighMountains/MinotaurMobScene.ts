	...
	export class MinotaurMobScene extends BaseContent implements TimeAwareInterface {
		...
		public  MinotaurMobScene() { CoC.timeAwareClassAdd(this); }
...
private  analSpearSemiPregMinotaurGangbang(): void { //SEMI PREG [> 120 && <= 216]
	spriteSelect(SpriteDb.s_minotaurSons);
...
private  minotaurGangBadEnd(): void { //Bad End Scene:
	clearOutput();
	spriteSelect(SpriteDb.s_minotaurSons);
...
private  minotaurGangBadEndPart2A(): void { //part2-1
	clearOutput();
...
private  minotaurGangBadEndPart2B(): void { //part2-2
	clearOutput();
...
private  minotaurGangBadEndPart3A(): void { //part3-1
	clearOutput();
	spriteSelect(SpriteDb.s_minotaurSons);
...
private  minotaurGangBadEndPart3B(): void { //part3-2
	clearOutput();
