...
private  giveCumToLynnette(type: number): void {
...
private  growBeard(mode: number = 0): void {
	clearOutput();
...
private  chooseBeardStyleFinalize(choiceStyle: number = 0): void {
	clearOutput();
