...
export class Essrayle extends BaseContent {
    ...
    public forestEncounterCondition(): boolean {
        return this.player.gender > 0 && (this.flags[kFLAGS.ESSY_MET_IN_DUNGEON] == 0 || this.flags[kFLAGS.TOLD_MOTHER_TO_RELEASE_ESSY] == 1);
    }
    public forestEncounter: Encounter = Encounters.build({
        name: "essrayle",
        call: this.essrayleMeetingI,
        when: this.forestEncounterCondition
    });

    public essrayleMeetingI(): void {
        this.clearOutput();
        this.outputText(this.images.showImage("essrayle-encounter"));
        ...
        // [Yes] [No]
        this.doYesNo(this.plantsForMe, this.noPlantsForMe);
    }
    ...
    private plantsForMe2(BE: number = 0): void {
        ...
        if (this.player.tail.type > Tail.NONE) this.outputText("tail, ");
        ...
        this.outputText(this.images.showImage("essrayle-discussion"));
    ...
    private acceptEssyPrizes(): void {
        ...
        this.outputText(this.images.showImage("essrayle-prize"));
    ...
    private yesGimmeGiantNipplesEssy(): void {
        this.clearOutput();
        this.outputText(this.images.showImage("item-pFruit"));
    ...
    public askMotherToReleaseEssy(): void {
        this.clearOutput();
        this.outputText(this.images.showImage("monster-sandmother"));
