...
export class ErlKingScene extends BaseContent implements Encounter {
	...
	public  encounterChance(): number { return flags[kFLAGS.ERLKING_DISABLED] == 0 ? 2 : 0; }
	public  execEncounter(): void {
		...
		var  baseVal: number = (player.inte + player.spe) - (player.fatigue - player.maxFatigue() + 100) * 2;
		//	trace("Base = " + baseVal);
			/*
