...
export class AkbalScene extends BaseContent implements Encounter {
    ...
    public akbalDefeated(hpVictory: boolean): void {
        ...
        if (hpVictory) // [General Victory]
        {
            ...
            this.clearOutput();
            this.outputText("Akbal falls to the ground in a beaten bloody heap.");
        } else // [Victory via Lust]
        {
            ...
            this.outputText("You walk around Akbal's lust crazed form with a smile on your face. The demon's growl continues as he awaits your judgment.");

            if (this.flags[kFLAGS.SFW_MODE] <= 0) {
                this.addDisabledButton(0, "Butt-fuck", "This scene requires you to have cock and sufficient arousal.");
                this.addDisabledButton(1, "Take Vaginally", "This scene requires you to have vagina and sufficient arousal.");
                this.addDisabledButton(2, "Force Lick", "This scene requires you to have vagina and sufficient arousal.");
                // Button 3 is used for Lusty Maidens Armor special scene and is hidden without it

                if (this.player.lust >= 33) {
                    if (this.player.hasCock())
                        this.addButton(0, "Butt-fuck", this.rapeAkbal);
                    if (this.player.hasVagina()) {
                        this.addButton(1, "Take Vaginally", this.girlsRapeAkbal);
                        this.addButton(2, "Force Lick", this.rapeAkbalForcedFemaleOral);
                        if (this.player.biggestTitSize() >= 4 && this.player.armor instanceof LustyMaidensArmor)
                        this.addButton(3, "B.Titfuck", (this.player.armor as LustyMaidensArmor).lustyMaidenPaizuri);
                    }
    ...
    private rapeAkbalForcedFemaleOral(): void {
        ...
        if (this.player.isNaga()) {
            ...
            this.outputText("Your scent causes the growl ripping out of Akbal's chest to quiver.  You lay before him, reaching up to smash his furry lips into your " + this.player.vaginaDescript(0) + ".  The demon, unable to escape his debilitating arousal, begins to lap at your " + this.player.vaginaDescript(0) + ".  He shoves his face against your " + this.player.vaginaDescript(0) + " twisting his lips and drilling his tongue into you, mercilessly attacking your " + this.player.clitDescript() + " as you scream, howl and cringe in ecstasy.\n\n");

            this.outputText("He begins to lift up, probably to get into position above you and sake his lust, but you force his face back down into your " + this.player.vaginaDescript(0) + ".  After dropping a line about how he has to make your cum or get his head ripped off Akbal whines, obviously distressed at not being able to slip his aching member into your " + this.player.vaginaDescript(0) + ".\n\n");
        ...
        // Centaur RAPPUUUUU
            ...
            this.outputText("Akbal gives a muffled scream at first but soon he gets the message. His tongue slithers into your " + this.player.vaginaDescript(0) + ".  You lift yourself a little; well... you lean forward a bit to let the demon actually breath.  This proves to be the right choice as Akbal is ravenous for your " + this.player.vaginaDescript(0) + ".\n\n");

            this.outputText("He drills his TONGUE into you, mercilessly attacking your " + this.player.clitDescript() + " as you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get the weight of your body off of the rest of his face, but you grab his tender furry balls in your hand and he stops before you're forced to do something drastic.\n\n");

            this.outputText("After dropping a line about how he has to make you cum or get his head ripped off Akbal whines, obviously distressed at not being able to slip his aching member into your " + this.player.vaginaDescript(0) + ".\n\n");
        ...
        // Everybody else
            ...
            this.outputText("You roughly grab the scruff of the demon's neck and give a gut-crushing blow to his stomach, causing him to call out in pain.");
            ...
            this.outputText("Your scent causes Akbal's growling to quiver.  You lay down before him, grabbing his head and smashing his furry lips into your " + this.player.vaginaDescript(0) + ".  The demon, unable to escape his debilitating arousal, begins to lap at your " + this.player.vaginaDescript(0) + ".  He twists his lips and drills his tongue into you, mercilessly attacking your " + this.player.clitDescript() + ", and you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get into position above you, but you force his face back down into your " + this.player.vaginaDescript(0) + ".  After dropping a line about how he has to make your cum or get his head ripped off, Akbal whines, obviously distressed at not being able to slip his aching member into your " + this.player.vaginaDescript(0) + ".\n\n");
    ...
    private rapeAkbal(): void {
        ...
        if (this.player.lowerBody.type == LowerBody.NAGA) {
            ...
            if (this.player.totalCocks() > 0) {
                ...
                if (this.player.cocks[primary].cockLength <= 7) {
                    this.outputText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  First you poke it with your finger, causing Akbal to flinch at the sensation.  Taking your " + this.player.cockDescript(primary) + " in hand you shove in without hesitation or mercy.  The virginally-tight hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you're sawing your " + this.player.cockDescript(primary) + " in and out of the demon's virginally-tight hole, relishing in the way it quivers and squirms around your embedded " + this.player.cockDescript(primary) + ".\n\n");
                }
                // (Md Penis: 8-12 inches)
                else if (this.player.cocks[primary].cockLength <= 12) {
                    this.outputText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  A light tap of your finger causes the tiny hole to constrict in fear as Akbal's entire body flinches away from you.  You grab your " + this.player.cockDescript(primary) + " with a cruel smile.\n\n");

                    this.outputText("As you shove your " + this.player.cockDescript(primary) + " into his tight pucker you are not surprised to find your " + this.player.cockDescript(primary) + " barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n");

                    this.outputText("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + this.player.cockDescript(primary) + " in and out of his pucker with force as the demon cat's howls range from pained to pleased.\n\n");
                }
                // (Lg Penis: 13 inches and up)
                else {
                    this.outputText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  A short glance tells you your " + this.player.cockDescript(primary) + " won't fit... but since when has that stopped you from trying?\n\n");
                    ...
                    this.outputText("You twist Akbal's tail into your fist and laugh as a scared whimper rises out of the jaguar demon's throat.  You begin to push your huge cock in with one hand as your other pulls Akbal's tail.  The creature wines and howls as you invade its clenching sphincter, forcibly stretching its tight pink hole to a dangerous degree with your " + this.player.cockDescript(primary) + ".  All too soon you are halted, barely able to fit more than a foot of your huge cock into Akbal's virginally-tight hole.  Deciding that's good enough you pull out and push forward, meeting the same resistance as before.\n\n");
                ...
                // (transition)
                this.outputText("You rape the jaguar demon's tight hole with steadily mounting force, your " + this.player.hipDescript() + " smashing into his body with freight train force and causing him to cry out.  Despite this his 15 inch swollen sex organ pumps pre beneath him, letting you know that his pain is mixed with plenty of unwilling pleasure.\n\n");

                // (With Fertility/Lots of Jizz Perk)
                if (this.player.cumQ() > 1000) {
                    this.outputText("The crushing tightness of Akbal's quivering hole pushes you over the edge and with a titanic howl you begin hosing down his insides.  The jaguar demon erupts as well, his body convulsing in time with your still thrusting " + this.player.cockDescript(0) + ".\n\n");
        ...
        // Centaur RAPPUUUUU
            ...
            if (this.player.totalCocks() > 0) {
                ...
                // (Sm Penis: 7 inches or less)
                if (this.player.cocks[primary].cockLength <= 7) {
                    this.outputText("Akbal snarls pitifully as you shove him stomach down against a log.  Your " + this.player.cockDescript(primary) + " leaks at the thought of bringing this \"god\" down a notch .  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal's body jerks away in fear.\n\n");

                    this.outputText("You rear up, standing on hind legs for a moment before your front legs fall to the ground, Akbal's head between them with his hair tickling your belly.  You give a few experimental thrusts.  The first one causes your " + this.player.cockDescript(primary) + " to slide up Akbal's upturned cheeks, making him cringe.  The second one, however, catches.\n\n");

                    this.outputText("The virginally-tight hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you're sawing your " + this.player.cockDescript(primary) + " in and out of the demon's virginally-tight hole, relishing in the way it quivers and squirms around your embedded " + this.player.cockDescript(primary) + ".  The sounds coming from Akbal's throat are varied but include many unwillingly pleased groans.  He's obviously liking this more  than he's willing to admit.\n\n");
                }
                // (Md Penis: 8-12 inches)
                else if (this.player.cocks[primary].cockLength <= 12) {
                    this.outputText("Akbal snarls pitifully as you shove him stomach down against a log.  Your " + this.player.cockDescript(primary) + " leaks at the thought of bringing this \"god\" down a notch.  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal's body jerks away in fear.\n\n");
                    ...
                    this.outputText("As you shove your " + this.player.cockDescript(primary) + " forward into his virginally-tight pucker you are not surprised to find your " + this.player.cockDescript(primary) + " barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n");

                    this.outputText("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + this.player.cockDescript(primary) + " in and out of his pucker.  The demon cat's howls range from pained to pleased, obviously enjoying his butt rape more than he is willing to admit.\n\n");
                }
                // (Lg Penis: 13 inches and up)
                else {
                    this.outputText("Akbal snarls pitifully as you shove him stomach down against a log. Your " + this.player.cockDescript(primary) + " leaks at the thought of bringing this \"god\" down a notch .  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal's body jerks away in fear.  There's no way in hell your " + this.player.cockDescript(primary) + " can fit inside something so incredibly tight but... since when has that stopped you?\n\n");

                    this.outputText("You rear up, standing on hind legs for a moment before your front legs fall to the ground, Akbal's head between them with his hair tickling your belly.  You give a few experimental thrusts.  The first one causes your " + this.player.cockDescript(primary) + " to slide up Akbal's upturned cheeks, making him cringe.  The second one, however, catches.\n\n");

                    this.outputText("The demon wines and wraps his arms around your front legs, pulling himself away from the burning pressure of your " + this.player.cockDescript(primary) + ".  His voice breaks as you invade his clenching sphincter, forcibly stretching Akbal's tight pink hole to a dangerous degree.  All too soon you are halted, barely able to fit more than a foot of your huge cock into Akbal's virginally-tight hole.  Deciding that's good enough you pull out and push forward, meeting the same resistance as before.\n\n");
                ...
                // (With Fertility/Lots of Jizz Perk)
                if (this.player.cumQ() > 1000) {
                    this.outputText("The crushing tightness of Akbal's quivering hole pushes you over the edge and with a titanic howl you begin hosing down his insides.  Akbal's suddenly clenching sphincter lets you know he has reached his orgasm as well.  ");
                    this.outputText("You continue to slide your still swollen sex organ inside his quivering hole as you pump massive tons of liquid into the false god's stomach and bowels.  Beneath the two of you his belly begins to bulge as he is filled to a dangerous degree.  ");
        ...
        if (this.player.totalCocks() > 0) {
            ...
            if (this.player.cockArea(0) < 13) {
                this.outputText("You first poke it with your finger, causing Akbal to flinch at the sensation.  Taking your " + this.player.cockDescript(0) + " in hand, you shove it in without hesitation or mercy.  The virgin-like hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you're sawing your " + this.player.cockDescript(0) + " in and out of the demon's tight hole, relishing in the way it quivers and squirms around your embedded " + this.player.cockDescript(0) + ".\n\n");
            }
            // [Medium penis (8-12 inches)]
            else if (this.player.cockArea(0) < 25) {
                this.outputText("A light tap of your finger causes the tiny hole to constrict and Akbal's entire body flinches in fear.  You grab your " + this.player.cockDescript(0) + " with a cruel smile.  As you shove yourself into his tight pucker, you aren't surprised to find that your " + this.player.cockDescript(0) + " is barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n");
                this.outputText("After a dozen achingly slow thrusts, Akbal's asshole begins to loosen and you start sawing your " + this.player.cockDescript(0) + " in and out of his pucker with force. The demon cat's howls fluctuate between yelps of pain and moans of pleasure.\n\n");
            }
            // [Large penis (13 inches and up)]
            else {
                this.outputText("A single look tells you your " + this.player.cockDescript(0) + " won't fit... but since when has that stopped you from trying?  You slide a single finger against the virginally-tight hole and Akbal flinches. His already tight hole clamps shut in fear, as if doing so will somehow stop the inevitable intrusion.\n\n");
                this.outputText("You twist Akbal's tail into your fist and laugh as a scared whimper escapes from the jaguar demon's throat.  You begin to push your " + this.player.cockDescript(0) + " in with one hand as you pull Akbal's tail with the other.  The demon whines and howls as you invade his clenching sphincter, forcibly stretching the tight pink hole to a dangerous degree.  You are halted all too soon, barely able to fit more than a foot of your " + this.player.cockDescript(0) + " into Akbal's virginally-tight hole.  Deciding that's good enough, you pull out before pushing forward again, meeting the same resistance as before.\n\n");
                this.outputText("After what seems like hours of resistance and howling, Akbal's body shudders and his asshole relaxes from complete exhaustion.  Battling with your " + this.player.cockDescript(0) + " seems to have nearly made him pass out, and he no longer has the energy to resist you.  The jaguar demon's body flinches with your every thrust as you pound him raw – without lube, and without mercy.\n\n");
            }
            ...
            // [With Fertility/Lots of Jizz Perk]
            if (this.player.cumQ() > 1000) {
                this.outputText("You continue to slide your still-swollen " + this.player.cockDescript(0) + " inside his quivering hole as you pump massive tons of liquid into the false god's stomach and bowels.  Beneath the two of you, his belly begins to bulge as he is filled to a dangerous degree.\n\n");
    ...
    private girlsRapeAkbal(): void {
        ...
        if (this.player.isTaur()) {
            ...
            this.outputText("Keeping the vines holding his arms up in hand, you slowly turn around and lift your tail, allowing your sopping mare cunt to wink at Akbal");
            if (this.player.hasCock())
                this.outputText(" " + this.player.sMultiCockDesc() + " hanging beneath, twitching in anticipation");
            this.outputText(". With a smirk at the helpless Gods expense, you take a step back, lining up before pushing yourself against him roughly, shoving his barbed feline shaft deeply into you.");
        }
        // {If Pussy is <loose}
            ...
            if (this.player.str > 60)
                ...
                this.outputText("dragging him towards the nearest tree");
            ...
            // ({if Naga}
            if (this.player.isNaga())
                this.outputText("You curl the tip of your tail around his length, catching the barbs lightly on your scales and squeezing, coaxing a low yowl of pleasure which you hurriedly make use of, ");
            // {If Goo}
            else if (this.player.isGoo())
                this.outputText("You focus, extending a small part of your liquid-like body, enveloping his feline meat in yourself, careful to avoid the tip. The sensation of damp warmth around his feline member is too much, making him open his mouth in a silent moan which you hastily use, ");
            else
                this.outputText("Lifting up your " + this.player.leg() + ", you firmly place the sole of your foot against his barbed flesh, pressing it against his stomach, forcing the jaguar to let out a low moan which you quickly take advantage of, ");
        ...
        // {If Pussy >= Loose}
            ...
            this.outputText(", you figure you have a pretty good idea where a reliable source of lube could be. You grin as you grab the demon cat by the scruff of his neck, ");
            // ({If strength >60}
            if (this.player.str > 60)
                this.outputText("hauling him towards a tree like a newborn kitten");
            else
            ...
            if (this.player.cor < 33)
                this.outputText("In a brief moment of pity you reach down, stroking Akbal's strained balls as he suckles, feeling them quiver as he noisily slurps and drools.");
            else
                this.outputText("You smirk, grabbing his full sack almost roughly, shaking them as he stares at you with his emerald eyes, although with rage or lust you can't quite tell.");
            this.outputText("\n\n");

            this.outputText("Finally, you judge that he's done enough, allowing him to lift his head back up with a splutter, although considering the flowing pre around his tip and over his lips, the experience was hardly a painful one. He glares at you with his burning green eyes as you ");
            // ({if Player is naga}
            if (this.player.isNaga())
                this.outputText("rear up, supporting your weight on your own tail as your hands explore down below, finding your puffed up slit and slowly parting them with a pair of fingers, allowing your scent and dampness to coat the jaguar's snout.");
            else if (this.player.isGoo())
                this.outputText("reach out, your liquid-like body coating his legs and holding them open, your hands reaching down to play with your damp, open fuck hole, chuckling as he tries to feign disinterest despite the obvious throbbing of his sack.");
            else
                this.outputText(" begin to stand over him, spreading your legs to reveal your damp, open pussy, his expression turning comically from rage to confusion to one of sheer lust, the feline licking his lips despite his own flavor on them.");
            this.outputText("\n\n");
    ...
    private girlsRapeAkbalPart2(): void {
        ...
        if (this.player.isTaur()) {
            this.outputText("You moan deeply as the thick shaft spreads your lips wide, throbbing against your clit as the barbs shudder against your inner walls, pushing your rump firmly against his lower abdomen as you squirm, leaking over his waist");
            if (this.player.hasCock())
                this.outputText(", " + this.player.sMultiCockDesc() + " swinging back and forth, occasionally bumping into his bound legs");
            ...
            // ({If Corruption > 30}
            if (this.player.cor > 33)
                this.outputText("If you weren't so eager on using him to get off, you might have considered teasing him like that then leaving him bound to the tree.  ");
            ...
            if (this.player.hasCock())
                this.outputText(", while your cock slaps at your stomach, pre flying from the tip to coat your lower body and the earth below");
            this.outputText(". He buries himself deep over and over, his fat, swollen balls slapping against you, feeling oddly natural");
        ...
        // TOIGHT
            ...
            // -Page Turn-
            this.outputText("Judging the silky fur to be slick enough, you yank out the tail from his mouth, pulling it towards your " + this.player.vaginaDescript() + " lips, teasing your folds with the tip before guiding him in. Taking the hint, the feline squirms his tail, pushing into you as he lifts his hips up once more, purring lightly as he presses himself against your " + this.player.foot() + ".  His cock is already leaking pre from the tip.  You gasp loudly as his fur bristles inside you, his saliva making your womanhood quiver in need as you feel him slip deeper, coiling and twisting. Making sure not to neglect the feline, you");
            // ({If Naga}
            if (this.player.isNaga())
                this.outputText(" squeeze his meat tighter, moving your coils up and down his feline prick while using the very tip of your tail to tease and poke his urethra, coating it in his pre");
            // ({If Goo}
            else if (this.player.isGoo())
                this.outputText(" squirm and writhe over the base of his feline shaft, vibrating your liquid-like appendage like a living sex toy, causing his balls to jiggle slightly");
            // ({If Bipedal}
            else
                this.outputText(" press his shaft firmer against his stomach, slowly slipping the sole of your foot up and down his length, coaxing out small yowls and purrs of pleasure");
            this.outputText(" as silent payment for the pleasure he's flooding your pussy with.\n\n");

            this.outputText("Time seems to stretch as you stand there, pinning the god, once so proud and mighty, now just a mewling kitten devoted to your pleasure");
            // ({If Herm}
            if (this.player.hasCock())
                this.outputText(" while you stroke " + this.player.oMultiCockDesc() + " in time with his thrusts");
            ...
            this.outputText("The squirming of his tail becomes too much however, as a familiar pressure builds up down below. Increasing the pace upon which you please his shaft, you lower yourself, trying to push more of that skilled tail into you, ");
            // ({If Herm}
            if (this.player.gender == 3)
                this.outputText("stroking " + this.player.oMultiCockDesc() + " roughly, ");
            ...
            if (this.player.hasCock())
                this.outputText(" as " + this.player.sMultiCockDesc() + " offers up its bounty, spasming and adding to the mess");
            ...
            this.outputText("Your " + this.player.chestDesc() + " chest heaves as you struggle to gulp air, " + this.player.legs() + " quivering from the sheer power of the orgasm the cat's tail gave you.  ");
            // ({if cum volume > normal}
            if (this.player.cumQ() > 500)
                this.outputText("His entire waist is coated in your juices, the once proud cat sitting in a pool of your leavings, with a contented grin on his face, like the cat that caught the canary");
            // ({If cum volume low/normal}
            else
                this.outputText("He sits, dazed as your cum covers his groin, his meat still shiny from the torrent you dropped down upon it. Nevertheless, his face is twisted into a purr");
            this.outputText(" as he sags against the tree trunk, overwhelmed by the pleasure. With a satisfied grin of your own, you pick up your " + this.player.armorName + " and head out. Perhaps you should look out for the \"<i>God of Terrestrial fire</i>\" again sometime...");
        ...
        // Loose
            ...
            this.outputText("You groan loudly as Akbal's impressive shaft stretches your pussy wide, instantly thankful that you had the idea to lube him up beforehand. Your less-than-willing partner adds his own groan to yours, the twitching of his meat signalling that he's not quite to opposed to the idea as he makes out. Maybe he's got a thing about dominance, from either angle. Nevertheless, you continue to push down until your hips reach his with a light bump. The sensation of his immense cock filling you up causes you to shudder, before leaning into the demon, pressing your " + this.player.chestDesc() + " against his, revealing in his silky fur stroking multiple parts of your body all at once. The yowling male takes off, ducking his head to lick and nip at your " + this.player.nippleDescript(0) + "s");
            // ({If Lactating}
            if (this.player.biggestLactation() >= 1)
                this.outputText(", adding a purr of pleasant surprise as he locks his lips around one nipple, drawing out mouthfuls of your sweet milk before gulping it down.  The sheer taboo of feeding a demon your milk sends shivers down your spine");
            this.outputText(".\n\n");

            this.outputText("As you lift yourself off, your head begins to swim as his previously unnoticed barbs rake along your inner walls, tugging, catching and massaging from the inside as they start to vibrate, causing you to ");
            // ({if Naga}
            if (this.player.isNaga())
                this.outputText("wrap your coils around him and the tree, adding leverage to your plunges down");
            // ({If Goo}
            else if (this.player.isGoo())
                this.outputText("encase yourself around his hips and groin, your entire lower body writhing and squirming around his shaft");
            // ({If Bipedal}
            else
                this.outputText("lock your legs around his torso, bouncing upon him with greater force");
            this.outputText(".  As your mouth hangs open, the demon lunges forward, pressing his own snout against your " + this.player.faceDescript() + ". You can still taste the traces of his own pre on his lips and tongue, furthering your lust as you use his groin roughly, impaling yourself hard enough to leave bruises on the pair of you, while he uses his tail to ");
            // ({if herm}
            if (this.player.cockTotal() == 1)
                this.outputText("wrap around your own straining shaft, the fur enhancing the effects of his pumps");
            // ({If more than 1 cock}
            else if (this.player.cockTotal() > 1)
                this.outputText("wrap around each of your throbbing malehoods with difficulty, teasing them with his bristled fur");
            // ({If female}
            else
                this.outputText("stroke and tickle your ass and lower back");
            this.outputText(".\n\n");

            this.outputText("You're not sure how long you sit there, bouncing roughly on the feline demon's cock, his eyes clenched tightly shut as he revels in the feeling of your warm damp pussy and your " + this.player.buttDescript() + " grinding against his swollen sack. Eventually, his combined efforts of mouth, shaft and tail force you over the edge, your hungry pussy lips clenching tightly over him, rhythmically squeezing as you attempt to milk his shaft");
            // ({if Herm}
            if (this.player.hasCock())
                this.outputText(" as " + this.player.sMultiCockDesc() + "  twitches and strains, ready to blow");
            this.outputText(", and he certainly doesn't disappoint. With a roar loud enough to shake the trees, he erupts violently within your passage, his hot, steaming, fertile seed pouring into your depths");
            // ({if Herm}
            if (this.player.cockTotal() == 1)
                this.outputText(", setting your own malehood off in sympathy, squirting thick cream over his chest");
            else if (this.player.cockTotal() > 1)
                this.outputText(" setting each of your malenesses surging, splattering the feline with your seed");
    ...
    private loseToAckballllllz(): void {
        ...
        // Centaurs R SPECIALZ
            ...
            this.outputText("Suddenly Akbal roars as he reaches his climax. You feel his giant cock hosing down your insides, filling you with his corrupted demon seed as he rides out his orgasm. His hips never stop. You feel your own orgasm rising to the surface only to suddenly fizzle out and you realize the corrupted seed inside you is actually stopping you from reaching climax. Akbal, however, sprays his spunk into your " + this.player.assholeDescript() + " again and again and never slows for a moment. Soon your stomach is obscenely swollen and you even taste cat jizz in your throat. Yet Akbal just keeps going, brutally fucking your helpless body and denying you release.\n\n");

            this.outputText("After hours of being his toy you pass out, never having reached your own orgasm.");
            this.dynStats("lust+", 10 + this.player.lib / 10, "cor+", 5 + rand(10));
            return;
            // Centaur over
        }
        if (this.player.ass.analLooseness < 3) // [Small/virgin pucker]
        {
            this.outputText("Akbal begins to push into you, the barbs on his massive cockhead causing you to howl as your " + this.player.assholeDescript() + " is forcibly stretched.  His jaguar claws grab your shoulders, and he uses your body as leverage to force his demonic erection into you.\n\n");
            this.outputText("The strain from Akbal's shoving makes you feel like you're going to pass out, yet the pain from his spiked sex organ keeps you conscious. After a while, you realize he's not even fucking you with his entire length; his swollen member is slowly forcing less than half its massive length into your " + this.player.assholeDescript() + ".\n\n");
            this.outputText("After what seems like hours of Akbal's long cat dick being slowly forced into your " + this.player.assholeDescript() + ", your body finally gives out. You've become so exhausted from the strain that you can barely even lift your arms.  With a triumphant growl Akbal thrusts forward, his cockhead spikes burying themselves into you.  Without your resistance, they seem to vibrate inside you like twelve little beads, massaging your innards.  The sudden change makes you croon as you widen your " + this.player.legs() + ", suddenly desperate for more.");
        ...
        // [Gaping pucker]
            ...
            this.outputText("Akbal begins to push into you, the barbs on his massive cockhead causing you to wince.  He bottoms out near-instantly, and he looks up at you with a feral grin.  Akbal begins to pump his engorged sex organ in and out of your " + this.player.assholeDescript() + " with a steadily mounting force.  You release a groan as the barbs covering Akbal's long cat-dick start to vibrate and begin to feel more like humming sex beads than anything else.  You widen your " + this.player.legs() + " in response and Akbal snarls as he slams his hips into you, obviously happy that you're able to take his massive length.  The demon seems to forget that he's raping you; he starts giving your neck licks that send shivers throughout your entire body as he roughly fucks you into the forest floor.");
        }
        this.player.buttChange(new Akbal().cockArea(0), true);
        this.outputText("\n\n");

        this.outputText("Akbal's embedded cock begins to hum inside you, causing you to cry out as he picks up the pace.  His every thrust is a hammer-like thump against your spread " + this.player.legs() + ".  Suddenly his thrusts become sloppy, and you feel his giant tool swelling inside you, stretching you out even more.  Akbal roars as he reaches his climax, and you feel his giant cock hosing down your insides, filling you with his corrupted demon seed as he rides out his orgasm.  His hips never stop.  You feel your own orgasm rising to the surface, only to suddenly fizzle out.  It is with horror that you realize that the corrupted seed inside you is actually stopping you from reaching climax.  Akbal, however, sprays his spunk into your " + this.player.assholeDescript() + " again and again, not slowing for even a moment.  Soon your stomach is obscenely swollen, and you even taste cat jizz in your throat.  Yet Akbal just keeps going, brutally fucking you into the ground.\n\n");

        this.outputText("After hours of being his toy you finally pass out, never having reached your own orgasm.");
        this.dynStats("lust+", 10 + this.player.lib / 10, "cor+", 5 + rand(10));
    }
    ...
    public execEncounter(): void {
        this.spriteSelect(SpriteDb.s_akbal);
        ...
        this.outputText("The aura pouring forth from this 'Akbal' is anything but god-like; you recognize the demon for what it truly is.  Yet its ivory teeth and sharp claws prove to you that it can make good on its threat.  What do you do?");
        // Talk / Fight / Run
        this.menu();
        this.addButton(0, "Talk", this.superAkbalioTalk);
        this.addButton(1, "Fight", this.startuAkabalFightomon);
    ...
    private superAkbalioTalk(): void {
        ...
        // Submit / Fight
        this.menu();
        this.addButton(0, "Fight", this.startuAkabalFightomon);
        this.addButton(1, "Submit", this.akbalSubmit);
    }
    ...
    private repeatAkbalPostSubmission(): void {
        ...
        // Submit / Deny / Fight
        this.menu();
        this.addButton(0, "Submit", this.akbalSubmit);
        this.addButton(1, "Deny", this.akbalDeny);
        this.addButton(4, "Fight", this.startuAkabalFightomon);
    }
    ...
    private akbalDeny(): void {
        ...
        this.outputText("Knowing he's found a new toy, Akbal allows you to leave unmolested.");
    ...
    private ackbalRepeatAfterWin(): void {
        this.spriteSelect(SpriteDb.s_akbal);
        this.clearOutput();
        this.outputText("As you walk through the forest, you hear a snarl and look up just in time to dodge a surprise attack by the jaguar demon, Akbal.  Your ");
        if (this.player.isTaur())
            this.outputText("four-legged leap places you a good distance away from him.  Do you fight or flee?\n\n");
        else
    ...
    private startuAkabalFightomon(): void {
        this.spriteSelect(SpriteDb.s_akbal);
        this.clearOutput();
        this.outputText("You ready your " + this.player.weaponName + " and prepare to battle the demon jaguar.");
        // [battle ensues]
    ...
    private akbalSubmit(): void {
        ...
        // Big booty special
        if (this.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] > 5 && this.flags[kFLAGS.PLAYER_RESISTED_AKBAL] < 2 && this.player.butt.rating >= 13 && this.player.tone < 80) {
        ...
        if (this.player.lowerBody.type == LowerBody.NAGA) {
            ...
            this.outputText("Akbal pushes you face first into the ground and places his forward paws on your back, pinning your chest against the ground. He removes the paw and you attempt to reposition yourself only to have your body pushed back down, a silent command for you to stay in this position.  You can't help but squirm a little as your bottom half is bunched up under your abdomen, putting your " + this.player.buttDescript() + " in the air.\n\n");

            this.outputText("His paws slide to your waist, melting into hands along the way. You look from beneath your arm and watch as Akbal's body changes, becoming more humanoid.  Once his transformation is complete he gets on his knees behind you and roughly pulls your upturned bottom half back.  When he shoves his face into your " + this.player.buttDescript() + " you flinch at the sudden and inexplicably erotic feeling.\n\n");

            this.outputText("He works his slippery wet tongue into your " + this.player.assholeDescript() + ", greedily lapping at your exposed backside as if it were a quickly-melting ice cream cone. The sensation causes you to groan as you push back against the tongue, suddenly lost in ecstasy. A part of your long tail wraps around his waist, holding him there as you revel in the sensation of being rimmed by a pro.  You even arch your back, allowing his long, thick jaguar tongue to penetrate deeper into your " + this.player.assholeDescript() + ". You feel his saliva, thick and warm like melted candy, sliding inside of you and coating your insides.\n\n");
            ...
            // (Small/Virgin Pucker)
            if (this.player.ass.analLooseness < 3) {
                this.outputText("You feel him poking around your " + this.player.assholeDescript() + " and quickly realize his member is not only insanely large but its head is covered in a dozen tiny barbs. You grit your teeth, expecting pain and yet, thanks to the weird saliva he slathered your innards with, there is none as his gargantuan member forcibly widens your " + this.player.assholeDescript() + ".\n\n");
            ...
            // (Medium Pucker)
                ...
                this.outputText("You feel him poking around your " + this.player.assholeDescript() + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. Yet, thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your " + this.player.assholeDescript() + ".\n\n");

                this.outputText("Akbal's titanic member stretches your " + this.player.assholeDescript() + " and makes you groan beneath him, reveling in the slick heat and fullness of your bowels. His saliva heats up, creating a steamy,pleasurable warmth inside your body. As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes. Your body begins to act of its own accord, your " + this.player.buttDescript() + " grinding against his thrusts as his large sex pump slides in with his trunk slamming into your " + this.player.buttDescript() + " in rhythmic, echoing claps.");
            }
            // (Gapping Pucker - Akbal's dick = 15 inches)
            else {
                this.outputText("You feel him poking around your " + this.player.assholeDescript() + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. When Akbal begins to penetrate you he is surprised when his trunk suddenly slams into your " + this.player.buttDescript() + ", the sudden invasion causing you to croon.\n\n");

                this.outputText("The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating. The sensation of the vibrating barbs is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you. Akbal wastes no time and begins forcibly fucking your " + this.player.assholeDescript() + " with reckless abandon, his every brutal thrust causing your body to slide forward through the dirt. You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.");
            }
            this.player.buttChange(this.monster.cockArea(0), true);
            this.outputText("\n\n");

            // (ending)
            this.outputText("Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your " + this.player.assholeDescript() + ". Your voice rises and falls with his frantic thrusts. Your body is racked by orgasm after orgasm and soon you're lying on your chest and knees in a pool of your own love juices.\n\n");
            ...
            this.outputText("The jaguar demon no longer seems to mind your presence in his territory as he drapes his tired body over yours and the two of you fall into a sex-induced coma.");
            // [+ 4-12 Corruption]
            this.dynStats("cor", 4 + rand(8));
            // [+ 1-2 Speed]
            this.dynStats("spe", 1 + rand(2));
            this.player.orgasm('Anal');
            // [Chance of butt growth]
            if (this.player.butt.rating < 8) {
                this.outputText("\n\nIn your sleep, your ass plumps up slightly, growing to accommodate the demon's wishes...");
                this.player.butt.rating++;
            }
            this.player.createStatusEffect(StatusEffects.PostAkbalSubmission, 0, 0, 0, 0);
        ...
        if (this.player.isTaur()) {
            ...
            if (this.player.tail.type > Tail.NONE)
                this.outputText("  As he makes his way to your hind quarters he grabs you by the tail, pulling it up and out the way with a feral, jaguar grin.  His free hand slides a finger across your " + this.player.assholeDescript() + " making you paw the ground with your hooves.");

            // (No tail)
            else
                this.outputText("  As he makes his way to your hind quarters he grabs your " + this.player.buttDescript() + ", groping the mass of flesh with one hand and sliding a finger across your exposed " + this.player.assholeDescript() + ", making you paw the ground with your hooves.");
            this.outputText("\n\n");
            // (Transition)

            this.outputText("The jaguar demon begins pushing you forward with his powerful hips, his demon-cat-dick sliding up the crevice of your " + this.player.buttDescript() + ".  He steers you towards a tree, forcing you chest-first against the rough bark.\n\n");

            this.outputText("Looking back you watch Akbal bend low, losing sight of the jaguar demon as he disappears behind you.  For a moment you wonder what he's doing but soon you feel him shove his face into your " + this.player.buttDescript() + " with a snarl.  He begins working his slippery wet tongue into your " + this.player.assholeDescript() + ", greedily lapping at your exposed backside as if it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, suddenly lost in ecstasy.  You are surprised at the strength in the demon's neck as he smashes your body against the tree with nothing but his mouth.  You feel his saliva, thick and warm like melted candy, sliding inside of you and coating your insides.");
            // (If Player has Vagina)
            if (this.player.hasVagina())
                this.outputText("  Akbal slurps his way down to your " + this.player.vaginaDescript(0) + " twisting his face and drilling his tongue into you, mercilessly attacking your " + this.player.clitDescript() + " as you scream, howl, and cringe in ecstasy.  He then uses his lips to gently suck your " + this.player.clitDescript() + " into his mouth and twirl his tongue on it, making your grind your swollen sex against his jaguar lips.");
            // (If Player has balls)
            if (this.player.balls > 0)
                this.outputText("  Akbal slurps his way down to your " + this.player.sackDescript() + " where he slathers his thick, heated saliva over your orbs, making you groan as your sensitive " + this.player.ballsDescriptLight() + " are teased and gently juggled by Akbal's masterful tongue.  He sucks both orbs into his mouth.  The sensation sends your eyes to the back of your skull and makes your entire body shiver.");
            // (transition)
            ...
            // (Medium Pucker)
                ...
                this.outputText("You feel him poking around your " + this.player.assholeDescript() + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs.  Yet,  thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your " + this.player.assholeDescript() + ".\n\n");
                this.outputText("Akbal's titanic member stretches your " + this.player.assholeDescript() + " and makes you groan and claw at the tree he has you pressed against, reveling in the slick heat and fullness of your bowels.  His saliva heats up, creating a steamy yet pleasurable warmth inside your body.  As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes.  You lean back into his thrusts as his trunk begins slamming into your " + this.player.buttDescript() + " in rhythmic claps that echo throughout the forest.");
            }
            // (Gapping Pucker - Remember Akbal's dick is 15 inches)
            else {
                this.outputText("You feel him poking around your " + this.player.assholeDescript() + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs.  When Akbal begins to penetrate you he groans in surprise as his large dick sinks into your " + this.player.buttDescript() + " easily, the sudden invasion causing you to croon.\n\n");
                this.outputText("The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating.  The sensation is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you.  Akbal wastes no time and begins forcibly fucking your " + this.player.assholeDescript() + " with reckless abandon, his every brutal thrust causing the tree you're shoved up against to shake back and forth.  You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.");
            }
            this.player.buttChange(this.monster.cockArea(0), true);
            this.outputText("\n\n");

            // (ending)
            this.outputText("Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your " + this.player.assholeDescript() + ".  Your body is racked by orgasm after orgasm and soon the ground beneath your pawing hooves is covered in a thick layer of your own love juices.  Then Akbal releases a harsh growl and you feel the large feline member twitching and swelling inside you.  A growl sounds in your own chest as the hot, corrupted seed of the demon cat shoots into you.  The feeling of the hot, wet warmth being fucked deeper into you is so close to supreme bliss you can scarcely tell the difference.\n\n");

            this.outputText("After a few moments you realize Akbal isn't slowing down.  His piston pumping hips drive right through his orgasm and never stop slamming into your " + this.player.buttDescript() + ".  He continues until he's erupted no less than eight times, masterfully working your hole the entire time.\n\n");

            this.outputText("After his last massive eruption you feel the jaguar demon pull out, releasing even more of his copious load from your happy hole in an oddly satisfying cascade of thick white cream that rushes like a waterfall down your legs");
            if (this.player.totalCocks() > 0)
                this.outputText(" to join your own");
            this.outputText(".\n\n");

            this.outputText("You close your eyes, willingly falling into a sex induced sleep.");
            // [+ 4-12 Corruption]
            this.dynStats("cor", 4 + rand(8));
            // [+ 1-2 Speed]
            this.dynStats("spe", 1 + rand(2));
        ...
        this.outputText("He suddenly yanks your upturned bottom half toward himself and shoves his face into your " + this.player.buttDescript() + ".  His slippery wet tongue begins to work its way into your " + this.player.assholeDescript() + ", greedily lapping at your exposed backside as though it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, quickly losing yourself into ecstasy.  You spread your " + this.player.legs() + " and arch your back, allowing his long and thick jaguar tongue to drill deeper into your " + this.player.assholeDescript() + ".  You feel his thick and warm saliva sliding into you and coating your insides.\n\n");

        // [Player has a vagina]
        if (this.player.hasVagina()) {
            this.outputText("Akbal slurps his way down to your " + this.player.vaginaDescript(0) + ", twisting his face and drilling his tongue into you, mercilessly attacking your " + this.player.clitDescript() + " as you scream, howl and cringe from the stimulation.  He then gently sucks your " + this.player.clitDescript() + " into his mouth and twirls his tongue around it, making you grind your swollen sex against his jaguar lips.  ");
        }
        // [Player has balls]
        else if (this.player.balls > 0) {
            this.outputText("Akbal slurps his way down to your " + this.player.sackDescript() + ", slathering his heated saliva over your orbs and making you groan as your sensitive " + this.player.ballsDescriptLight() + " are teased and gently juggled by Akbal's masterful tongue.  Your body continually twitches with pleasure from the sensations.  ");
        }
        ...
        this.outputText("You feel him poking around your " + this.player.assholeDescript() + ", learning quickly that not only is his member insanely large, but its head is covered in dozens of tiny barbs.  ");
        // [Small/virgin pucker]
        if (this.player.ass.analLooseness < 3) {
            this.outputText("You grit your teeth, expecting pain. However, thanks to the weird saliva he slathered your innards with, you feel none as his gargantuan member forcibly widens your " + this.player.assholeDescript() + ".");
            this.player.buttChange(this.monster.cockArea(0), true);
            this.outputText("\n\n");
        ...
        // [Medium Pucker]
            ...
            this.outputText("Thanks to the weird saliva he slathered your innards with, you feel no pain as his gargantuan member forcibly widens your " + this.player.assholeDescript() + ".");
            this.player.buttChange(this.monster.cockArea(0), true);
            this.outputText("\n\n");

            this.outputText("Akbal's titanic member stretching your " + this.player.assholeDescript() + " makes you groan beneath him, reveling in the slick heat and the fullness of your bowels.  His saliva heats up, creating a steamy and pleasurable warmth inside your body.  As he begins to pump his huge member in and out of you, the barbs covering his head begin to vibrate.  Your body is hit with waves of unbearable pleasure, the wicked-looking barbs acting more like humming sex beads than barbs.  Your body begins to act of its own accord; your " + this.player.buttDescript() + " grinds against his thrusts as his large sex slides in, his trunk slamming into your " + this.player.buttDescript() + " with rhythmic claps that echo throughout the forest.\n\n");
        }
        // [Gapping Pucker - Remember Akbal's dick is 15 inches]
        else {
            this.outputText("As Akbal begins to penetrate you, he groans in surprise at how easily his large dick sinks into your " + this.player.buttDescript() + ", and the sudden invasion causes you to croon.\n\n");

            this.outputText("The weird spit he slathered your insides with instantly heats up, and the barbs covering his cock head suddenly start vibrating.  The vibrating barbs feel like slimy sex beads, spinning and shaking as they are pushed inside you.  Akbal wastes no time and begins forcibly fucking your " + this.player.assholeDescript() + " with reckless abandon, his every brutal thrust causing your body to slide forward through the dirt.  You try to meet his deep thrusts, but the jaguar is fucking you with speed and force befitting a cheetah. The constantly vibrating barbs make your body shiver with each hammering blow to your insides.\n\n");
        }

        this.outputText("Akbal works his hips fast, piston-pumping his long demon cat-dick in and out of your " + this.player.assholeDescript() + ".  The rampant babbling coming from your mouth breaks with his every thrust, and your body is racked by orgasm after orgasm. You're soon on your chest and knees ");
        if (this.player.hasVagina() || this.player.totalCocks() > 0)
            this.outputText("in a pool of your own love juices");
        else
            this.outputText("in sexual bliss");
        this.outputText(".\n\n");
        ...
        this.outputText("After the sensation begins to settle, you realize Akbal isn't slowing down.  His hips carry on with their pistoning right through his orgasm and continually slam into your " + this.player.buttDescript() + ".  He persists until he's erupted no less than eight times, masterfully working your hole the entire time.\n\n");
        ...
        this.outputText("The jaguar demon no longer seems to mind your presence in his territory as he drapes his body over yours, and the two of you fall into a sex-induced sleep.");
    ...
    public akbalSubmissionFollowup(): void {
        ...
        if (this.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] < 4) {
            this.outputText("You awake in your camp feeling dangerous, powerful and fiercely satisfied.");
        }
        ...
        else if (this.flags[kFLAGS.AKBAL_SUBMISSION_COUNTER] >= 8 && this.player.isCorruptEnough(80)) {
            if (!this.player.hasPerk(PerkLib.FireLord)) {
        ...
        // [After 4th submission if corruption is greater than 40%]
        else if (!this.player.hasPerk(PerkLib.Whispered) && this.player.isCorruptEnough(40)) {
            ...
            this.outputText("You awake in your camp feeling dangerous, powerful and fiercely satisfied.");
        if (this.player.hasPerk(PerkLib.Whispered) && this.player.hasPerk(PerkLib.FireLord)) {
            this.awardAchievement("Allahu Akbal", kACHIEVEMENTS.GENERAL_ALLAHU_AKBAL, true, true, false);
        }
    ...
    private akbitchEncounter(): void {
        ...
        if ((!this.player.isCorruptEnough(40) && this.player.findPerk(PerkLib.Pervert) < 0 && this.player.findPerk(PerkLib.Sadist) < 0) || this.player.lust < 33)
    ...
    public takeAdvantageOfAkbitch(): void {
        ...
        this.addDisabledButton(0, "Fuck Him", "This scene requires you to have cock.");
        // 1 - normal ride is always available
        this.addDisabledButton(1, "Str.Fuck", "This scene requires you to have cock and superior strength.");
        this.addDisabledButton(6, "Str.Ride", "This scene requires you to have superior strength.");
        this.addDisabledButton(2, "Spd.Fuck", "This scene requires you to have cock and superior speed.");
        this.addDisabledButton(7, "Spd.Ride", "This scene requires you to have superior speed.");
        this.addDisabledButton(3, "Tou.Fuck", "This scene requires you to have cock and superior toughness.");
        this.addDisabledButton(8, "Tou.Ride", "This scene requires you to have superior toughness.");

        if (this.player.hasCock())
            this.addButton(0, "Fuck Him", this.buttFuckbuttFuckbuttFuckAkbal);
        this.addButton(5, "Ride Him", this.topAkbitchFromDaBottom);

        // AMB Strength Scene
        // 70+
        if (this.player.str >= 70) {
            if (this.pc.hasCock())
                this.addButton(1, "Str.Fuck", this.akbitchHighStrengthVariant, 0, undefined, undefined, "Forcefully fuck him with your cock.");
            this.addButton(6, "Str.Ride", this.akbitchHighStrengthVariant, 1, undefined, undefined, "Forcefully ride his cock.");
        }
        // AMB Speed Scene
        // 70
        if (this.player.spe >= 70) {
            if (this.pc.hasCock())
                this.addButton(2, "Spd.Fuck", this.akbalBitchSpeed, 0, undefined, undefined, "Intensely fuck him with your cock.");
            this.addButton(7, "Spd.Ride", this.akbalBitchSpeed, 1, undefined, undefined, "Intensely ride his cock.");
        }
        // AMB Toughness Scene
        // 70
        if (this.player.tou >= 70) {
            if (this.pc.hasCock())
                this.addButton(3, "Tou.Fuck", this.akbitchToughness, 0, undefined, undefined, "Thoroughfully fuck him with your cock.");
            this.addButton(8, "Tou.Ride", this.akbitchToughness, 1, undefined, undefined, "Thoroughfully ride his cock.");
        }
    }
    ...
    private topAkbitchFromBottomDuex(): void {
        ...
        this.outputText("\n\nYou look back at your new bitch with a grin while he regains his senses.  As you leave the forest, you hear a promise from Akbal’s chorus of voices, \"<i>You will regret this... Champion.</i>\"");
        this.player.orgasm(analOrgasm ? 'Anal' : 'Vaginal');
        this.dynStats("cor", 3);
        if (this.player.hasVagina())
            this.player.knockUp(PregnancyStore.PREGNANCY_IMP, PregnancyStore.INCUBATION_IMP, 101);
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    // AMB Strength Scene
    // 70+
    private akbitchHighStrengthVariant(ride: boolean = false): void {
        this.clearOutput();
    ...
    // AMB Speed Scene
    // 70
    private akbalBitchSpeed(ride: boolean = false): void {
        this.clearOutput();
    ...
    // AMB Toughness Scene
    // 70
    private akbitchToughness(ride: boolean = false): void {
        this.clearOutput();
        // [if (toughness > 70)]
