 ...
 *
 */
export class PlantGirlScene extends BaseContent {
    // Help Wanted

    private x: number = 0; // FIXME this is a dummy to avoid compile errors due to copy-pasted code.
    private y: number = 0; // FIXME this is a dummy to avoid compile errors due to copy-pasted code.
    ...
    public encounterPlantWoman(): void {
        if (rand(2) == 0) {
            this.monster.createStatusEffect(StatusEffects.happy, 0, 0, 0, 0);
        }
        else if (rand(2) == 0) {
            this.monster.createStatusEffect(StatusEffects.horny, 0, 0, 0, 0);
        }
        else {
            this.monster.createStatusEffect(StatusEffects.grouchy, 0, 0, 0, 0);
        }
        this.clearOutput();
        if (this.flags[kFLAGS.TIMES_MET_PLANTGIRL] == 0) {
            this.outputText("While out exploring the deep woods you come across a thick bush full of vines and thorns that is obstructing your path.  Strange...that wasn't there a few days ago.  You remember the perverted, sexual vegetation, but not this.  You scan the brush for a way to get through to no avail.  As you begin to turn, you hear an eerie, ominous coo which causes you to freeze, listening for further movement or noise.  After a few moments, you sigh and begin to head back the way you came... only to hit another patch of dense foliage, blocking your advance once again.");
            ...
            this.menu();
            this.addButton(0, "WaitAndSee", this.plantyLadySeeWhatHappens);
            this.addButton(1, "Struggle", this.plantWomanStruggle);
        }
        else {
    ...
    public plantyLadySeeWhatHappens(): void {
        this.clearOutput();
        this.outputText("You decide to not offer any resistance as the vines begin to tighten around your body.  When they have you nearly constricted, they stop suddenly.  Looking downward confirms the vines relaxing and slowly uncoiling from around your legs." + (this.player.cor >= 66 ? "  A sense of disappointment comes to you at the sight of the retreating vegetation, robbing you of potential fun." : "") + "  Standing there in utter confusion, you scratch the back of your head and survey the thick bush that now surrounds you, when a creature appears with a soft rustle to the left!");
        ...
        this.menu();
        this.addButton(0, "Let's Fuck!", this.plantLadyLetsFuck, 1.1);
        this.addButton(1, "Decline", this.declinePlantSmex);
        this.addButton(4, "Escape", this.plantWomanStruggle);
    }

    // [Let's fuck!]
    public plantLadyLetsFuck(from: number = 1.1): void {
        this.clearOutput();
        this.outputText("Throwing caution to the wind, you decide to engage in a little 'carnal' pleasure with this creature. How to do you want to sex the plant woman?");
        ...
        */
        ...
        if (from == 1.1) {
            ...
            this.addButton(0, "Dominant", undefined); // FIXME value was 9999
            this.addButton(1, "Submissive", undefined); // FIXME value was 9999
        }
    }
    ...
    public plantWomanStruggle(): void {
        ...
        if (this.player.str >= 40) {
            ...
            this.menu();
            this.addButton(0, "Sex", undefined); // FIXME value was 9999
            this.addButton(1, "Decline", this.declinePlantSmex);
            this.addButton(4, "Try to Run", undefined); // FIXME value was 9999
        }
        // (struggle: failure, or Intro 1.2.3) (< 40 STR)
        else {
            this.outputText("Despite your best efforts, you can't seem to break free from the vines as they tense around your limbs and then your waist.  You bite your lower lip and brace for whatever is coming to \"greet\" you.");
            // (leads to 1.2.3m)
    ...
    public sexFailureIntro(): void {
        ...
        this.menu();
        this.addButton(0, "Do It!", this.struggleFailDoItPlantSmex);
        this.addButton(1, "Decline", this.declinePlantSmex);
        this.addButton(2, "Get Lost", this.seriouslyGetLostPlantLady);
    }
    ...
    public declinePlantSmex(): void {
        ...
        if (this.monster.hasStatusEffect(StatusEffects.happy)) {
            ...
            this.monster.removeStatusEffect(StatusEffects.happy);
    ...
    public seriouslyGetLostPlantLady(): void {
        ...
        this.startCombat(this.monster); // TODO create PlantGirl
        this.monster.HP -= 20;
        if (this.player.horns.value > 0 && this.player.horns.type > Horns.NONE) this.monster.HP -= 15;
    ...
    public struggleFailDoItPlantSmex(): void {
        ...
        // IN ZE PC BUTT
        choices[choices.length] = this.plantRapingAssTrappedSexIntro;
        // GIVE HER A BJ
        choices[choices.length] = this.trappedFlowerSexBlowjob;
        // SHE RIDES UR DICK
        if (this.player.hasCock()) choices[choices.length] = this.trappedPlantSexPussy;
        // SHE BLOWS YA
        if (this.player.hasCock()) choices[choices.length] = this.trappedPlantSexWantsToBlowYa;
        // SHE WANTS UR DICK IN HER ASS
        if (this.player.hasCock()) choices[choices.length] = this.strugglePlantLadyFailAnal;
        // SHE WANTS 69 - ANY GENDER
        if (this.player.gender > 0) choices[choices.length] = this.failStruggle69;
        // SHE FUCKS YER CUNT, YA GIT
        if (this.player.hasVagina()) choices[choices.length] = this.struggleFailPlantFucksPussy;
    ...
    public escapeFromPlantWomanAndDeclineSex(): void {
        ...
        this.outputText("You stare at the plant woman and shake your head.  Sorry, you're not interested.  The plant woman continues to stare at you, uncertain of what you are saying.  You gesture to the monster that ");
        if (this.player.cor < 50) this.outputText("you are taking your leave and don't wish for any trouble.");
        else this.outputText("following or attacking would be a bad idea.");
        // (Connects to failure to persuade)
        // (Success, SD 1.1s)
        if (9999 == 9999) {
            this.outputText("\n\nThe monster, from what you can tell, deliberates your gesture of ");
            if (this.player.cor < 50) this.outputText("walking away");
            else this.outputText("intimidation");
            this.outputText(" and shrugs.  She promptly flees back into the woods.  You are left wondering just how messed up the local fauna and wildlife in Mareth is before promptly returning to camp.");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        // Failure to persuade/intimidate (SD 1.1f)
        else {
            this.outputText("\n\nThe plant monster scowls at you when you attempt to leave.  You try to ");
            if (this.player.cor < 50) this.outputText("calm her down");
            else this.outputText("remind her that attacking you will earn her a world of pain");
            this.outputText(", but she isn't buying any of it.  You ");
            if (this.player.cor < 50) this.outputText("shrug and turn you back, beginning the long trek back towards camp");
            else this.outputText("take a step forward and ready your weapon");
            this.outputText("; she responds by attempting to whip you with one of her vine appendages, causing you to ");
            if (!this.player.isTaur()) this.outputText("leap");
            else this.outputText("gallop");
            this.outputText(" out of the way.  She's misses, but it's obvious she will not take no for an answer. Looks like you have a fight on your hands...");
            // (leads to Fight 1.0]
            this.startCombat(this.monster); // TODO create PlantGirl
            this.doNext(undefined); // FIXME was 1
        }
    }
    ...
    public fuckMyAssPlantLadyWhileImTrapped(): void {
        this.clearOutput();
        this.outputText("You look up into the plant girl's eyes and smile, signalling that you're ready for what she has in mind.  She returns your lustful leer and presses her lips against yours, tongues once again darting around in search of each other as the plant girl reaches down to both your chest and ");
        if (this.player.hasCock()) this.outputText(Appearance.multiCockDescriptLight(this.player));
        if (this.player.gender == 3) this.outputText(" and ");
        if (this.player.hasVagina()) this.outputText(this.player.clitDescript());
        this.outputText(", and begins to caress and ");
        if (this.player.hasCock()) this.outputText("stroke");
        else this.outputText("finger");
        this.outputText(" you.");

        this.outputText("\n\nAs she takes ");
        if (this.player.hasCock()) this.outputText("[oneCock]");
        else if (this.player.hasVagina()) this.outputText("your " + this.player.clitDescript());
        this.outputText(" into her hand, you can feel her slip her plant-like penis into your [butt].  A loud series of deep moans escape from you both as your arm reach around and cradles her head in close, desiring the warmth of her body against yours as she presses on into your rump. With a moan, she pushes past your [asshole] and enters your rectum, causing a small cry of pain to stumble out of your mouth as she begins to push deeper and deeper into you; luckily she's considerate enough to not injure you");
        // PC asshole is virgin, tight, or loose:
        if (this.player.analCapacity() < 25) this.outputText(", but the bulbous member sliding inside of you hurts nevertheless");
        this.outputText(".");
        ...
        if (this.player.analCapacity() < 20) this.outputText("  You moan again from the pain and clamp down, causing your captor to shudder from the sensation of your [asshole]'s tightness.  Once the floral creature regains her composure, she begins to pump in and out of your ass at a gradually faster pace.");
        // PC asshole is loose:
        else if (this.player.analCapacity() < 60) this.outputText("  Her bulbous cock works its way into your [asshole] with some difficulty, but as it continues you feel the walls of your anus fit snugly around her, causing her to shudder from the sensation.  The vibrations from her trembling can be felt in your ass, traveling through your pelvis and into the rest of your body...  Once the plant woman regains her composure, she begins to pump in and out of your ass at a gradually faster pace.");
        // PC asshole is gaping: Her member slides in with no resistance whatsoever.
        else this.outputText("  You can hear her hiss in frustration at how loose your anus is.  You can hear her breathing stop momentary, and before you can react, her plant-like cock proceeds to expand inside of you.  It gradually grows in size and girth until resting snugly inside of your anus... or so it would seem.  The now incredibly thick prick inside of you doesn't relent in its growth, continuing to expand as it starts to painfully stretch you even further than you already are.  Gritting your teeth, you whine loudly and demand that her efforts stop.  Your wishes are heeded, but it seems the plant woman wants to let you know that she isn't particularly pleased that you've been stretched out so loose.  With your \"punishment\" over, the plant creature starts her gyrations against you, her horse-cock length prick now tunneling its way into you.");
        ...
        if (this.player.shortestCockLength() < 48) {
            ...
            this.outputText(this.player.cockDescript(this.player.shortestCockIndex()) + " flap");
            if (this.player.balls > 0) this.outputText("s");
            this.outputText(" against your thighs as she fucks you harder and harder as her hand finds its way down to your prick");
            if (this.player.totalCocks() > 1) this.outputText("s");
            this.outputText(".  The creature twists and jerks at the head of your cock and works diligently to stimulate your rock hard " + this.player.multiCockDescriptLight() + ", intent on making you moan out for her.");
        }
        // PC has a vagina:
        ...
        // (if long tongued:
        if (this.player.tongue.type > Tongue.HUMAN) this.outputText("  In a cute but spiteful way, your tongue is pulled forcefully out of your mouth and into her lips as she pulls her head back; the plant woman doesn't get too far from your face before you run out of tongue to give.  This suits her just fine as she takes to sucking on your incredibly long tongue in a manner similar to fellatio.  Pursed on the bottom of yours, she darts her head back and forth along the length of it, edging further into her mouth as she nears closer and closer to your own.  Her dominance without question, she reaches your lips and slips her tongue in, sealing it in with a firm kiss.");
        // Not long tongued:
        else this.outputText("  Your tongue is viciously attacked by the sudden intrusion of her own.  However, you are more than happy to return the favor as you counter attack, swapping each other's saliva in the process.");

        this.outputText("The feminine creature's hand then finds its way ");
        if (this.player.balls == 0) this.outputText("up");
        else this.outputText("down");
        this.outputText(" to your ");
        if (this.player.balls == 0) this.outputText(this.player.nippleDescript(0));
        else this.outputText("[balls]");
        this.outputText(", massaging and caressing them gently as she moves to kissing at your neck.  Her thrusts become shorter in length as her breathing becomes frantic, signaling that her orgasmic peak is near. The plant woman ");
        // PC has hair: (grabs you by the hair)
        if (this.player.hair.length > 0) this.outputText("grabs you by the hair");
        // PC doesn't have hair: embraces you)
        else this.outputText("embraces you");
    ...
    public trappedFlowerSexBlowjob(): void {
        this.clearOutput();
        this.outputText("The plant woman smiles at you and places your hand on her breast, and in turn places her hand on your chest.  You feel uneasy as the plant-like vines in her arms start wriggling around, and begin to envelope you.");
        // (//You're not sure what this act is supposed to mean exactly, but you hope that it doesn't involve impaling your heart.)
        this.outputText("  The vines that entrap you suddenly lower you to the ground and force you to your knees.  Eager to see what the plant girl has in store for you, you lick your lips and smile.  The plant girl returns your smile and pets the back of your head. Suddenly something begins to shake in her pelvis, and within seconds a cock bursts forth.  She coos playfully and tilts your head back, opening her mouth in what seems to be ecstasy.  Your eyes go wide as her cock bobs up and down, drooling golden, sappy pre-cum.  The sly look on her face conveys to you her belief that you both might enjoy this... but this IS a plant monster with a cock.  Maybe you should exercise caution?");
        // [Open wide (leads to TsI: 1.2a)]      [Put that thing away! (leads to TsI 1.2b)]

        this.addButton(0, "Open Wide", undefined); // FIXME was commented out simpleChoices with 9999
        this.addButton(1, "Put That Away", undefined); // FIXME was commented out simpleChoices with 9999
    }

    // (Failure blowjob: or TsI 1.2r)
    public trappedFlowerSexBlowjobRejection(): void {
        this.outputText("You push against the plant girl's thighs and shake your head, telling her that you are interested in THAT. You comment on how you wouldn't mind playing with something else though, as you begin to stroke your finger around the plant woman's labia.  She stops and ponders for a moment, and then giggles as her appendage disappears back into her body.");
        this.outputText("\n\nIt looks like it's up to you how you want to be sexed.");
        // (Taken back to tied sex menu)
        this.doNext(undefined); // FIXME was 9999 instead of undefined
    }

    // (Failure blowjob: I. Said. OPEN. WIDE!, or TsI: 1.2a)
    public trappedFlowerSexBlowjobAhoy(): void {
        this.clearOutput();
        this.outputText("\"<i>MHHMMpffffrmPH!</i>\ you mumble as her cock hits the back of your mouth, the plant creature clearly intent on jumping into the rougher sex sooner rather than later. The plant girl giggles as you struggle to breathe and not vomit from the violent intrusion. Placing both of her hands on the back of your head she begins to pump her hips, gliding her cock along your (tongue descript). You gasp for air as you try to push yourself off of the girl and get some room to breathe, but she has a pretty firm grip. She continues thrusting, but is increasingly annoyed that you aren't putting much effort into it right now.  A pair a vines ");
        // (If PC has balls:
        if (this.player.balls > 0) this.outputText("wrap themselves around your ([balls] and begin to squeeze");
        // (If PC has a cock(s):
        else if (this.player.hasCock()) this.outputText("wrap themselves around your " + this.player.multiCockDescriptLight() + " and begin to squeeze");
        // (If PC has a pussy:
        else if (this.player.hasVagina()) this.outputText("take hold of you player.clitDescript() and tug hard");
        // (If PC is genderless:
        else this.outputText("take hold of your [nipples], fiercely pulling on them to try and convince you to put some work into it");
        this.outputText(".");
    ...
    public trappedPlantSexPussyGOOO(): void {
        this.clearOutput();
        this.outputText("The vines around you begin to shift, and you fear that she might have misinterpreted your preferences for sex, gritting your teeth as you await the inevitable violation of your body.  The continuing sound of cracking vines and growth intrigues you enough to open your eyes, witnessing both yourself and the plant woman being lifted off of the ground by her cabal of creepers.  Lifting you further and further into the air, the vegetation draw her close to your restrained, naked body.  The floral beauty's petal like vagina is soaked in anticipation and glistening in the warm glow of the sun.");
        let cockIndex: number = this.player.cockThatFits(9999); // Undefined capacity for now.
        if (cockIndex < 0) cockIndex = this.player.smallestCockIndex();
        // (If  cock(s) are 4 inches or less)
        if (this.player.cocks[cockIndex].cockLength < 4) {
            this.outputText("\n\nThe plant woman goes to massage your " + this.player.cockDescript(cockIndex) + ", but stops when she sees how small you are.  Rather than dumping you on your ass, one of the vines that holds you wraps itself around [eachCock] and then proceeds to pierce the sensitive flesh of your glans with what you assume are barbs.  Unconsciously, you scream out in pain; it isn't the worst agony you have ever felt, but the sharp stinging that floods your sensitive member is enough to be a mood killer. In increasing agony, you gaze down at your " + this.player.multiCockDescriptLight() + " to witness your member");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" swelling up. The head");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" of your cock");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" swell");
            if (this.player.cockTotal() == 1) this.outputText("s");
            this.outputText(" to what seems to be double ");
            if (this.player.cockTotal() > 1) this.outputText("their ");
            else this.outputText("its ");
            this.outputText("original size, and your unsubstantial shaft");
            if (this.player.cockTotal() > 1) this.outputText("s gain");
            else this.outputText(" gain");
            this.outputText(" some length in the process.  Is this some kind of allergic reaction?  A chemical?  Some kind of hormone? Regardless of how this is done, your once insignificant penis");
            if (this.player.cockTotal() > 1) this.outputText("es are now ");
            else this.outputText(" is now ");
            this.outputText("of sufficient length to penetrate this creature; though, you suspect the effects are temporary.");
            // (cock size temporarily increased to 7 inches)
            this.player.cocks[cockIndex].cockLength += 7;
        }
        // (if > 4 inches)
        ...
        this.outputText("\n\nRaising herself ever so slightly, the plant woman wraps her legs around and straddles you as she lowers her pussy onto the tip of " + this.player.cockDescript(cockIndex) + ".  The female perversion of nature slowly takes the entirety of your cock in her, causing your prick to sensually ease through her tight cunt like a mole crawling through the fertile earth.  The sensation is too much, causing you to shudder and twitch uncontrollably.  Your dominant partner rests her ");
        // (If height is 36 inches to 72 inches:
        if (this.player.tallness < 72) this.outputText("raises her face to yours ");
        // If height is greater than 72 inches, but less than 96 inches:
        else if (this.player.tallness < 84) this.outputText("head against your [chest] ");
        // (If Height is less than 96 inches:
        else if (this.player.tallness < 96) this.outputText("forehead against your chest, sniffing you intensely as she takes in your musk.  The creature of flora and warped flesh moans and shivers as she acquires your " + this.player.mf("manly", "feminine") + " scent, and ");
        // (If height is greater than 96 inches:
        else this.outputText("places her head against your stomach, eyes closing as the creature takes in the rising and descent of your stomach ");
        this.outputText(" as she slowly begins to work her hips, grinding the innards of her hot and moist sex against your " + this.player.cockDescript(cockIndex) + ".");
        // (if one cock:
        if (this.player.cockTotal() == 1) this.outputText("  The plant creature begins to speed up her thrusting against your cock, eager to drive you over the edge with the tightness of her hole.");
        else {
            // (If multi-cocked:
        ...
        // (Multi-cocked:
        if (this.player.cockTotal() > 1) this.outputText("  Buried deep in the makeshift vaginas, [eachCock] thrusts forward and eagerly deposits the nourishment the creature craves.");
        // Vagina:
        if (this.player.hasVagina()) this.outputText("  Cumming hard, your " + this.player.clitDescript() + " releases a liberal stream of juices down the vine that fucks you, dissolving into the appendage as you moan in furious release.");
    ...
    public trappedPlantSexWantsToBlowYa(): void {
        this.clearOutput();
        this.outputText("The plant woman looks your body up and down, seemingly torn between what tickles her fancy and how she can take your body.  Her almost childlike darting of her eyes stops when she lays her sight on your player.multiCockDescriptLight(), sending an aroused shiver through her body as she appears to finalize her decision.  Like a child walking to the local stream for a swim, she proceeds towards you in an almost skipping like fashion.  Reaching your naked body, she promptly sinks to her knees and takes your " + this.player.multiCockDescriptLight() + " into her hand");
        // (if more than 4 cocks or PC cocks are more than 10 inches in diameter combined:
        if (this.player.cockTotal() >= 4 || this.player.totalCockThickness() >= 10) this.outputText("... or she tries to, as she fumbles with your freakish bundle of dicks.  Unable to fit them all into her hand she shrugs");
        this.outputText(", staring up at you with her leafy hair semi-obstructing her flirtatious and suggestive eyes.");
        // [Blow me! (leads to TsI: 1.4a)]        [Nope (leads to TsI: 1.4r)]
        this.menu();
        this.addButton(0, "Blow Me!", this.trappedPlantSexBlowMe);
        this.addButton(1, "Nope", this.trappedPlantSexDontBlowMe);
    }

    // [Nope, TsI: 1.4r]
    public trappedPlantSexDontBlowMe(): void {
        this.clearOutput();
        this.outputText("It may seem she wants to take your [oneCock] and suck on it like a sugar cane, but you aren't keen on her choice of how to pleasure you.  Remaining flaccid, you stare down at the plant woman and tell her you aren't interest in a little oral love for your " + this.player.multiCockDescriptLight() + ", aware of the fact that she can't understand you.  Despite your words likely sounding like jibberish, the plant woman understands your intent and motions for you to make up your mind; given the slightly annoyed expression on her face, you had better make it quick.");
    ...
    public trappedPlantSexBlowMe(): void {
        this.clearOutput();
        this.outputText("The thought of getting a blowjob from this rather attractive... um... plant lady excites you greatly, springing your flaccid maleness from it's slumber.  Before the plant woman's very eyes, [eachCock] expands like heated metal; only in a much more dramatic and erotic fashion.");
        // (if cock(s) are 3-24 inches:)
        if (this.player.longestCockLength() < 24) {
            this.outputText("  Now staring her straight in the eyes, your ");
            this.outputText(Appearance.multiCockDescriptLight(this.player) + " stare");
            if (this.player.cockTotal() == 1) this.outputText("s");
            this.outputText(" defiantly at the plant woman; erect in a such a fashion that suggests insult at the attractive creature before ");
            if (this.player.cockTotal() == 1) this.outputText("it");
            else this.outputText("them");
            this.outputText(" that will be tending to them today.  Eager to rise to said challenge, the plant woman attempts to take your " + this.player.multiCockDescriptLight() + " into her mouth and ");

            // (if cock(s) do not exceed 6 inches in total diameter:)
            if (this.player.totalCockThickness() < 6) {
                this.outputText(" manages to fit ");
                if (this.player.cockTotal() == 1) this.outputText("it");
                else this.outputText("them");
                this.outputText(" into her mouth with little difficulty");
                if (this.player.cockTotal() > 1) this.outputText(".  What a champ");
            }
            // if total cocks exceed 6 inches total diameter, but up to two cocks fall under 6 inches:
            else if (this.player.twoDickRadarSpecial(6)) {
                this.outputText(" manages to take two of your pricks into her mouth without dislocating a jaw or showing any obvious of discomfort");
            }
            else this.outputText(" manages to swallow your dick into her mouth");
            this.outputText(".");
            // (If cock count is more than two:
            if (this.player.cockTotal() > 2) {
                this.outputText("  The rest of your left out cocks ache for her touch; as she takes the two cocks she has further into her mouth, she raises her arms and attempts to take hold of your members, stroking them as best as she can as she works you with her mouth");
                // (cock(s) are 3-12 inches:
                if (this.player.cocks[this.player.thinnestCockIndex()].cockLength < 12) this.outputText(" against her face, while planting her hands against your thighs");
                // Cocks are 13-24 inches:
                else this.outputText(" in-between her shoulder and neck, using them both to form a tight hole for your other cocks to fuck");
                this.outputText(".");
            }
            // 		(jump to Continued... (“normal” dick sized oral) )
            // Continued... (“normal” dick sized sexing)
            this.outputText("With your member");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" inside of her mouth, she begins the long awaited sucking and stimulation; starting out slowly at first, she slides the top of her tongue along the bottom of your prick");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(", going so gradual that you believe she is savoring the taste of you in her mouth.  To your surprise, she pulls back and lets your cock");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" pop out of her maw, smacking and licking her lips as she grunts her approval like someone who has just enjoyed a fine meal.  Shaking her now intrusive hair out of the way of her eyes, she darts her head forward and takes your ");
            if (this.player.cockTotal() >= 2) this.outputText("two ");
            this.outputText("saliva covered member");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" into her mouth; with little regard for her gag reflex, she raises her hands on your ");
            if (this.player.cockTotal() >= 4) this.outputText("upper shafts");
            else if (this.player.cockTotal() >= 3) this.outputText("upper shaft");
            else this.outputText("[hips]");
            this.outputText(" as she better positions herself for the entirety of your ");
            this.outputText("cock");
            if (this.player.cockTotal() > 1) this.outputText("s as they make");
            else this.outputText(" as it makes");
            this.outputText(" contact with the back of her throat.  You feel a bit of pre-cum leak out from the tip");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" of your ");
            if (this.player.cockTotal() > 1) this.outputText("two ");
            this.outputText("dick");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" and ooze against the back of her throat, causing her to moan in delight as your sticky fluids coat her throat.");
            ...
            // If Goo legs:
                ...
                if (this.player.cockTotal() > 1) this.outputText("s");
                this.outputText(" as you assert a degree of control and influence on your pleasuring.  The sticky mess that is your body solicits a series of lustfully moans from the woman who tends to your loins with her mouth.");
            }
            this.outputText("\n\nBobbing her head back and forth against you, she sucks and roughs up your cock");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" with her energetic efforts");
            if (this.player.cockTotal() == 1) this.outputText(".");
            else {
                this.outputText(", while she cheek fucks the remainder of your " + this.player.multiCockDescriptLight() + ".");
            }
            ...
            if (this.player.balls > 0) {
                this.outputText(" and the base of your shaft");
                if (this.player.cockTotal() > 1) this.outputText("s");
            }
            this.outputText(", she squeezes with considerable force, almost as if she is attempting to bottle up pressure in your ");
            if (this.player.balls > 0) this.outputText("[sack]");
            else this.outputText("loins");
            this.outputText(" so that your creamy contents will explode forth into her craw.  Like a knotted up hose line, your cock");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" begin");
            if (this.player.cockTotal() == 1) this.outputText("s");
            this.outputText(" to ache due to the irritating discomfort in your shaft");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText("; you're unsure if you will be able to achieve orgasm with such a tense grip on your spear");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText("!  In a rhythmic fashion, the creature ascends your member");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" and promptly descends back downward, flooding your nerves with pleasure and a growing need to cum as she darts back and forth like a grounded raven chasing after a worm.");
            ...
            if (this.player.balls > 0) {
                this.outputText("balls and shaft");
                if (this.player.cockTotal() > 1) this.outputText("s");
            }
            else {
                this.outputText("shaft");
            ...
            this.outputText(" tightens considerably;  with gusto, she starts stroking the base of your shaft like a squeeze tube, eager to aid your sperm in their journey to her stomach as they unknowingly rush to their certain doom.  Bleat red, her face compresses against your loins as she takes load after load into her throat, moaning like a wanton harlot and swallowing every once in a while to ensure that there will be room for more splooge in her mouth.  Just when you think she is going to injure you with her fierce grip, she lets you go; and not a moment too soon it seems, judging from the redness in your ");
            if (this.player.balls > 0) this.outputText("scrotum's");
            else {
                if (this.player.cockTotal() == 1) this.outputText("cock's");
                else this.outputText("cocks'");
            }
            this.outputText(" skin.  Content with your 'donation', the plant woman releases your cock");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" from her mouth with a loud pop; leaving trails of drool and semen on her chin as she does so.  The vines holding you retract from around your limbs and allows you to suit up and leave, whilst she cradles her sated stomach and hums to herself.");
            this.player.orgasm('Generic');
        }
        else {
            // (If all cocks exceed 24 inches, and two to three cocks measure 6 inches in diameter or less total:
            this.outputText("  Despite having to position herself a considerable distance away from your body, the plant woman manages to take [oneCock] and fits it into her mouth.  Due to the distance between you two, the plant woman has to ");
            if (this.player.cockTotal() == 1) this.outputText("prop some of your length up on her average body to prevent it from straining towards the ground.");
            else this.outputText("prop your other dicks up with her average body to prevent them from hitting the dirt covered ground.  Obviously she has plans for them, and doesn't want her prize catches getting dirty.");
            // (jump to Continued... (huge dick sized oral)
            // 	Continued... (huge dick sized oral)
            // (All cocks exceed 4  inches in diameter individually:
            this.outputText("\n\nHaving to scoot back a fair bit to enjoy her catch, the plant woman kneels against the dirty ground and attempts to take your " + this.player.cockDescript(0) + " into her mouth.  You feel her attempt to fit your rod into her little mouth; teeth accidentally scraping along your head, the buckling of jaws, and soft lips that are rebutted are all the signs you need to understand that your " + this.player.multiCockDescriptLight());
            if (this.player.cockTotal() == 1) this.outputText("is");
            else this.outputText("are");
            this.outputText(" much too large to fit inside of her mouth.  Undeterred by your freakish large member");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(", the plant woman smothers her face against your " + this.player.cockDescript(0) + ", allowing your pre-cum to lather up her face well. Stopping to sheepishly grin up at you, you see that the plant woman has trails of pre-cum connecting between her face and the head of your dick.  Like a kitten with a ball of string, she chases after the strands of pre-cum and attempts to catch them in her mouth.  You grunt and cough at her childish display, to remind her of what she's SUPPOSED to be doing; odd, coming from someone who's trapped in a vine prison.  Embarrassed, the plant woman nods her head apologetically, and takes to your " + this.player.cockDescript(0) + " with ferocious effort, smearing her face along the head of your cock while dragging her tongue along it with wanton abandon.  You groan at the sensation, and tense up as your body is fluid with relaxing sexual chemicals, easing you up and getting you ready for the pleasure that follows.");
            ...
            this.outputText("\n\nWithout noticing, your orgasm arrives and launches forth from your " + this.player.multiCockDescriptLight() + ", with enough force to startle the plant woman as it slaps her across the face.  A series of passionate moans rise up from under your dicks as the creature is liberally covered in your steamy jism.  Her tongue now free from your urethra, you breathe a sigh of relief as you finally get to relax; the sensation of tickling gone from your body.  Closing your eyes, you can't help but slump to the ground, mentally drained as the plant woman lunges after your torrent of cum like an orphan to food. With the last shot of cum, the plant woman rises to get feet, ");
            if (this.player.cumQ() < 500) this.outputText("covered");
            else this.outputText("drenched");
            this.outputText(" in your salty seed as she grins like a fool; obviously dumbfounded at her sheer dumb luck to find  a virile specimen such as yourself. The vines holding you retract, allowing your drained body to slowly fall to the ground. Panting heavily, you lie stomach first against the ground and collect your composure as the plant woman walks up to you and strokes your back and hair. She stays at your side until you muster the will and energy to pull yourself to your feet; at which point she helps you to your [armor] and helps you to put it back on. With a smile, she sees you off as you head back to camp.  “Strange that she didn't leave you and let something else have fun with me”, you wonder in your head as you leave the deep woods.");
            this.player.orgasm('Generic');
        }
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    public plantAnalGivingTheDick(): void {
        this.clearOutput();
        this.outputText("The sight of this nice, ample ass and the thought of fucking a supple  little pucker piques your " + this.player.multiCockDescriptLight() + ", causing ");
        if (this.player.cockTotal() == 1) this.outputText("it");
        else this.outputText("them");
        this.outputText(" to become semi-erect.  As you reach her full ass, your prick");
        if (this.player.cockTotal() > 1) this.outputText("s poke");
        else this.outputText(" pokes");
        this.outputText(" at her soft behind, signaling to her that now is the time guide you into her tight pucker.  Slowly, she edges your cock against the tight opening of her asshole.  Realizing that the asshole ");
        if (this.player.cockTotal() == 1) this.outputText("it");
        else this.outputText("they");
        this.outputText(" will hopefully penetrate is a winner in the tightness department, your " + this.player.multiCockDescriptLight() + " surge");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" with vigor and anticipation.   The plant woman can barely contain her surprise as your dick");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" become");
        if (this.player.cockTotal() == 1) this.outputText("s");
        this.outputText(" rock hard and push");
        if (this.player.cockTotal() == 1) this.outputText("es");
        this.outputText(" against her butt hole, her hand shooting up her mouth to contain a giggle.  Looking back over her shoulder at you, she smirks as she pushes against your cock head");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(", easing ");
        if (this.player.cockTotal() == 1) this.outputText("it");
        else this.outputText("them");
        this.outputText(" into her tight pucker.  With a sudden and rough slide forward your cock");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" satisfyingly penetrate");
        if (this.player.cockTotal() == 1) this.outputText("s");
        this.outputText(" her anus, leading to a slight gasp as the plant woman takes you inside of her.");

        this.outputText("\n\nKeeping her comfort in mind, the plant creature stares at the trunk in front of her and takes her time as she gradually eases more and more of you inside of her hot innards.  You grunt as the walls of her ass painfully yield to your spear(s) of lust;  The rough stretching of her contours along your glans continuing until she loosens up, to where both of you can be comfortable with the act.  Throwing caution to the wind, the plant woman “tests the waters” by bounces her ass off of your thighs, eventually increasing in tempo as she adapts to the " + this.player.cockDescript(0) + " inside of her.  The initial throes of anal sex that your captor inflicts on herself begins to overwhelm your cock");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(", causing you to shudder in delicious pleasure as you moan loudly.");
        ...
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" as she weakly bounces against you, squeezing down on you with just the right amount of force that it drives you past the point of no return, unleashing a ");
        // Cum output low:
        if (this.player.cumQ() < 20) this.outputText("small amount of semen");
        else if (this.player.cumQ() < 250) this.outputText("generous amount of cum");
        else this.outputText("flood of sticky spunk");
        this.outputText(" from your cock");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" and into her tight asshole.");

        // (If there are free cocks:
        if (this.player.cockTotal() > 1) this.outputText("\n\nThe rest of your " + this.player.multiCockDescriptLight() + " erupt as well, coating her butt and thighs in sticky jizz.  Like a true slut, the plant woman grabs your ejaculating prick and crams it into her fuck-hole, her pussy milking you of all the cum you can muster up.");
        ...
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" from her body.  Surprisingly, no cum (yours or otherwise) leaks out of her love button... weird.  With your lust quenched, you decide to head back to camp and get back to... whatever you were doing.  As you put your [armor] back on, the plant woman slips in quietly and kisses you tenderly on the neck.  Smiling, you wave to the delicate plant woman and make for camp.");
    ...
    public failStruggle69(): void {
        ...
        this.outputText(" with her hands as she moves in for the 'kill'.");

        this.menu();
        // [No way!, leads to TsI: 1.6r]     [69!, eat her pussy, leads to TsI: 1.6a]    [69! give her oral, leads to TsI: 1.6a]
        this.addButton(0, "No Way!", this.nowayStruggle69Plant);
        this.addButton(2, "69 EatDick", this.struggle69Plant, 1);
        this.addButton(1, "69 EatPuss", this.struggle69Plant, 2);
        this.addButton(3, "69 EatAll", this.struggle69Plant, 3);
    }
    // [No way!, TsI. 1.6r]
    public nowayStruggle69Plant(): void {
        this.clearOutput();
        this.outputText("The dizzying sensation of being hung upside down like a hunter's catch in a tree is bad enough; the idea of this thing forcing her fuck hole against your face and licking your genitalia is more than enough for you to try and break free.  Thrashing around in the vine prison like a fly caught in a spider web, you try to show the plant woman that you are not okay with her choice in 'having fun' with you.  Your erratic and frenzied rejection dawns on the plant woman, and she pouts as she dejectedly flips you up right.  Her stare carries with it a plea for you to reconsider, but you ensure that you will not be swayed on this matter.  With a sad expression on her face, she stares down at the ground, lamenting your denial; raising an eyebrow, you call out the plant creature and assure her through your ");
        if (this.player.hasCock()) this.outputText(Appearance.multiCockDescriptLight(this.player));
        if (this.player.hasVagina()) this.outputText("[clit]");
        this.outputText(" that you still want to fool around.  Conveying your preference, you gesture to her that she should... ");
    ...
    public struggle69Plant(pt: number = 1): void {
        ...
        let target: number = 0;
        if (this.player.gender == 1) target = 1;
        if (this.player.gender == 2) target = 2;
        if (this.player.gender == 3) target = 1 + rand(2);

        if (pt == 1) { // [69!, TsI: 1.6a, eat her pussy]
            this.outputText("Abandoning yourself to the plant woman's desires, you proceed to stretch your tongue and take her sweet, drooling cock along it, allowing her pre to seep along your mouth muscle and ignite your taste buds with her excitement. All too happy that you've chosen the rock hard prick between her hips, the plant woman is eager to reciprocate");
            // PC pussy chosen:
            if (target == 2) this.outputText(" as she allows her soft lips to surround your [clit], 'trapping' it for her much anticipated assault.");
            // PC cock chosen:
            else this.outputText(" as she wastes no time with 'formalities,' stuffing your " + this.player.cockDescript(0) + " into her mouth, firmly sealing her lips around your shaft and suckling along the sensitive flesh of your glans.");
        }
        else if (pt == 2) { // [69!, TsI: 1.6a, give her oral]
            this.outputText("Abandoning yourself to the plant woman's desires, you proceed to stretch your tongue and take her sweet cunt, allowing her soft sex to drag across it.  The soft tongue of your lover against your ");
            if (target == 2) this.outputText("[clit]");
            else this.outputText("[cock]");
            this.outputText(" flushes your body with arousal as she teases you");

            // PC pussy chosen:
            if (target == 2) this.outputText(", allowing her soft lips to surround your " + this.player.clitDescript() + ", 'trapping' it for her much anticipated assault.");
            // PC cock chosen:
            else this.outputText(".  Wasting no time with 'formalities,' she stuffs your " + this.player.cockDescript(0) + " into her mouth, firmly sealing her lips around your shaft and suckling along the sensitive flesh of your glans.");
        }
            ...
            if (target == 2) this.outputText(" as she allows her soft lips to surround your [clit], “trapping” it for her much anticipated assault.");
            // PC cock chosen:
            else this.outputText(" as she wastes no time with 'formalities,' stuffing your [cock] into her mouth, firmly sealing her lips around your shaft and suckling along the sensitive flesh of your glans.");
            this.outputText("  Not to be an inconsiderate 'guest,' you decide to give a little love to her clit as well, soliciting a girlish little squeal of surprise for your lover.  Seems she lucked out this time with such an open-minded partner.");
        }
        // Clit is chosen for plant woman to focus on
        if (target == 2) {
            // PC vagina (mainly, for herms; some recognition will be given to PC cocks):
            this.outputText("\n\nThe soft texture of your labia now along her tongue, the plant woman spreads your clit with her hands and allows herself a greater angle to attack your eager sex.  With a nice view of your [vagina], the flora girl sinks her tongue into your fuck-hole like an arrow into bare flesh.  Rending her way through your love canal as her saliva mixes with your pussy fluids, the warmth of her wetness making itself known after every lick of your sex.  Pressing her thighs against your chest, her wet clit slides against your moaning face with prompting force, conveying her need for you to control yourself, center your focus, and lick that tender slit of love button like a good " + this.player.mf("boy", "girl") + ".  Mustering your concentration, you press your face hard against her clit and dart your tongue inward, sliding it ever so gently along her tight contours.");
            ...
            if (this.player.hasCock()) {
                this.outputText("\n\nIf that wasn't bad enough, the unsporting woman also takes to your " + this.player.multiCockDescriptLight() + " and strokes ");
                if (this.player.cockTotal() == 1) this.outputText("it");
                else this.outputText("them");
                this.outputText(" teasingly.  The pompous creature gives you a stare down at your form and grins at the “superior” position she thinks she has you in.");
            }
            ...
            if (this.player.hasCock()) {
                this.outputText("  With your feminine release comes a slightly painful build up of pressure in your loins; then, the hot and heavy eruption of cum in the air as your prick");
                if (this.player.cockTotal() > 1) this.outputText("s explode");
                else this.outputText(" explodes");
                this.outputText(", coating the floral vixen in your seed.");
            }
        ...
        // Cock(s):
            ...
            if (pt == 1) this.outputText("cock");
            else if (pt == 2) this.outputText("love button");
            else this.outputText("love button and cock");
            this.outputText(", trying your best to guide your tongue around her ");
            if (pt == 2) this.outputText("clit and vagina");
            else if (pt == 1) this.outputText("glans and shaft");
            else this.outputText("clit, vagina, glans, and shaft");
            this.outputText(" while you hang upside down.  No doubt loving every second of this, the plant woman starts gyrating and grinding her sex against your face, moaning and whimpering between mouthfuls of cock as you ");
            if (pt == 2) this.outputText("probe her depths");
            else this.outputText("do your best to service the stiff prick in your mouth");
            this.outputText(".");

            // (PC is herm:
            if (this.player.gender == 3) this.outputText("  In reward for remembering your “duties,” a set of fingers find their way along your feminine sex and into your honey pot, her teasing of your [vagina] ensuring that no sexes on your body are needlessly left out.");
    ...
    public struggleFailPlantPussyFuckNoWay(): void {
        this.clearOutput();
        this.outputText("Whether it's because you ");
        // PC is virgin:
        if (this.player.vaginas[0].virgin) this.outputText("want to protect your chastity, or you ");
    ...
    public struggleFailPlantPussyFuckAllow(): void {
        ...
        // (PC is lactating:
        if (this.player.isLactating()) this.outputText(", whetting her appetite for milk ");
    ...
    public victoryVsPlant(): void {
        this.clearOutput();
        // (Victory, V 1.1L):
        this.outputText("The plant woman sinks to her knees, clutching her ");
        // PC HP victory:
        if (this.monster.HP < 1) this.outputText("shoulder and sides.");
        else this.outputText("breasts and pussy, twisting at her teats and finger herself like a woman possessed.");
    ...
    public defeatOrDomPlantAndCuntFuck(): void {
        ...
        if (this.player.cockTotal() > 1) {
            this.outputText("  Your extra endowment");
            if (this.player.cockTotal() == 2) this.outputText(" flaps");
            else this.outputText("s flap");
            this.outputText(" wildly against her thighs and ass, quietly acknowledging the call to arms and prepare to do their part.");
        }
        ...
        this.outputText(".  The sensation is too much, and you cry out as you flood her vagina with your hot semen.  The plant woman senses your orgasmic release and begins to squeeze your sides with her legs, as if pumping you for all of your seed.  Your ");
        if (this.player.balls == 0) this.outputText(Appearance.multiCockDescriptLight(this.player));
        else this.outputText(this.player.ballsDescriptLight());
        this.outputText(" acknowledge");
        if (this.player.balls == 0 && this.player.cockTotal() == 1) this.outputText("s");
        this.outputText(" her desire and continue to shoot thick streams of your seed into her");
        if (this.player.cockTotal() > 1) this.outputText(" as well as on her stomach and the ground beneath you");
        if (this.player.hasVagina()) this.outputText("; your vaginaDescript(0) quivers with the need for release, letting loose with its own torrent of lady fluids as you moan in orgasm");
        this.outputText(".  After a few moments, you slump down on the plant woman's chest, completely spent. A few minutes rest does you good, and with time you rise back up and look down at your partner; a dazed, blissful expression has fallen on her features, the creature lost in pure nirvana as she cradles her stomach. Satisfied with how things turned out, you give her one last kiss and struggle to get back up.  Damn, your ");
        if (this.player.balls > 0) this.outputText("[balls] really hurt");
        else {
            this.outputText("dick really hurts");
            if (this.player.cockTotal() > 1) this.outputText("s really hurt");
        }
        this.outputText(", but looking back at the heap of a woman behind you, you concur that it was totally worth it.");
        ...
        if (this.player.HP < this.player.maxHP()) {
            this.outputText("Upon returning to camp, you notice that some of the wounds the plant creature kissed have actually healed.  You're not sure how exactly this worked, but at least you don't have to put up with too many cut and bruises now.");
    ...
    public victoryOverPlantGalWithPCCockCorruptedStart(): void {
        ...
        if (this.player.isGoo()) {
            ...
            this.menu();
            this.addButton(0, "Yes", this.corruptDomWinFuckGooGal);
            this.addButton(1, "No", this.victoryOverPlantGalWithPCCockCorrupted, true);
        }
        else this.victoryOverPlantGalWithPCCockCorrupted(false);
    }
    ...
    public victoryOverPlantGalWithPCCockCorrupted(newl: boolean = false): void {
        ...
        this.outputText("After an eternity of ravaging her pussy, you feel your load building up pressure and getting ready to explode.  You tighten your grip on the plant woman's hair and with one last thrust fill her womb with your corrupted semen.  You jerk her hair back, forcing her head back towards your mouth as you begin to neck her.  \"<i>AuuughhhAHHHHHHHHHHHHHHH!</i>\" she screams out as you pull on her hair, with her pussy clamping down on your " + this.player.cockDescript(this.x) + ".  Her fuck hole ever so eager to receive your seed, her body convulses violently as you continue to fire more semen into the floral vixen's cervix.  The excretion is too much, and with a groan, you pass out on top of her.");
    ...
    public victoryDefeatPlantGirlGetBJMainSCREENON(): void {
        ...
        // PC has balls: (
        if (this.player.balls > 0) this.outputText(" cusps your [balls] in her hand, and suck on the sides of your [sack]. She licks upwards from your testicles and caresses them before");
        else this.outputText(" licks up from your gouch before");
        this.outputText(" slowly proceeding towards your glans and swirling her tongue around it like a tootsie roll.  It isn't long before the plant woman suddenly stops and looks up at you with mischievous eyes.  She raises her eyebrows twice, and then ");

        // [If cock(s) are tentacle dicks and greater than 24 inches in length, jump to (V and D 1.2tc)]
        if (this.player.countCocksOfType(CockTypesEnum.TENTACLE) > 0 && (this.player.countCocksOfType(CockTypesEnum.TENTACLE) == this.player.totalCocks() || rand(2) == 0)) {
            this.plantGirlPCWinGetTentacleBJ();
            return;
        }
        else {
            // [if cock size is 4-14 inches]
            if (this.player.cocks[this.player.biggestCockIndex()].cockLength < 14) this.outputText("takes the entirety of your [cock biggest] in her mouth and down her throat.  You lurch forward as your cock hits the back of her throat, moaning intensely at the plant girl's ability to take your whole penis in her mouth.");

            // [If cock size is greater than 14 inches]
            else this.outputText("attempts to take as much of your member as she possibly can.  Your [cock biggest] slams against the back of her throat, and the plant woman tries to take a little more of you to no avail.  She looks up at you apologetically, but you pet her head and ensure that she knows you aren't upset with her.");

            this.outputText("  She stares up at you with a flirtatious look and pulls your cock out of her throat, seeking to get a little more intimate with the head of your dick.  You grip on her hair tightly with every pleasurable sensation as her head bobs back and forth between your thighs.");
        ...
        // ______________________________________________________________________________
        // (if Non-goo:
        if (!this.player.isGoo()) this.outputText(".  She pulls your dick out of her mouth and closes her eyes as she gets ready to catch the rest of your load with her mouth.  Thick globs of semen erupt from your player.multiCockDescriptLight() and strike her in the face.  She herself orgasms as your torrent of semen washes over her head and chest, covering both liberally.");
        // (If goo:
        else this.outputText(", bucking hard against her face as you grunt furiously through gritted teeth and a fierce expression of release.  The plant woman inhales deeply just as you cum into her hot, moist mouth, producing a satisfied series of muffled groans as you deposit your seed.");
    ...
    public plantGirlPCWinGetTentacleBJ(): void {
        ...
        if (this.player.cocks[this.x].cockLength < 48) {
            ...
            this.outputText(" and begins to squeeze tighter and tighter.  “Owww! Owww! Okay, Okay! I get it!” you cry out as you once again ram your " + this.player.cockDescript(this.x) + " down her throat.  The plant woman responds by massaging your ");
            if (this.player.balls > 0) this.outputText("balls");
            else this.outputText("nipples");
            this.outputText(", showing that this is what she wants.  You laugh out loud at the ridiculousness of the situation: you're using a plant creature's throat as a makeshift cunt, and she doesn't seem to be running out of air anytime soon.");
    ...
    public beatPlantGirlDomLetsFuckAnal(): void {
        ...
        if (this.combat.inCombat) {
            ...
            // Testicle check:
            // ([balls]/pelvis)
            if (this.player.balls > 0) this.outputText("Your [balls] slap");
            else this.outputText("Your pelvis slaps");
            this.outputText(" against her pussy, causing wet slapping sounds and coating your [sack] liberally with her sexual secretions.  The plant woman moans weakly");
            if (this.player.cockTotal() > 1) this.outputText(" grabs a hold of your penis and guides it to her vagina.");
            else {
                this.outputText(", while she ");
                // PC has testicles: (
                if (this.player.balls > 0) this.outputText("fondles your testicles sensually; surprisingly she doesn't injure you by squeezing too hard despite the rough fucking.");
            }
            // Vagina check:
            if (this.player.hasVagina()) {
                if (this.player.cockTotal() == 1 && this.player.balls > 0) this.outputText("  Not content with just teasing your balls, the");
                else this.outputText("  The");
                this.outputText(" attractive creature darts her hand down to your [vagina], fingering you passionately as she takes the length of your meat into her hungry sex.");
            }
            ...
            this.outputText("\n\nYou grunt and moan as your " + this.player.cockDescript(this.x) + " shoots its anal payload ");
            if (this.player.cockTotal() > 1) this.outputText(" along with its vagina-clad brother");
            this.outputText(".  She slumps against you, lost in pleasure and sensation as you drench her interior with hot, sticky cum.  The plant woman's nectar-flavored milk shoots forth from her breasts and coats the ground in front of the both of you, causing her to shake and moan furiously.");
            if (this.player.hasVagina()) this.outputText("Your [vagina] obliges, and a few steams of lady spunk flow from your [clit] and intertwine with the fauna creature's fluids on the ground.");
            this.outputText("  As the plant woman comes down from her climax, you lick your hands clean of her nectar and pull out from her.  You shoot her a look of appreciation, and she fires back a look of utter contentment and bliss.  You leave her to recuperate from the act and head back to camp.");
            this.player.orgasm('Generic');
            this.combat.cleanupAfterCombat();
        }
        // (Dominant Let's Fuck! (giving anal) D 1.3
        else {
            this.outputText("Before the plant gets a chance to take two steps forward,you put your hand out towards her, signaling her to stop. Almost immediately the plant woman pauses her movement towards you, like a herbivore as it listens for the sounds of predators. Knuckles against your chin, you stare longingly at the creature's hips as she stands motionless, wondering why you wanted her to stop. Signaling with your index finger, you instruct the perplexed female to turn around. Reluctantly she spins around and exposes her ample rump to your gaze, causing a violent twitch in your pants as her full bottom comes into view. Satisfied, you proceed towards the plant woman, disrobing as you go.");
    ...
    public pcBeatsPlantgirlAndCorruptAssFuck(): void {
        ...
        // (If Naga:
            ...
            this.menu();
            this.addButton(0, "Penetrate", this.nagaPenetrateWithTailDuringPlantGirlMeanAnalPCWin);
            this.addButton(1, "Stick2Anal", this.pcBeatsPlantgirlAndCorruptAssFuckPt2);
            return;
        }
        this.pcBeatsPlantgirlAndCorruptAssFuckPt2();
    }

    // [Penetrate her]
    public nagaPenetrateWithTailDuringPlantGirlMeanAnalPCWin(): void {
        this.clearOutput();
        this.outputText("With a twist of your sleek snake tail, you angle your tip to thrust up into her.  The plant woman doesn't see your tail coming and shrieks as you dart up into her clit, tip pushing her pussy lips aside as you work as much tail end into her as possible.  Thrashing manically, the plant woman moans theatrically as you start the process of double pumping her pussy and ass.");
        this.pcBeatsPlantgirlAndCorruptAssFuckPt2(true);
    }
    ...
    public pcBeatsPlantgirlAndCorruptAssFuckPt2(tail: boolean = false): void {
        ...
        if (!tail) this.outputText("herself");
        else this.outputText("her labia while you fuck her with your tail");
        this.outputText(" and playing with her breasts as you pump her ass with all of your might.  You can no longer control the timing of your orgasm, and you howl in savage delight as you bottom out in this plant creature's sphincter.  She cries out so loud that you swear she almost ruptures your ear drums, slamming against you in a uncontainable thrashing orgasm.  You place your hands on the top of her thighs and push downward, intent on burying your cock");
        if (this.y >= 0) this.outputText("s");
        this.outputText(" deep in her ass as you fill her up with your tainted splooge.  She quivers violently; her body intent on getting some room but you will have none of it.  You keep her pinned against your lap until you have finished cumming and pull out of her, wiping yourself off with her hair as you proceed to replace your [armor].  The plant woman lies against the ground, now utterly dominated and unable to move.  As you walk away, you hear a rustling in the bush near her.  You let out a loud laugh as you picture an imp or tentacle monster emerging and proceeding to pick up where you left off.  As much as you would like to stick around and find out what fate lies in store for her, you have other things to do.  You turn and head back to camp.");
        this.player.orgasm('Generic');
        this.combat.cleanupAfterCombat();
    }
    ...
    public beatPlantGirlAndTakePlantCockInButt(): void {
        ...
        if (this.player.hasCock()) this.outputText("[eachCock] becomes rock solid");
        if (this.player.gender == 3) this.outputText(" while ");
        if (this.player.hasVagina()) this.outputText("your pussy becomes incredibly wet");
        if (this.player.gender == 0) this.outputText("nipples become erect");
        this.outputText(" in response to your own arousal and desire.  The tip of her penis presses against your cheeks and pushes its way into you as you allow it past your anus and into the depths of your ass.  The creature opens her mouth in an 'ohh' expression, enjoying the sensation of breaking past your [asshole].  As she bottoms out, ");
        if (this.player.hasCock()) this.outputText("[eachCock] jerks upward, the last shot of blood filling and hitting them like a thunderous punch");
        if (this.player.gender == 3) this.outputText(", while ");
        if (this.player.hasVagina()) this.outputText("your pussy leaks a bit of girl cum.  It slowly drools out onto her pelvis");
        if (this.player.gender == 0) this.outputText("your body quivers from the sensation");
        this.outputText(".  ");
        // PC has balls:
        if (this.player.balls > 0) this.outputText("Your [balls] laying on top of her pelvis, y");
        else if (this.player.hasVagina()) this.outputText("Your vaginal muscles clenching up along with your sphincter, y");
        else this.outputText("Y");
        this.outputText("ou ");
        if (this.player.balls > 0) this.outputText("begin to massage your [sack] as you raise your hips upward");
        else if (this.player.hasVagina()) this.outputText("relish in the moment and allow a hand to drop to your sex as you raise your hips, eager to please both ends during this act");
        else this.outputText("grab her nipples and begin to play with them");
        this.outputText(".  Slowly, you lower your hips back down once again onto the plant woman's penile member, causing your partner to moan in lustful appreciation.  A sense of fullness floods you as you allow yourself to take her entire member inside of you.  You ");
        if (!this.player.hasVagina()) this.outputText("place both hands on her shoulders");
        else this.outputText("continue to finger yourself");
        this.outputText(" as you bob your [asshole] against her lap, moaning loudly as you do.  The plant woman's hands shoot out and ");
        // PC has a pussy (and/or) a dick:
        if (this.player.gender > 0) {
            this.outputText("grab both your [chest] and ");
            if (this.player.hasCock()) this.outputText("[oneCock]");
            if (this.player.hasVagina()) this.outputText("your vulva");
        }
        // PC is genderless:
        else this.outputText("your nipples, playfully tugging on them");
        this.outputText(", intent on magnifying your own pleasure.");
        ...
        if (this.player.hasCock()) this.outputText("strokes [oneCock] with her hands");
        if (this.player.gender == 3) this.outputText(" as she also ");
        if (this.player.hasVagina()) this.outputText("massages your labia");
        if (this.player.gender == 0) this.outputText("massages you");
        this.outputText(".");
        this.outputText("  The plant woman thrusts in kind,  mashing her pelvis against your own as you bounce off the creature. You manage to time your descent with her thrusts to intensify both of your pleasures.  She ");
        if (this.player.hasCock()) this.outputText("quickens her pace of stroking your cock");
        if (this.player.gender == 3) this.outputText(" and ");
        if (this.player.hasVagina()) this.outputText("fingers the interior of your pussy, causing you to roll your eyes into the back of your head as she sensually teases the inside of your sex");
        if (this.player.gender == 0) this.outputText("raises herself to deliver a passionate kiss");
        this.outputText(".  You feel her thrusts getting shorter now, and you know that her she going to blow her load soon.  With gradually closing eyes and increasingly frequent panting and moaning, she grabs your hips and holds them in place as she thrusts upward one last time.  With a lusty moan, her spunk shoots into your hot innards with significant force, allowing you to feel the impact of every shot of cum in your anus.");
        this.outputText("\n\nYou cry out in fierce orgasm, ");
        if (this.player.hasCock()) {
            this.outputText("[eachCock] erupting its own payload onto her face and chest");
        }
        if (this.player.gender == 3) this.outputText(", ");
        if (this.player.hasVagina()) this.outputText("vaginal muscles clamping down and drooling pussy juice all over the plant woman's lap");
        if (this.player.gender == 0) this.outputText("twitching futilely around the plant-girl's swollen seeder");
        this.outputText(".  With a groan, you collapse against the creature's chest, desperately trying to catch your breath from the taxing ordeal.  The plant woman hums approvingly, stroking your hair as your body ascends and descends from her own because of your heavy breathing.  After some time, you are able to muster the strength to pull yourself off of the plant creature, her cock slipping out of your ass and unleashing a flood of sappy jism from your anus.  Content, she passes out into a deep sleep.  You grin to yourself, putting your [armor] back on and heading back to camp.");
        this.player.orgasm('Anal');
        if (this.combat.inCombat)
            this.combat.cleanupAfterCombat();
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    public defeatPlantgirlBlowAndButtfuckCorrupt(): void {
        this.clearOutput();
        if (this.flags[kFLAGS.TIMES_GOT_CORRUPT_BJ_ANAL_PLANTGIRL_SCENE] >= 2) {
            this.defeatPlantgirlBlowAndButtfuckPure();
            return;
        }
        ...
        this.flags[kFLAGS.TIMES_GOT_CORRUPT_BJ_ANAL_PLANTGIRL_SCENE]++;
        this.doNext(this.camp.returnToCampUseOneHour);
    }

    // Victory and Dominant: Fuck her cock w/ your pussy (light side)
    public defeatPlantgirlBlowAndButtfuckPureStart(): void {
        // V 1.6 and D 1.6
        this.clearOutput();
        this.outputText("With your hands on your hips you " + this.player.mf("walk", "sway"));

        // (Victory, V 1.6:)
        if (this.combat.inCombat)
            this.outputText(" towards the battered creature as she struggles to get back to her feet.  Her efforts are quite for naught as her arms give out, causing her to hit the ground hard.");
        // (Scene leads to V and D 1.6)
        // (Dominant, D 1.6:
        else this.outputText(" towards the plant woman, causing her to giggle in response as she beckons you over to her.");
        // (Scene leads to V and D 1.6)
        this.doNext(this.defeatPlantgirlBlowAndButtfuckPure);
    }
    ...
    public defeatPlantgirlBlowAndButtfuckPure(): void {
        ...
        if (this.player.isNaga()) this.outputText("now exposed ");
        this.outputText(this.player.clitDescript() + ".  The plant woman yelps in surprise as the vine makes contact with your labia, causing you to jump a little.  You turn to face the plant woman, who is blushing profusely and resting her hand on her pussy.  Looking at the vegetation, you deduce that she must be able to feel you along her vines and that these creepers may also function as penile appendages.  A grin spreads across your face as the realization hits you, and you bring the vine back to your sex and tease your vulva.  Soft moans escape the plant girl as the head of the perverted vegetation brushes past your clit, and you ");
        // (pure:
        if (this.player.cor < 50) this.outputText("giggle");
        // Corrupted:
        else this.outputText("smirk");
        this.outputText(" at the woman's predicament.  Deciding to stop teasing the poor girl, you take the head of the creeper and push it into your pussy, edging it upwards at a gradual pace so that your partner can feel the contours of your " + this.player.vaginaDescript(0) + ".");
 ...
 */
class kFLAGS {
    public static TIMES_MET_PLANTGIRL: number = -1000;
    public static TIMES_FUCKED_PLANTGIRLS_ASS: number = -1001;
    public static TIMES_GOT_CORRUPT_BJ_ANAL_PLANTGIRL_SCENE: number = -1002;
}
