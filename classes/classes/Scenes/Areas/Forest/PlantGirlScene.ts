	...
	export class PlantGirlScene extends BaseContent
	{
		...
		private  x: number; //FIXME this is a dummy to avoid compile errors due to copy-pasted code.
		private  y: number; //FIXME this is a dummy to avoid compile errors due to copy-pasted code.
		...
		public  plantLadyLetsFuck(from: number = 1.1): void {
			...
			*/
			...
			if (from == 1.1) {
				...
				addButton(0, "Dominant", undefined); //FIXME value was 9999
				addButton(1, "Submissive", undefined); //FIXME value was 9999
			}
		}
		...
		public  plantWomanStruggle(): void {
			...
			if (player.str >= 40) {
				...
				menu();
				addButton(0,"Sex", undefined); //FIXME value was 9999
				addButton(1, "Decline", declinePlantSmex);
				addButton(4,"Try to Run", undefined); //FIXME value was 9999
			}
		...
		public  plantRapingAssTrappedSexIntro(): void {
			...
			addButton(0, "Fuck My Ass", undefined); //FIXME was commented out simpleChoices with 9999
			addButton(1, "Exit Only", undefined); //FIXME was commented out simpleChoices with 9999
		}
		...
		public  trappedFlowerSexBlowjob(): void {
			...
			addButton(0, "Open Wide", undefined); //FIXME was commented out simpleChoices with 9999
			addButton(1, "Put That Away", undefined); //FIXME was commented out simpleChoices with 9999
		}
		...
		public  trappedFlowerSexBlowjobRejection(): void {
			...
			//(Taken back to tied sex menu)
			doNext(undefined); //FIXME was 9999 instead of undefined
		}
		...
		public  protestTrappedPlantPussySex(): void {
			...
			//(Taken back to tied sex menu)
			doNext(undefined); // FIXME was 9999
		}
		...
		var  cockIndex: number = player.cockThatFits(9999); //Undefined capacity for now.
