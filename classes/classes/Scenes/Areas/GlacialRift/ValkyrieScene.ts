//Coded by Kitteh6660, courtesy of Savin.
	...
	export class ValkyrieScene extends BaseContent
	{
		
		public  ValkyrieScene() 
		{
		}
		
		public  loseToValkyrie(): void {
			clearOutput();
		...
		private  loseToValkyrieForcedOral(): void {
			credits.modContent = true;
			credits.authorText = "Savin";
		...
		public  winAgainstValkyrie(): void {
			clearOutput();
		...
		//Aerial Fuck
		private  valkyrieAerialFuck(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Savin";
