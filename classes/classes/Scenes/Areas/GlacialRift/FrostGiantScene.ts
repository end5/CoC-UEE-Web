	...
	export class FrostGiantScene extends BaseContent
	{
		
		public  FrostGiantScene() 
		{
			
		}
		
		public  loseToGiant(): void {
			combat.cleanupAfterCombat();
		}
		
		public  winAgainstGiant(): void {
			clearOutput();
