 ...
 */
	...
	{
		public  CorruptedDriderScene(pregnancyProgression:PregnancyProgression, output:GuiOutput)
		{
...
//*Victory Rape: Ride Ovi Anal sex-insenitive (done)
		public  victoryVSDriderRideOviAnal(): void
		{
			spriteSelect(SpriteDb.s_drider);
...
//*Loss Vaginal Impregnation and forced BJ - Symphonie (done)
		...
		private  loseVSDriderAndVaginallyImpreggleOviEnding(): void {
			spriteSelect(SpriteDb.s_drider);
			clearOutput();
			outputText(images.showImage("cDrider-loss-vag"));
