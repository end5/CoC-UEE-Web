//Dungeon 2: Deep Cave
	...
	export class DeepCave extends DungeonAbstractContent
	{
		/*
		...
		*/
		...
		private  takeBondageStraps(): void {
			clearOutput();
		...
		private  buyItem(item: number = 0): void
		{
			spriteSelect(SpriteDb.s_sean);
		...
		public  incubusBuy(itype:ItemType): void {
			spriteSelect(SpriteDb.s_sean);
			clearOutput();
		...
		public  incubusTransact(itype:ItemType): void {
			spriteSelect(SpriteDb.s_sean);
			clearOutput();
		...
		//	if (player.ass.analLooseness <= 1) {
			outputText("\"<i>It will never please them like that,</i>\" she scolds. \"<i>You must be made more to their liking or they will never grant you endless joy.</i>\" She grinds her button-stiff clit against your abdomen as she lowers you toward the smallest peg on the rail, an uncarved, lacquered wooden nub an inch wide and three inches long, barely larger than a finger. You try to attack the fairy before she can plug you in, but she simply drops you the rest of the way, and what should've been a relatively painless insertion becomes agonizing as you hit the peg and three inches of hardened wood fill your " + player.assholeDescript() + ". You gasp and try to get off the device, but the fairy has already grabbed you again and pulls you back into the air. You clench your muscles as you look at the far end of the ladder in horrified fascination at a wooden carving that would shame a minotaur. The fairy moves up a couple of notches.");
		...
		//[Release Him]
		public  sexualTortureReleaseZetaz(): void {
			clearOutput();
		...
		//[Tighten Strap] 
		public  sexualTortureTightenZetaz(): void {
			clearOutput();
		...
		public  roomEntrance(): void {
			...
			dungeons.setDungeonButtons(roomTunnel, undefined, undefined, undefined);
		...
		public  roomTunnel(): void {
			...
			dungeons.setDungeonButtons(roomGatheringHall, roomEntrance, undefined, undefined);
		}
		
		public  roomGatheringHall(): void {
		...
		public  roomFungusCavern(): void {
			...
			dungeons.setDungeonButtons(undefined, undefined, undefined, roomGatheringHall);
		...
		public  roomTortureRoom(): void {
			...
			dungeons.setDungeonButtons(roomSecretPassage, undefined, roomGatheringHall, undefined);
			//Vala here?
		...
		public  roomSecretPassage(): void {
			...
			dungeons.setDungeonButtons(undefined, roomTortureRoom, roomZetazChamber, undefined);
		...
		public  roomZetazChamber(): void {
			...
			if (flags[kFLAGS.DEFEATED_ZETAZ] == 0) {
				...
				dungeons.setDungeonButtons(undefined, roomGatheringHall, undefined, roomSecretPassage);
			}
		}
	}
