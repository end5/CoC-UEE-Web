//Side Dungeon: Desert Cave
	...
	export class DesertCave extends DungeonAbstractContent implements VaginalPregnancy
	{
		/*
		...
		*/
		...
		public  DesertCave(pregnancyProgression:PregnancyProgression) {
		...
		private  checkPharmacyDoorUnlocked(): boolean {
		...
		*/
		...
		public  volunteerConfirmation(): void {
			clearOutput();
		...
		public  turnIntoASammitch(volunteered: boolean = false): void {
			clearOutput();
			if (!volunteered) {
		...
		public  cumWitchCumPumpBadEnd(volunteered: boolean = false): void {
			clearOutput();
			if (!volunteered) {
		...
		public  sandWitchMotherFriendlyMenu(): void {
			...
			addButton(5,"Buy LaBova",buyPotion, consumables.LABOVA_, 25, undefined, consumables.LABOVA_.description);
			addButton(6,"Buy Lactaid",buyPotion, consumables.LACTAID, 50, undefined, consumables.LACTAID.description);
		...
		private  buyPotion(iType:ItemType, price: number): void {
			clearOutput();
		...
		private  buyPotionConfirm(iType:ItemType, price: number): void {
			player.gems -= price;
		...
		public  sexWithFriendlySandMother(): void {
			if (monster == undefined || monster.short != "Sand Mother") {
		...
		public  sandMotherPOMenu(): void {
			...
			if (flags[kFLAGS.SAND_WITCH_LOOT_TAKEN] < 5) {
				addButton(5,"Get LaBova",takeLaBovaOrLactaid, false, undefined, undefined, consumables.LABOVA_.description);
				addButton(6,"Get Lactaid",takeLaBovaOrLactaid, true, undefined, undefined, consumables.LACTAID.description);
			}
		...
		public  friendlyCumWitchBlessing(): void {
			...
			else if (player.hasCock()) addButton(0,"Virility",cumWitchBlessed, true, undefined, undefined, "Receive the blessing of virility. This will increase your cum production and virility rating.");
			...
			else if (player.hasVagina()) addButton(1, "Fertility", cumWitchBlessed, false, undefined, undefined, "Receive the blessing of fertility. This will increase your pregnancy speed and fertility rating.");
		...
		public  roomEntrance(): void {
			...
			dungeons.setDungeonButtons(roomCaveCommons, undefined, undefined, undefined);
		...
		public  roomCaveCommons(): void {
			...
			dungeons.setDungeonButtons(undefined, checkExit, roomWestHall1, roomEastHall1)
		...
		public  roomPlayRoom(): void {
			...
			dungeons.setDungeonButtons(undefined, roomWestHall1, undefined, undefined);
		}
		public  roomLustRoom(): void {
			...
			dungeons.setDungeonButtons(roomWestHall1, undefined, undefined, undefined);
			spriteSelect(SpriteDb.s_sandwich);
		...
		public  roomWestHall2(): void {
			...
			dungeons.setDungeonButtons(roomNursery, checkPharmacyDoorUnlocked, undefined, roomWestHall1);
		...
		public  roomNursery(): void {
			...
			dungeons.setDungeonButtons(undefined, roomWestHall2, undefined, undefined);
		}
		public  roomPharmacy(): void {
			...
			dungeons.setDungeonButtons(roomWestHall2, undefined, undefined, undefined);
			if (flags[kFLAGS.SANDWITCH_THRONE_UNLOCKED] == 0) {
		...
		public  roomEastHall1(): void {
			...
			dungeons.setDungeonButtons(roomSleepingChamber, undefined, roomCaveCommons, roomEastHall2); 
		}
		public  roomSleepingChamber(): void {
			...
			dungeons.setDungeonButtons(undefined, roomEastHall1, undefined, roomBathroom);
		}
		public  roomBathroom(): void {
			...
			dungeons.setDungeonButtons(undefined, undefined, roomSleepingChamber, undefined);
		...
		public  roomEastHall2(): void {
			...
			dungeons.setDungeonButtons(undefined, roomCumWitchBedroom, roomEastHall1, undefined);
		}
		public  roomCumWitchBedroom(): void {
			...
			dungeons.setDungeonButtons(roomEastHall2, undefined, roomCumWitchOffice, undefined); 
		}
		public  roomCumWitchOffice(): void {
			...
			dungeons.setDungeonButtons(undefined, undefined, undefined, roomCumWitchBedroom);
			spriteSelect(SpriteDb.s_cumWitch);
			if (flags[kFLAGS.SAND_WITCHES_FRIENDLY] > 0) {
		...
		public  roomSacrificalAltar(): void {
			...
			dungeons.setDungeonButtons(roomSandMotherThrone, roomCaveCommons, undefined, undefined);
		}
		public  roomSandMotherThrone(): void {
			...
			dungeons.setDungeonButtons(undefined, roomSacrificalAltar, undefined, undefined);
