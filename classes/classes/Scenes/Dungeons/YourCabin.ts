	...
	export class YourCabin extends DungeonAbstractContent
	{
		...
		public  enterCabin(): void {
			...
			if (getGame().time.hours >= 21 || getGame().time.hours < 6) addButton(9, "Sleep", getGame().camp.doSleep);
		...
		private  setAlarm(timeSet: number = 6): void {
			clearOutput();
		...
		private  studyCombatManual(): void {
			clearOutput();
		...
		private  studyEtiquetteGuide(): void {
			clearOutput();
		...
		//CONSTRUCT FURNITURE
		//Bed
		private  constructFurnitureBedPrompt(): void {
			clearOutput();
		...
		private  constructFurnitureBed(): void {
			clearOutput();
		...
		//Nightstand
		private  constructFurnitureNightstandPrompt(): void {
			clearOutput();
		...
		private  constructFurnitureNightstand(): void {
			clearOutput();
		...
		//Dresser
		private  constructFurnitureDresserPrompt(): void {
			clearOutput();
		...
		private  constructFurnitureDresser(): void {
			clearOutput();
		...
		//Table
		private  constructFurnitureTablePrompt(): void {
			clearOutput();
		...
		private  constructFurnitureTable(): void {
			clearOutput();
		...
		//Chair
		private  constructFurnitureChairPrompt(): void {
			clearOutput();
		...
		private  constructFurnitureChair(): void {
			clearOutput();
		...
		//Bookshelf
		private  constructFurnitureBookshelfPrompt(): void {
			clearOutput();
		...
		private  constructFurnitureBookshelf(): void {
			clearOutput();
		...
		//Desk
		private  constructFurnitureDeskPrompt(): void {
			clearOutput();
		...
		private  constructFurnitureDesk(): void {
			clearOutput();
		...
		//Chair for Desk
		private  constructFurnitureChairForDeskPrompt(): void {
			clearOutput();
			outputText("Would you like to construct a chair? (Cost: 40 nails and 10 wood.)\n\n");
			camp.cabinProgress.checkMaterials();
			if (player.hasKeyItem("Carpenter's Toolbox"))
		...
		private  constructFurnitureChairForDesk(): void {
			clearOutput();
			outputText("You take the book from your toolbox and flip pages until you reach pages about how to construct a chair. You follow the instructions.\n\n");
			outputText("You pick up the wood and begin to construct a chair. You cut the wood into lengths. You put it together by driving nails into place with your hammer. After putting the chair together, you paint the chair for a polished look.\n\n");
			outputText("The paint dries relatively quickly and it only took you one hour to finish your chair! \n\n");
