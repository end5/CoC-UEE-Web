	 ...
	 * @author Kitteh6660
	 */
	export class AnzuScene extends BaseContent// implements TimeAwareInterface
	{
		...
		public  anzuAffection(amount: number = 0): number {
		...
		public  anzuRelationshipLevel(): number {
		...
		//INTRO
		public  initialPalaceEncounter(): void {
			clearOutput();
		...
		private  apporachInitialPalace(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  leaveInitialPalace(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  anzuRelatLvl3Help(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  anzuRelatLvl3Dont(): void {
			clearOutput();
			credits.authorText = "Coalsack";
		...
		private  anzuRelatLvl4Dont(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		public  anzuMenus(): void {
			...
			if (kGAMECLASS.dungeonLoc == DungeonCore.DUNGEON_ANZU_ROOF) {
				if (player.canFly()) {
					if (flags[kFLAGS.ANZU_RELATIONSHIP_LEVEL] >= 4) addButton(3, "Race Him", undefined).hint("Challenge Anzu to a race and have some fun!");
		...
		private  anzuTalkMaraeAndLethice(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		//Sex
		private  anzuSexMenu(showText: boolean = true): void {
			if (showText) {
				clearOutput();
				credits.modContent = true;
				credits.authorText = "Coalsack";
		...
		private  suckOffDeitysCock(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  fuckGodlyBirdButt(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  racingWithAnzuDecline(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  racingWithAnzuAccept(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  eatFoodWithAnzu(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
			//Determine amount to refill hunger
		var  hungerRefillAmount: number = 50;
		...
		private  dontEatFoodWithAnzu(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
			//Scene GO!
		...
		// BATHING (2PM)
		//------------
		public  anzuBathTimeBeginning(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  anzuBathTimeAccept(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  anzuBathTimeRelax(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  anzuBathTimeDecline(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		// SLEEPING (8PM)
		//------------
		public  sleepWithAnzuInvitation(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  declineSleepingWithAnzu(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  acceptSleepingWithAnzu(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  sleepingWithAnzuPart2(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  sleepingWithAnzuBlowjob(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  sleepingWithAnzuNoBJ(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
		...
		private  sleepWithAnzuProcess(): void {
			clearOutput();
			credits.modContent = true;
			credits.authorText = "Coalsack";
			kGAMECLASS.timeQ = 10;
		...
		private  sleepWithAnzuHeal(): void {
			kGAMECLASS.timeQ = 10;
			camp.sleepRecovery(true);
			kGAMECLASS.timeQ = 0;
		}
		
		private  wakeUpWithAnzuGoodMorningBirdie(): void {
