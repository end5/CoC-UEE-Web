	...
	export class OmnibusOverseerScene extends BaseContent
	{
		
		public  OmnibusOverseerScene() {}
		
		public  encounterOmnibus(): void {
			menu();
		...
		public  doLossOmnibus(): void {
			doBadEndOmnibusPart1();
		}
		
		//Choose your poison
		public  winAgainstOmnibus(): void {
			clearOutput();
			...
			addButton(6, "More Lust", postOmnibusBoon, true, undefined, undefined, "Be always ready for sex.\n\nDo you think it is really good idea?");
		...
		private  postOmnibusBoon(willing: boolean = false): void {
			if (willing) {
				clearOutput();
		...
		private  doBadEndOmnibusPart1(): void {
		...
		private  doBadEndOmnibusPart2(): void {
			clearOutput();
			//(Multi dicks)
			if (player.cocks.length > 1) {
