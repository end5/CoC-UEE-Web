	...
	export class SecretarialSuccubusScene extends BaseContent
	{
		
		public  SecretarialSuccubusScene() {}
		
		public  encounterSuccubus(): void {
		...
		private  talkSuccubusForWhat(): void {
			spriteSelect(SpriteDb.s_succubus_secretary);
			clearOutput();
		...
		private  talkSuccubusItsMe(): void {
			clearOutput();
		...
		private  doFightSuccubusMocked(): void {
			spriteSelect(SpriteDb.s_succubus_secretary);
			flags[kFLAGS.FACTORY_SUCCUBUS_DEFEATED] = 1
			startCombat(new SecretarialSuccubus(), true);
			monster.armorDef -= 10;
		...
		public  doForcefeedSuccubus(): void {
			clearOutput();
		...
		public  doLeaveSuccubus(): void {
			combat.cleanupAfterCombat();
			//doNext(roomBreakRoom);			
		}
		
		public  doBadEndSuccubusPart1(): void {
			spriteSelect(SpriteDb.s_succubus_secretary);
			//Arousal
			clearOutput();
		...
		private  doBadEndSuccubusPart2(): void {
			spriteSelect(SpriteDb.s_succubus_secretary);
			clearOutput();
