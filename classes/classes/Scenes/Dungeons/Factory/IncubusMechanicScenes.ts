	...
	export class IncubusMechanicScenes extends BaseContent
	{
		...
		private  MECHANIC_NO_SELECTION: number = 0;
		...
		// Dungeon 1
		//------------
		public  encounterIncubusFactory(): void {
		...
		public  doRideIncubusAnally(): void {
			clearOutput();
