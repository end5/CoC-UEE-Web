//Quest Dungeon: Tower of the Phoenix (Helia's quest, one-time dungeon)
	...
	export class HelDungeon extends DungeonAbstractContent
	{
		/*
		...
		*/
		...
		public  returnToHeliaDungeon(): void {
			clearOutput();
			outputText(images.showImage("dungeon-entrance-phoenixtower"));
		...
		//[Refuse Polite]
		public  refuseGooArmorOfferPolitely(): void {
			spriteSelect(SpriteDb.s_valeria);
			clearOutput();
			//In Tower of the Phoenix
			if (flags[kFLAGS.VALERIA_FOUND_IN_GLACIAL_RIFT] == 0) {
		...
		public  harpyQueenBeatsUpPCBadEnd(): void {
			clearOutput();
			//(Go to \"<i>Harpy Breeding Slut</i>\" Bad End)
		...
		public  roomGuardHall(): void {
			...
			dungeons.setDungeonButtons(roomStairwell, undefined, undefined, undefined);
		...
		public  roomStairwell(): void {
			kGAMECLASS.dungeonLoc = DungeonCore.DUNGEON_HEL_STAIR_WELL;
			clearOutput();
			outputText("<b><u>Stair Well</u></b>\n");
			dungeons.setDungeonButtons(undefined, roomGuardHall, undefined, undefined);
